...
<title><?php if(!empty($navtitle)): echo $navtitle.' - '; endif; if(empty($nobbname)): echo $_G['setting']['bbname'].' - '; endif;?> - 简明版</title>
...
<meta name="copyright" content="2001-2012 P.S.V.R" />
<style type="text/css">
...
<h2><?php echo $_G['setting']['bbname']; ?> - 简明版 </h2>
</center>