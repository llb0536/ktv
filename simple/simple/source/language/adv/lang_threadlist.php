...
$lang = array
(
	'threadlist_name' => '课件系统/群组 课件列表课件位广告',
	'threadlist_desc' => '展现方式: 课件位广告显示于课件列表页第一页的课件位置，可以模拟出一个具有广告意义的课件地址，吸引访问者的注意力。',
	'threadlist_fids' => '投放版块',
	'threadlist_fids_comment' => '设置广告投放的课件系统版块，当广告投放范围中包含“课件系统”时有效',
