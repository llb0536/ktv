...
$lang = array
(
	'attachmentlist_name' => '课件系统附件列表',
	'attachmentlist_desc' => '课件系统附件列表调用',
	...
	'attachmentlist_items_comment' => '设置一次显示的图片课件条目数，请设置为大于 0 的整数',
	'attachmentlist_titlelength' => '标题长度',
	'attachmentlist_titlelength_comment' => '设置当附件名称/课件标题显示的最大长度',
	'attachmentlist_summarylength' => '内容长度',
	'attachmentlist_summarylength_comment' => '设置附件介绍/课件内容显示的最大长度',
	...
	'attachmentlist_threadmethod' => '课件方式调用',
	'attachmentlist_threadmethod_comment' => '选择“是”将按照课件方式调用附件，一个课件显示一个附件；选择“否”将按照附件方式调用',
	'attachmentlist_digest' => '精华课件过滤',
	'attachmentlist_digest_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'attachmentlist_digest_0' => '普通课件',
	'attachmentlist_digest_1' => '精华 I',
	'attachmentlist_digest_2' => '精华 II',
	'attachmentlist_digest_3' => '精华 III',
	'attachmentlist_special' => '特殊课件过滤',
	'attachmentlist_special_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'attachmentlist_special_1' => '投票课件',
	'attachmentlist_special_2' => '商品课件',
	'attachmentlist_special_3' => '悬赏课件',
	'attachmentlist_special_4' => '活动课件',
	'attachmentlist_special_5' => '辩论课件',
	'attachmentlist_special_0' => '普通课件',
	'attachmentlist_special_reward' => '悬赏课件过滤',
	'attachmentlist_special_reward_comment' => '设置特定类型的悬赏课件',
