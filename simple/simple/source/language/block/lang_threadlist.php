...
(
	...
	'threadlist_fids_comment' => '设置允许参与新课件调用的版块，可以按住 CTRL 多选，全选或全不选均为不做限制',
	...
	'threadlist_typeids' => '课件分类ID',
	'threadlist_typeids_comment' => '输入课件分类ID，多个 ID 之间用半角逗号“,”隔开。',
	'threadlist_typeids_all' => '全部的课件分类',
