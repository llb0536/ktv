...
(
	...
	'post_reply_quote' => '{author} 上传于 {time}',
	'post_edit' => "[i=s] 本课件最后由 {editor} 于 {edittime} 编辑 [/i]\n\n",
	'post_edit_regexp' => '/^\[i=s\] 本课件最后由 .*? 于 .*? 编辑 \[\/i\]\n\n/s',
	'post_edithtml' => '[i=s] 本课件最后由 {editor} 于 {edittime} 编辑 [/i]<br /><br />',
	'post_edithtml_regexp' => '/^\[i=s\] 本课件最后由 .*? 于 .*? 编辑 \[\/i\]&lt;br \/&gt;&lt;br \/&gt;/s',
	'post_editnobbcode' => '[ 本课件最后由 {editor} 于 {edittime} 编辑 ]\n\n',
	'post_editnobbcode_regexp' => '/^\[ 本课件最后由 .*? 于 .*? 编辑 \]\n\n/s',
	'post_reply' => '回复',
	'post_thread' => '的课件',
	...
	'formulaperm_digestposts' => '精华课件数',
	'formulaperm_posts' => '发课件数',
	'formulaperm_threads' => '课件数',
	...
	'share_message' => '您好！我在 {$_G[setting][bbname]} 看到了这篇课件，认为很有价值，特推荐给您。\\n\\n$thread[subject]\\n地址 [url={$threadurl}]{$threadurl}[/url]\\n\\n希望您能喜欢',
	...
	'perms_allowstickthread' => '课件置顶',
	'perms_allowdigestthread' => '课件精华',
	'perms_allowstickthread_value' => '置顶',
	'perms_allowdigestthread_value' => '精华',
	'perms_allowbumpthread' => '提升课件',
	'perms_allowhighlightthread' => '课件高亮',
	'perms_allowrecommendthread' => '课件推荐',
	'perms_allowstampthread' => '课件鉴定',
	'perms_allowclosethread' => '课件关闭',
	'perms_allowmovethread' => '课件移动',
	'perms_allowedittypethread' => '编辑课件分类',
	'perms_allowcopythread' => '课件复制',
	'perms_allowmergethread' => '课件合并',
	'perms_allowsplitthread' => '课件分割',
	'perms_allowrepairthread' => '课件修复',
