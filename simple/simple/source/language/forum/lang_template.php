...
$lang = array (
  ...
  'collection_comment_submit' => '上传评论',
  ...
  'collection_comment_thread' => '淘课件评论',
  'no_content' => '暂时没有内容',
  ...
  'collection_addreason' => '淘课件理由：',
  'collection_fill_entire' => '请将标题填写完整',
  'collection_reason_exceed' => '"淘课件理由不能超过 "+reasonlimit+" 字节"',
  ...
  'never' => '从未',
  'on' => '于',
  'online_only_guests' => '当前只有游客或隐身用户在线',
  'onlinemember' => '在线用户',
  'onlines' => '人在线',
  'private_forum' => '私密版块',
  ...
  'post_hide_reply_hidden' => '，如果您要查看本课件隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'connect_fill_profile_to_post' => '您需要 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">绑定已有帐号</a> 后才可以发课件',
  'login_to_post' => '您需要登录后才可以发课件',
  'no_permission_to_post' => '您现在无权发课件。',
  'post_advancemode' => '高级模式',
  'post_relay' => '转播给听众',
  'post_sync_method' => '将此课件同步到',
  'quick_post' => '快速发课件',
  'select_thread_catgory' => '选择课件分类',
  ...
  'digest_posts' => '精华',
  'forum_group' => '版块/群组',
  'forum_nothreads' => '本版块或指定的范围内尚无课件',
  'forum_thread' => '版块课件',
  'from' => '来自',
  ...
  'mod_notice' => '课件系统管理员在“管理面板”中权限和超级版主基本相同，如果需要更多功能，请进入 <a href="admin.php?mod=forum" target="_blank"><u>管理中心</u></a> ',
  ...
  'mod_access_ban_postreply' => '禁止上传回复',
  ...
  'mod_notice_access' => '通常情况下，用户在版块的权限是根据他的用户组决定的，此处您可以限制某个用户在某版块的权限。<br />注意: 看课件是基本权限，一旦禁止, 其他权限会同时进行禁止。<br />图例说明: <img src="static/image/common/access_normal.gif" class="vm" /> 默认权限&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_disallow.gif" class="vm" /> 强制禁止&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_allow.gif" class="vm" />强制允许 ',
  'moderator' => '版主',
  'admin' => '课件系统管理员',
  'days' => '天',
  'expire' => '有效期',
  ...
  'mod_option_subject_forum' => '版块课件',
  'mod_option_subject_recyclebin' => '课件回收站',
  'mod_option_subject_recyclebinpost' => '学习笔记回收站',
  'modcp_forum' => '当前版块',
  'modcp_posts_author' => '课件作者',
  'modcp_posts_dateline_range' => '时间范围',
  'modcp_posts_error_1' => '搜索条件不足！您至少应当在 关键字，课件作者或者发课件 IP 当中设置一个搜索的条件',
  ...
  'modcp_posts_error_4' => '抱歉，您无权使用批量删课件功能',
  'modcp_posts_ip' => '发课件 IP',
  ...
  'modcp_posts_threadfirst' => '课件首课件',
  'modcp_posts_threadreply' => '课件回复课件',
  'modcp_posts_to' => '至',
  ...
  'mod_option_selectthreadclass' => '课件分类',
  'modcp_dateline_range' => '上传时间范围',
  'modcp_forum_select_msg' => '请选择版块进行管理',
  'modcp_no_reply_range' => '多少天内无回复',
  'modcp_reply_range' => '回复次数范围',
  'modcp_restore' => '恢复',
  'modcp_select_threadclass' => '请选择课件分类',
  ...
  'replycredit_once' => '每次学习笔记奖励:',
  'replycredit_rate' => '中奖率',
  'replycredit_reward' => '奖励',
  'replycredit_time' => '次',
  'replycredit_total' => '学习笔记奖励总额:',
  'rushreply_change' => '将该课件设为抢楼课件',
  'rushreply_end' => '截止楼层:',
  ...
  'disable' => '禁用',
  'hiddenreplies' => '学习笔记仅作者可见',
  'post_additional_options' => '附加选项',
  'post_anonymous' => '使用匿名发课件',
  'post_delpost' => '删除本课件',
  'post_descviewdefault' => '学习笔记倒序排列',
  ...
  'stats_main_board_activity' => '课件系统活跃指数',
  'stats_main_forums_count' => '版块数',
  'stats_main_hot_forum' => '最热门的版块',
  'stats_main_member' => '用户统计',
  'stats_main_members' => '注册用户',
  'stats_main_members_count' => '最近 24 小时新增用户数',
  'stats_main_new' => '新用户',
  'stats_main_nmpd' => '平均每日注册用户数',
  'stats_main_nonposters' => '未发课件用户',
  'stats_main_nppd' => '平均每日新增课件数',
  'stats_main_posters' => '发课件用户',
  'stats_main_posters_percent' => '发课件用户占总数',
  'stats_main_posts_avg' => '平均每人发课件数',
  'stats_main_posts_count' => '课件数',
  'stats_main_rpt' => '平均每个课件被回复次数',
  'stats_main_threads_count' => '课件数',
  'stats_main_todays_newposts' => '最近 24 小时新增课件数',
  'stats_main_topposter' => '今日课件系统之星',
  'stats_main_total_posted' => '发课件数',
  ...
  'stats_posts_thismonth' => '最近 30 天发课件',
  'stats_team' => '管理团队',
  ...
  'admin_type_msg' => '当前版块无分类设置，请联系管理员到后台设置课件分类',
  ...
  'topicadmin_warn_prompt' => '{$_G[setting][warningexpiration]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止发课件 {$_G[setting][warningexpiration]} 天',
  ...
  'set_tag_to_poll_users' => '给参与投票的用户贴标签',
  'set_tag_to_reply_users' => '给参与学习笔记的用户贴标签',
  'follow' => '收听TA',
  'have_ignored' => '已忽略',
  'i_want' => '我要',
  'last_thread' => '上一课件',
  ...
  'thread_author' => '楼主',
  'thread_printable' => '打印',
  'thread_replycredit_tips1' => '回复本课件可获得 {$_G[forum_thread][replycredit_rule][extcredits]} {$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][unit]}{$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][title]}奖励!',
  ...
  'thread_rushreply' => '本课件为抢楼课件，欢迎抢楼!',
  'thread_rushreply_check_back' => '返回抢楼课件',
  'thread_rushreply_end' => '截止楼层：',
  'thread_rushreply_floor' => '奖励楼层',
  'thread_rushreply_limit' => '本课件为抢楼课件，{$rushresult[creditlimit_title]}大于{$rushresult[creditlimit]}可以抢楼',
  ...
  'debater' => '辩手',
  'login_to_reply' => '您需要登录后才可以学习笔记',
  'post_fastreply_gotolast' => '学习笔记后跳转到最后一页',
  'post_newreply' => '上传回复',
  'post_reply_relay' => '学习笔记并转播',
  ...
  'message_ishidden_hiddenreplies' => '此课件仅作者可见',
  ...
  'viewthread_trade_message3' => '并可以针对课件内所有商品添加统一的',
  'viewthread_trade_message4' => '柜台介绍',
  'warn_view_log' => '$warnuser 警告记录',
  'warn_view_prompt' => '$warnuser 已被累计警告 $warnnum 次，{$_G[setting][warningexpiration]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止发课件 {$_G[setting][warningexpiration]} 天',
  'main_nav' => '主导航',
  'quick_nav' => '快捷导航',
