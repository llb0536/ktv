...
$lang = array (
  ...
  'follow_relate_thread_null' => '没有相关课件',
  ...
  'upload' => '上传',
  'delete' => '删除',
  'follow_post_by_time' => '上传于',
  'follow_reply' => '转播',
  'follow_special_thread_tip' => '这是一个特殊课件，点这里可以回原课件查看详细内容',
  'follow_thread_deleted' => '该课件已被删除',
  'follow_followed' => '已收听',
  ...
  'interactive_help_message' => '<li>来访用户：指的是每天访问本站的唯一用户数。一个用户访问多次，也只算一次</li>
  									<li>{$_G[setting][navs][2][navname]}：指的是每天发布课件、投票、活动、悬赏、辩论、商品和课件学习笔记的总数量 </li>
									<li>群组：指的是每天创建{$_G[setting][navs][3][navname]}、{$_G[setting][navs][3][navname]}课件、{$_G[setting][navs][3][navname]}学习笔记的总数量 </li>
  ...
  'edit' => '编辑',
  'explain_album' => '您在课件系统或日志里面上传的图片附件，全部存放在 <a href="home.php?mod=space&uid=$space[uid]&do=album&id=-1" class="xw1 xi2">默认相册</a> 里',
  ...
  'manage_doing' => '管理记录',
  'manage_feed' => '管理动态',
  'manage_group_prune' => '群组课件',
  'manage_group_threads' => '群组课件',
  'manage_share' => '管理分享',
  'member_manage' => '用户管理',
  'message' => '留言板',
  ...
  'nothing' => '无',
  'task_admins' => '管理人员',
  'task_applicants' => '已有 $task[applicants] 位用户参与此任务',
  ...
  'author' => '作者',
  'del_select_thread' => '删除选中课件',
  'del_select_thread_confirm' => '确定要删除选中的课件吗？',
  'forum' => '版块',
  'friend_post' => '好友的课件',
  'group' => '群组',
  'hide_thread' => '本页有 $hiddennum 篇课件因隐私问题而隐藏',
  'ignored' => '已忽略',
  'last_post' => '最后发课件',
  'my_post' => '我的课件',
  'newest_thread' => '最新课件',
  'no_related_posts' => '还没有相关的课件',
  'post_comment' => '点评',
  'posted' => '发课件',
  'replies' => '回复/查看',
  'they_thread' => 'TA 的所有课件',
  'top_thread' => '热门课件',
  'additional' => '附加',
  'buy_trade' => '买家交易',
  ...
  'delete_pic_notice' => '删除图片提示：如果您要删除的图片出现在您的课件、日志、话题中，删除后，会导致内容里面的图片同时无法显示 ',
  'determine' => '确定',
  'edit_album' => '编辑相册',
  ...
  'modify_unitprice_note' => '竞价单价决定您在竞价排行中的排名，单价越高，您的排名越靠前。站上用户访问一次您的个人主页将从您的竞价总额中扣除相应的竞价值 ',
  ...
  'memcp_credits_log_payment' => '课件付费',
  'srch' => '查询',
  ...
  'view_right_setting_effective' => '相关浏览权限需要在上传时单独设置方可完全生效',
  'write_blog' => '撰写日志',
  ...
  'mode_one' => '方式一：',
  'mode_two' => '方式二：',
  'mode_two_desc' => '通过点击课件标题旁的“复制链接”，推广成功后也可以获得积分奖励 &nbsp; <a href="forum.php" class="xi2">去推广课件&raquo;</a>',
  'post_promotion' => '如果您的朋友通过下面任意一个链接访问站点并注册新用户，您将获得积分奖励 <span class="xi1">$regstr</span>',
  'post_promotion_reg' => '如果您的朋友不但访问并且注册成为用户，您将再获得积分奖励 <span class="xi1">$regstr</span>',
  ...
  'mail_pcomment' => '我的课件被人点评',
  'mail_piccomment' => '我的相册被评论',
  'mail_post' => '我的课件被人回复',
  'mail_pusearticle' => '我的日志或课件被推送成文章',
  'mail_reward' => '悬赏课件回复被设为最佳答案',
  ...
  'send_real_time' => '实时发送',
  'comment_add_inonetime' => '同时作为评论上传',
  'delete_share' => '删除分享',
