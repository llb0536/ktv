...
(
	...
	'cloud_status_error' => '出了点小错，由于站点ID/通信KEY等关键信息丢失导致Kejian.TV云平台服务出现异常，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测站点ID和KEY，如有疑问请访问<a href="http://www.kejian.tv/forum-3926-1.html" target="_blank">官方课件系统</a>寻求帮助',
	...
	'cloud_unknown_dns' => '您的站点目前无法连接Kejian.TV云平台，请检查您服务器网络设置，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测DNS解析和接口连通性。<a href="http://cp.discuz.qq.com/faq?fId=1305690058&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>，如有疑问请访问<a href="http://www.kejian.tv/forum-3926-1.html" target="_blank">官方课件系统</a>求助',
	...
	'cloud_sync_failure' => '站点信息同步失败，原因：<br />{errorMessage} (ERRCODE:{errorCode})<br /><br />如有疑问，请访问<a href="http://www.kejian.tv/forum-3926-1.html" target="_blank">官方课件系统</a>寻求帮助',
	...
	'cloud_doctor_setidkey_tips' => '<li style="color:red">修改Kejian.TV上的站点ID和KEY，可能会导致通信错误、签名错误以及其他的故障，请勿在没有官方人员指导的情况下修改。</li><li style="color:red">修改ID、KEY和状态前，请先备份课件系统的common_setting表。</li>',
	...
	'cloud_application_disable' => '您的站点已被禁止使用此项云服务，如果有疑问请访问<a href="http://www.kejian.tv/forum.php?gid=3923" target="_blank">官方课件系统</a>寻求帮助',

	'cloud_search_tips' => '<li>开启漫游搜索功能后，用户可以使用基于漫游的搜索功能。</li>',

	'cloud_stats' => '腾讯分析',
	'cloud_stats_tips' => '<li>选择的样式会显示在课件系统底部的右下方。</li>',
	...
	'cloud_smilies_tips' => '<li>搜尽天下表情，为网站带来无穷的乐趣与体验。</li><li>省略繁琐的上传表情流程，无缝“偷渡”QQ表情到您的网站，课件系统表情变得不再单调无味。</li>',

	'cloud_smilies_status' => '启用SOSO 表情',
	'cloud_storage' => '旋风存储',
	'cloud_storage_tips' => '<li>为网站节省空间带宽，让用户享受超大文件的高速存储，上传下载尽在云端。</li><li>体验高速上传下载，支持单个文件高达2GB的附件上传，附件永久有效，为课件系统降低成本。</li>',
	...
	'connect_setting_feed_allow' => '开启发课件同步推送到QQ空间动态',
	'connect_setting_feed_allow_comment' => '开启后，用户发课件可以同步推送到QQ空间动态，展现给用户的QQ空间好友',
	...
	'connect_setting_t_allow' => '开启发课件同步推送到腾讯微博',
	'connect_setting_t_allow_comment' => '开启后，用户发课件可以同步推送到腾讯微博，展现给用户的微博听众',
	...
	'connect_setting_t_reply_comment' => '推送课件或分享课件到腾讯微博后，是否允许微博评论和转播内容回流',
	...
	'connect_setting_qshare_allow_comment' => '用户选中课件内容中的任何一段文本时，可方便快捷的将选中的文本内容和区域内图片转播到腾讯微博',
	...
	'qqgroup_msg_deficiency' => '请至少推送一条头条课件和一条列表课件',
	...
	'qqgroup_search_order_recommends' => '课件评价倒序',

	'qqgroup_search_dateline_1' => '1小时内发布的课件',
	'qqgroup_search_dateline_2' => '24小时内发布的课件',
	'qqgroup_search_dateline_3' => '7天内发布的课件',
	'qqgroup_search_dateline_4' => '1个月内发布的课件',
	'qqgroup_search_dateline_0' => '不限制',

	'qqgroup_search_tid' => '课件ID:',
	'qqgroup_search_button' => '搜索',
	'qqgroup_search_threadslist' => '课件列表',
	'qqgroup_search_inforum' => '所在版块',
	'qqgroup_search_operation' => '操作',

	'qqgroup_search_loading' => '加载中...',
	'qqgroup_search_nothreads' => '未找到指定条件的课件，请尝试更换筛选条件重新搜索',
	...
	'qqgroup_setting_tips' => '<li>课件查看页的“推送到QQ群”功能，可将课件即时推送到QQ群聊天框。</li><li><img src="static/image/admincp/cloud/feed.png" align="left"></li>',

	'security_member_list' => '违规用户',
	'security_thread_list' => '违规课件',
	'security_post_list' => '违规学习笔记',
	...
	'security_tips' => '小技巧',
	'security_tips_1' => '<li><p>系统识别到违规课件和违规学习笔记后，自动将课件和学习笔记放入<a href="admin.php?action=recyclebin" style="text-decoration:none; color:#0000FF;">回收站</a></p></li>',
	...
	'security_forum_white_list_comment' => '所选版块内的课件和回复，防水墙不做处理，可以按住 CTRL 多选',
	'security_recyclebin_thread' => '到回收站处理课件',
	'security_recyclebin_post' => '到回收站处理学习笔记',
	'security_thread_status' => '课件状态',
	'security_post_status' => '学习笔记状态',
	...
	'search_setting_allow_thread_related' => '开启课件相关课件',
	'search_setting_allow_forum_related' => '开启板块相关课件',
	'search_setting_allow_collection_related' => '开启淘课件相关课件',
);
