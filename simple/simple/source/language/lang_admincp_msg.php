...
$lang = array (
  ...
  'counter_member_succeed' => '用户发课件数重建完成',
  ...
  'forums_threadtypes_duplicate' => '新增课件分类与现有重复',
  ...
  'counter_forum_succeed' => '课件系统课件数重建完成',
  'counter_digest_succeed' => '精华课件数重建完成',
  'counter_thread_succeed' => '课件课件数重建完成',
  ...
  'counter_groupmember_post_succeed' => '群组成员发课件数重建完成',
  ...
  'forums_delete_confirm' => '本操作不可恢复，您确定要删除该版块，清除其中课件和附件吗？<br />注意: 删除版块并不会更新用户发课件数和积分',
  ...
  'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中课件和附件吗？<br />注意：删除群组并不会更新用户发课件数和积分',
  ...
  'specialuser_hotuser_del_succeed' => '删除明星用户成功 ',
  ...
  'specialuser_hotuser_add_succeed' => '添加用户成功 ',
  ...
  'upgrade_successful' => '恭喜您，升级成功! <br />您当前的版本为：[Kejian.TV X{version} Release[{release}] <br /><br />为安全起见，升级文件已保存至{save_update_dir}目录，<br />备份文件已保存至{save_back_dir}目录 {upgradeurl}',
  ...
  'usergroups_update_credits_invalid' => '缺少积分下限为负数或 0 的用户用户组',
  'usergroups_update_credits_duplicate' => '用户用户组积分下限设置重复',
  ...
  'members_search_noresults' => '没有找到符合条件的用户',
