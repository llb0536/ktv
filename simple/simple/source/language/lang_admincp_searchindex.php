...
$lang = array (
  ...
  array (
    'index' =>
    array (
      '群组批量删课件' => 'action=prune&operation=group',
    ),
    'text' =>
    array (
      0 => '群组批量删课件',
  ...
  array (
    ...
    array (
      ...
      16 => '允许推荐课件',
      17 => '设置是否允许推荐管理范围内的课件 (要在相应版块的扩展设置里开启推荐课件功能)',
  ...
  array (
    ...
    array (
      ...
      4 => '允许审核课件',
      5 => '设置是否允许审核用户上传的课件，只在站点设置需要审核时有效',
      ...
      22 => '允许批量删课件',
      23 => '设置是否允许通过管理面板批量删课件，版主在面板中批量删课件的范围是 1 周内，超级版主删课件范围是 2 周内， 管理员无限制',
  ...
  array (
    ...
    array (
      ...
      13 => '允许 DIY',
      14 => '设置是否允许 DIY 课件系统，文章，空间，课件系统等页面',
    ),
  ),
  144 =>
  array (
  ...
  array (
    ...
    array (
      0 => '更新统计',
      1 => 'counter_tips',
      2 => '当下列数据不正常时，可以使用此功能对数据进行更新校正。请尽量避开用户访问的高峰时间
  ...
  array (
    ...
    array (
      ...
      18 => '备份文件名',
      19 => 'db_import_tips',
      20 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将课件系统关闭，恢复全部完成后可以将课件系统重新开放。恢复数据前请在 Kejian.TV X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
      21 => 'db_import',
      22 => '数据恢复',
    ),
  ),
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 支付宝',
      1 => 'ec_alipay_tips',
      2 => '“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Kejian.TV 用户提供积分购买及课件系统 B2C、C2C 交易平台。您只需进行简单的设置，即可使课件系统内容和人气，真成为除广告收入外的重要利润来源，从而实现课件系统的规模化经营。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方课件系统另行通知以外，Kejian.TV 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方课件系统提供的信息为准。您使用支付宝服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京Kejian.TV科技有限责任公司不对因使用此功能造成的任何损失承担责任。支付宝业务咨询 Email 为 6688@taobao.com；支付宝客户服务电话为 +86-0571-88156688。',
      3 => 'ec_alipay',
      4 => '支付宝设置',
      5 => 'ec_alipay_account',
      6 => '收款支付宝账号',
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方课件系统另行通知以外，Kejian.TV 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方课件系统提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京Kejian.TV科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      9 => '课件系统首页下级子版块横排',
      10 => '设置进入课件系统首页时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
      ...
      24 => '站点名称&nbsp;{bbname}（应用范围：所有位置）当前版块名称&nbsp;{forum}（应用范围：除首页以外）一级版块名称&nbsp;{fup}（应用范围：子版块课件列表页和课件内容页）分区名称&nbsp;{fgroup}（应用范围：除首页以外）课件标题&nbsp;{subject}（应用范围：课件内容页）课件摘要&nbsp;{summary}（应用范围：课件内容页）课件标签&nbsp;{tags}（应用范围：课件内容页）分页数&nbsp;{page}（应用范围：课件列表页、课件内容页）',
  ...
  array (
    ...
    array (
      ...
      22 => '版块转向 URL',
      23 => '如果设置转向 URL(例如 http://www.kejian.tv)，用户点击本分版块将进入转向中设置的 URL。一旦设定将无法进入版块页面，请确认是否需要使用此功能，留空为不设置转向 URL',
      24 => 'forums_edit_basic_description',
      25 => '版块简介',
      26 => '将显示于版块名称的下面，提供对本版块的简短描述支持内置的 Kejian.TV 代码',
      27 => 'forums_edit_basic_rules',
      28 => '本版块规则',
      29 => '显示于课件列表页的当前版块规则，留空为不显示支持内置的 Kejian.TV 代码',
      30 => 'forums_edit_basic_keys',
      31 => '绑定别名',
      32 => '绑定后当站点开启 URL 静态化后可通过别名访问此版块，如设置别名为“developer”那么版块的 URL 将变为“http://127.0.0.1/Kejian.TVX/tools/language_template/forum-developer-1.html”。注意：别名中只能包含字母或数字，且不能是纯数字',
      ...
      40 => '站点名称&nbsp;{bbname}（应用范围：所有位置）当前版块名称&nbsp;{forum}（应用范围：除首页以外）一级版块名称&nbsp;{fup}（应用范围：子版块课件列表页和课件内容页）分区名称&nbsp;{fgroup}（应用范围：除首页以外）课件标题&nbsp;{subject}（应用范围：课件内容页）课件摘要&nbsp;{summary}（应用范围：课件内容页）课件标签&nbsp;{tags}（应用范围：课件内容页）分页数&nbsp;{page}（应用范围：课件列表页、课件内容页）',
  ...
  array (
    ...
    array (
      ...
      9 => '课件系统版块下级子版块横排',
      10 => '设置进入课件系统版块时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
      ...
      15 => '只显示下级子版块',
      16 => '选择“是”将不显示本版块的课件列表、发课件按钮等等，类似于一个分类',
      17 => 'forums_edit_extend_sub_horizontal',
      18 => '课件系统版块下级子版块横排',
      19 => '设置进入课件系统版块时下级子版块横排时每行版块数量，如果设置为 0，则按正常方式排列',
      ...
      24 => '只显示下级子版块',
      25 => '选择“是”将不显示本版块的课件列表、发课件按钮等等，类似于一个分类',
      ...
      39 => '课件默认排序字段',
      40 => '设置版块的课件列表默认按照哪个字段进行排序显示。默认为“回复时间”，除默认设置外其他排序方式会加重服务器负担',
      41 => 'forums_edit_extend_defaultorder',
      42 => '课件默认排序方式',
      43 => '设置版块的课件列表默认排序的方式。默认为“按降序排列”，除默认设置外其他排序方式会加重服务器负担',
      44 => 'forums_edit_extend_threadcache',
      45 => '页面缓存系数',
      46 => '此功能可以将游客经常访问的课件临时缓存起来，缓解大型服务器压力。系数范围 0～100，建议数值 20 ～ 40，0 为关闭缓存。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果注：版块设置完毕后请到 全局 -> 优化设置 -> 站点页面缓存设置，调整其缓存时间',
      47 => 'forums_edit_extend_relatedgroup',
      48 => '关联群组/版块',
      49 => '填写被关联群组/版块的fid，以半角逗号 "," 隔开。版块的课件列表页将显示被关联群组/版块的课件',
      50 => 'forums_edit_extend_edit_rules',
      51 => '允许版主修改本版块规则',
      52 => '设置是否允许超级版主和版主修改本版规则',
      53 => 'forums_edit_extend_disablecollect',
      54 => '禁止淘课件',
      55 => '选择“是”将禁止用户淘课件本版课件',
  ...
  array (
    ...
    array (
      ...
      6 => '发课件审核',
      7 => '选择“是”将使用户在本版上传的课件待版主或管理员审查通过后才显示出来，打开此功能后，您可以在用户组中设定哪些组发课件可不经审核，也可以在管理组中设定哪些组可以审核别人的课件',
      8 => 'forums_edit_posts_alloweditpost',
      9 => '允许编辑课件',
      10 => '选择“是”将允许用户编辑本版上传的课件',
      11 => 'forums_edit_posts_recyclebin',
      12 => '回收站',
      13 => '是否在本版启用回收站功能，打开此功能后，所有被删除课件和学习笔记将被放在回收站中，而不会被直接删除',
      ...
      33 => '允许匿名发课件',
      34 => '是否允许用户在本版匿名上传课件和回复，只要用户组或本版块允许，用户均可使用匿名发课件功能。匿名发课件不同于游客发课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
      ...
      50 => '课件自动关闭',
      51 => '设置课件是否在某时间后自动关闭，禁止普通用户回复',
      52 => 'forums_edit_posts_autoclose_time',
      53 => '自动关闭时间(天)',
      54 => '本设定必须在“课件自动关闭”功能打开时才生效，课件依据自动关闭的设定: 在上传后若干天、或被最后回复后若干天被自动转入关闭状态，从而使普通用户无法回复',
      ...
      59 => '允许发送广播和动态',
      60 => '开启后默认允许用户发送广播和动态，广播是否发送用户可以在发课件时去掉，隐私版块建议设为否。',
  ...
  array (
    ...
    array (
      '版块管理' => 'action=forums',
      '课件分类' => 'action=forums&operation=edit&anchor=threadtypes',
    ),
    'text' =>
    array (
      0 => '版块管理 &raquo; 课件分类',
      ...
      6 => '启用课件分类',
      7 => '设置是否在本版块启用课件分类功能，您需要同时设定相应的分类选项，才能启用本功能',
      8 => 'forums_edit_threadtypes_required',
      9 => '发课件必须归类',
      10 => '是否强制用户上传新课件时必须选择分类',
      11 => 'forums_edit_threadtypes_listable',
      12 => '允许按类别浏览',
      13 => '用户是否可以按照课件分类筛选浏览内容',
      14 => 'forums_edit_threadtypes_prefix',
      15 => '类别前缀',
      16 => '是否在课件前面显示分类的名称',
      17 => 'forums_edit_threadtypes',
      18 => '课件分类',
      19 => '您可以启用已有的课件分类或添加新课件分类应用于本版块，在分类很多的情况下，建议只有重要的分类使用“平板显示”方式，更多的分类使用“下拉显示”方式',
    ),
  ),
  183 =>
  array (
  ...
  array (
    ...
    array (
      ...
      4 => '版块权限',
      5 => '某权限如果全部未选则表示如下含义:　　浏览版块，全部用户组具有浏览版块课件权限；发新话题，除游客以外的用户组具有发课件权限；上传回复，除游客以外的用户组具有回复权限；查看附件，全部用户组具有下载/查看附件权限；上传附件，除游客以外的用户组具有上传附件权限；上传图片，除游客以外的用户组具有上传图片权限',
      ...
      16 => '版块权限',
      17 => '某权限如果全部未选则表示如下含义:　　浏览版块，全部用户组具有浏览版块课件权限；发新话题，除游客以外的用户组具有发课件权限；上传回复，除游客以外的用户组具有回复权限；查看附件，全部用户组具有下载/查看附件权限；上传附件，除游客以外的用户组具有上传附件权限；上传图片，除游客以外的用户组具有上传图片权限',
      18 => 'forums_edit_perm_formula',
      19 => '权限表达式设置',
      20 => '当您设定了权限表达式后，只有符合此表达式的用户才可以浏览本版块。如 "posts > 100 and extcredits1 > 10" 表示 "发课件数 > 100 并且 威望 > 10"日期格式 "{Y-M-D}"，如 "{2009-10-1}"。IP 格式 "{x.x.x.x}"，既可输入完整地址，也可只输入 IP 开头，如 "{10.0.0.1}"、"{192.168.0}"',
  ...
  array (
    ...
    array (
      ...
      15 => '选择管理用户组(在群组中具有与课件系统中相对应的管理权限)',
      16 => 'forums_edit_posts_allowfeed',
      17 => '允许发送广播和动态',
      18 => '开启后默认允许用户发送广播和动态，广播是否发送用户可以在发课件时去掉，隐私版块建议设为否。',
    ),
  ),
  187 =>
  array (
  ...
  array (
    ...
    array (
      0 => '群组等级',
      1 => 'group_level_tips',
      2 => '群组等级不宜设置过多。当允许群组内发课件等操作影响用户积分时应谨慎，用户有可能通过群组刷积分。默认等级图标大小是25 X 25像素。',
    ),
  ),
  189 =>
  array (
  ...
  array (
    'index' =>
    array (
      '编辑用户用户组' => 'action=members&operation=group',
    ),
    'text' =>
    array (
      0 => '编辑用户用户组',
  ...
  array (
    ...
    array (
      ...
      2 => 'Kejian.TV 支持对用户 8 种扩展积分的设置，只有被启用的积分才允许您进行编辑。修改用户的某项积分会造成该用户总积分的变化，从引起普通用户等级的变化，因此请仔细设置各项积分。',
  ...
  array (
    ...
    array (
      ...
      2 => '本功能用于自定义首页及课件列表页显示的在线用户分组及图例，只在在线列表功能打开时有效。用户组图例处空白为不区分该组用户，所有未区分的用户组将统一归入第一行的“普通用户”项。用户组图例中请填写图片文件名，并将相应图片文件上传到 static/image/common/ 目录中。',
    ),
  ),
  202 =>
  array (
    ...
    array (
      0 => '友情链接',
      1 => 'misc_link_tips',
      2 => '如果您不想在课件系统首页显示友情链接，可以在“界面设置”中关闭。未填写文字说明的项目将以紧凑型显示。
  ...
  array (
    ...
    array (
      ...
      2 => '只有在自定义 Kejian.TV 代码可用并设置了图标文件时，具有“允许使用自定义 Kejian.TV 代码”权限的用户组在发课件时才会看到相应自定义 Kejian.TV 代码按钮。',
    ),
  ),
  205 =>
  array (
    ...
    array (
      0 => '词语过滤',
      1 => 'misc_censor_tips',
      2 => '替换前的内容可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略的字节数。如 "a{1}s{2}s"(不含引号) 可以过滤 "ass" 也可过滤 "axsxs" 和 "axsxxs" 等等。对于中文字符，若使用 GBK、Big-5 版本，每个中文字符相当于 2 个字节；若使用 UTF-8 版本，每个中文字符相当于 3 个字节。为不影响程序效率，请不要设置过多不需要的过滤内容。审核只对课件系统中的内容有效如果您不是课件系统管理员，您将只能对自己添加的项目进行编辑或删除。不良词语如果以"/"(不含引号)开头和结尾则表示格式为正则表达式，这时替换内容可用"(n)"引用正则中的子模式，如"/1\\d{10}([^\\d]+|$)/"替换为"手机(1)"。',
      3 => 'misc_censor_batch_add_tips',
      4 => '每行一组过滤词语，不良词语和替换词语之间使用“=”进行分割；如需禁止发布包含某个词语的文字，而不是替换过滤，请将其对应的替换内容设置为{BANNED}即可；如需当用户发布包含某个词语的文字时，自动标记为需要人工审核，而不直接显示或替换过滤，请将其对应的替换内容设置为{MOD}即可(审核只对课件系统中的内容有效)。如果只是想将某个词语直接替换成 **，则只输入词语即可；例如：toobadnobadbadword=goodsexword={BANNED}导出/导入时支持词语分类导入，导入时不带有分类则可以通过选择指定导入分类。没有分类时自动归入默认分类',
...
',
  ...
  array (
    ...
    array (
      ...
      8 => '被点评课件 ID',
      9 => '指定课件的所有点评(包括课件课件和学习笔记)，多 ID 中间请用半角逗号 "," 隔开',
  ...
  array (
    ...
    array (
      0 => '课件系统批量删课件',
      1 => 'prune_tips',
      2 => '批量删课件仅用于删除违规课件使用，如您需要批量删除历史旧课件，请使用批量课件管理功能。使用此功能，需同时提供起始时间和终止时间其中之一，及发课件用户名、发课件 IP、内容关键字其中之一，至少共二项必要的条件，否则将无法进行操作。如果符合删除条件的课件为课件第一课件，或该课件无回复，将删除整个课件。如果您不是课件系统管理员，您只能删除从某一时间到现在的范围内的课件。超级版主的删课件的时间范围为二星期(14 天)；版主的时间范围为一星期(7 天)且只能删除所管辖课件系统内的课件。关键字可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。',
  ...
  array (
    ...
    array (
      ...
      40 => '默认记录提示内容',
      41 => '一行为一个提示内容，这些内容将在记录上传框中显示，随机从这些默认提示中选取一行做为提示内容',
    ),
  ),
  228 =>
  array (
  ...
  array (
    ...
    array (
      ...
      2 => '允许新用户注册',
      3 => '设置是否允许游客注册成为站点用户，您可以根据站点需求选择注册方式',
      ...
      12 => '邀请新注册用户奖励所用扩展积分',
      13 => '邀请新注册用户奖励所用的扩展积分，包括奖励邀请人和被邀请人的奖励积分',
      ...
      33 => '注册地址:',
      34 => '设置站点注册地址 mod 值，默认为“register”，修改名称有利于防止灌水软件，有别于 Kejian.TV X 之前的版本更改了此设置，不需要修改任何文件名称，只在此修改即可',
  ...
  array (
    ...
    array (
      ...
      2 => '新手见习期限(分钟)',
      3 => '新注册用户在本期限内将无法发课件和短消息，不影响版主和管理员，0 为不限制',
      ...
      11 => '允许上传的域名列表',
      12 => '当用户组禁止上传 URL ，或者 URL 不解析时，处于本列表中的域名下的 URL 仍然可以正常上传，正常解析，每行一个域名，默认为本站域名可以正常上传',
    ),
  ),
  231 =>
  array (
    ...
    array (
      ...
      6 => '站点默认风格',
      7 => '站点默认的界面风格，游客和使用默认风格的用户将以此风格显示',
      ...
      18 => '站点宽窄风格',
      19 => '设置站点的显示风格是宽版还是窄版。其中课件系统的版块中还可以进行独立的设置',
      20 => 'setting_styles_index_switchwidthauto',
      21 => '允许用户自由切换',
      22 => '设置是否允许用户自由切换宽窄风格',
      23 => 'setting_styles_global_jsmenu',
      24 => '课件系统显示版块跳转菜单',
      25 => '注意: 当课件系统分版块很多时，本功能会严重加重服务器负担',
  ...
  array (
    ...
    array (
      '界面设置' => 'action=setting&operation=styles',
      '课件系统首页' => 'action=setting&operation=styles&anchor=index',
    ),
    'text' =>
    array (
      0 => '界面设置 &raquo; 课件系统首页',
      ...
      25 => '显示边栏',
      26 => '选择“是”课件系统首页侧边将显示聚合课件系统内容的信息',
      27 => 'setting_styles_index_whosonline',
      28 => '显示在线用户',
      29 => '设置是否在课件系统首页底部和课件系统版块边栏显示在线用户列表',
      30 => 'setting_styles_index_whosonline_contract',
      31 => '缩略显示在线列表',
      32 => '如果打开该选项，在线列表将只显示在线用户数，不显示详情，此时用户可手动打开在线用户列表(最大在线超过 500 人系统将自动缩略显示在线列表)',
  ...
  array (
    ...
    array (
      ...
      18 => '启用全局置顶',
      19 => '选择“是”，置顶 III 的课件将在全部课件系统显示，置顶 II 的课件将在当前分区中显示。注意: 本功能会加重服务器负担',
      ...
      45 => '封面图显示数量',
      46 => '当版块开启图片列表模式时有效，0或不填 将和普通列表模式每页显示课件数一致',
  ...
  array (
    ...
    array (
      ...
      21 => '相关淘专辑条目数',
      22 => '在课件课件中显示相关淘专辑的条目数，0 为不显示',
      23 => 'setting_styles_viewthread_relate_number',
      24 => '相关课件条目数',
      25 => '在课件课件中显示相关课件的条目数，0 为不显示',
      26 => 'setting_styles_viewthread_relate_time',
      27 => '相关课件缓存时间',
      28 => '单位：分钟，在课件课件中显示相关课件的缓存时间（0 为不缓存，不推荐）',
      ...
      39 => '课件内图片最大宽度',
      40 => '当课件内图片宽度大于设置的值时图片宽度会被自动调节。请填写整数值，不支持百分比数值',
      41 => 'setting_styles_viewthread_imagelistthumb',
      42 => '课件内图片列表中图片横排显示条件',
      43 => '设置当课件内图片列表中图片数量满足多少张以后以横排方式显示，0 或留空为关闭横排显示',
      44 => 'setting_styles_viewthread_zoomstatus',
      45 => '是否使用图片动态放大效果',
      46 => '当课件内图片宽度大于“课件内图片最大宽度”时是否附加鼠标点击时的动态放大效果。选择“是”单击图片会有动态放大效果，选择“否”将会新窗口打开图片',
      ...
      60 => '课件顺序名称',
      61 => '设置每篇课件所有课件的顺序名称，每行填写一个名称，第一行代表课件课件，第二行代表课件的第一个回复，以此类推',
      62 => 'setting_styles_viewthread_maxsmilies',
      63 => '最大单一表情解析次数',
      64 => '在一篇课件中解析的单一表情符号的最大次数，超过此次数限制的表情将不被解析而保留原样，以避免用户在一篇课件中恶意上传大量表情影响正常阅读，0 为不限制',
      65 => 'setting_styles_viewthread_author_onleft',
      66 => '作者用户名显示位置',
      67 => '显示位置并不会影响课件系统的性能和美观，请根据您用户的浏览习惯进行选择',
  ...
  array (
    ...
    array (
      ...
      7 => '开启直接/快速跳转',
      8 => '对于站点中的某些成功的操作不显示提示信息，直接跳转到下一个页面，例如发课件，回复等等，可以节省用户等待跳转的时间',
  ...
  array (
    ...
    array (
      ...
      13 => '发课件页面',
      14 => '发课件页面的弹出信息，每行填写一条信息，多条信息将随机显示',
  ...
  array (
    ...
    array (
      '性能优化' => 'action=setting&operation=seo',
      '课件系统页面缓存设置' => 'action=setting&operation=cachethread',
    ),
    'text' =>
    array (
      0 => '性能优化 &raquo; 课件系统页面缓存设置',
      1 => 'setting_cachethread',
      2 => '课件系统页面缓存设置',
      3 => '开启后，缓存页面内容到静态文件，游客访问时速度将大大提升，建议独立服务器使用，虚拟空间请根据实际情况调节缓存的有效期',
      4 => 'setting_cachethread_indexlife',
      5 => '缓存课件系统首页有效期',
      6 => '设置课件系统首页缓存更新的时间，单位为秒，0 为关闭(此处关闭以后，缓存系数将不再起作用)，建议设置为 900。此功能只针对游客',
      7 => 'setting_cachethread_life',
      8 => '缓存课件有效期',
      9 => '设置课件页面缓存更新的时间，单位为秒，0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑课件系统来指定课件页面缓存系数',
      ...
      16 => '缓存系数',
      17 => '页面缓存功能可以将用户经常访问的课件临时缓存起来，缓解大型课件系统服务器压力。缓存阀值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
  ...
  array (
    ...
    array (
      ...
      35 => '是否关闭session机制',
      36 => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能（注意：游客数和用户的在线时长将不再进行统计，课件系统首页和版块列表页面的在线用户列表功能将不可用）',
  ...
  array (
    ...
    array (
      ...
      7 => '开启课件系统管理工作统计',
      8 => '课件系统管理工作统计可以使版主、管理员了解课件系统版主等管理人员的工作状况。注意: 本功能会轻微加重系统负担',
      9 => 'setting_functions_archiver',
      10 => '开启课件系统 简明版 功能',
      11 => '课件系统 简明版 能够将课件系统公开的内容模拟成静态页面，以便搜索引擎获取其中的内容',
      12 => 'setting_functions_archiverredirect',
      13 => '禁止用户访问 简明版',
      14 => '选择“是”，当用户通过搜索引擎中的链接访问 简明版 页时将自动跳转到原始内容页',
      15 => 'setting_functions_mod_maxmodworksmonths',
      16 => '管理记录保留时间(月)',
      17 => '系统中保留管理记录的时间，默认为 3 个月，建议在 3～6 个月的范围内取值',
      18 => 'setting_functions_mod_losslessdel',
      19 => '删课件不减积分时间期限(天)',
      20 => '设置版主或管理员从前台删除上传于多少天以前的课件时，不更新用户的扩展积分，可用于清理老课件而不对作者的扩展积分造成损失。0 为不使用此功能，始终更新用户积分',
  ...
  array (
    ...
    array (
      ...
      2 => '课件热度将按参与人次计算，包括学习笔记，点评，收藏，分享，评分，推荐',
      3 => 'setting_functions_heatthread_period',
      4 => '用户热度值周期(天)',
      5 => '以天为单位，一个周期内某用户多次参与课件，只加一次热度。0代表不设置周期，只要参与一次，热度就加1。为避免用户刷热度，建议不要设置为0。(回复、点评、评论、收藏、分享等都算作参与课件的动作)',
  ...
  array (
    ...
    array (
      ...
      2 => '不同用户组用户的课件评价影响值不同，您可以在”用户组”设置的“课件相关”中设置。',
  ...
  array (
    ...
    array (
      ...
      2 => '点评方式',
      3 => '设置点评的上传方式，如不选择表示不启用点评功能。开启任意一种点评方式都需要在用户组中设置点评权限“直接点评”即通过课件每楼层中的“点评”链接上传点评“楼层回复”即通过课件每楼层中的“回复”链接上传学习笔记时，自动对该楼层产生点评注意：点击课件中的“回复”链接，不会对课件产生点评',
      ...
      11 => '允许点评楼主课件',
      12 => '设置是否允许直接点评楼主课件，关闭表示只能点评学习笔记',
  ...
  array (
    ...
    array (
      ...
      2 => '允许查看用户的课件和课件',
      3 => '设置是否允许查看其他用户的课件和课件，选择相应的版块那么在个人空间将出现“课件”模块和链接',
      4 => 'setting_permissions_allowviewuserthread_fids',
      5 => '允许查看哪些版块的课件',
      6 => '设置允许查看其他用户哪些版块的课件和课件',
      ...
      13 => '课件最小字数(字节)',
      14 => '管理组成员可通过“发课件不受限制”设置而不受影响，0 为不限制',
      15 => 'setting_permissions_maxpostsize',
      16 => '课件最大字数(字节)',
      17 => '管理组成员可通过“发课件不受限制”设置而不受影响',
      ...
      33 => '评分时间限制(小时)',
      34 => '课件上传后超过此时间限制其他用户将不能对此课件评分，版主和管理员不受此限制，0 为不限制',
      35 => 'setting_permissions_modratelimit',
      36 => '版主评分限制',
      37 => '设置版主只能在自身所管辖的版块范围内对课件进行评分。本限制只对版主有效，允许评分的普通用户及超级版主、管理员不受此限制，因此如果赋予这些用户评分权限，他们仍将可以在全版块范围内进行评分',
      ...
      46 => '距发课件日期天数超过此设置时标签自动失效，0或不填为不限制',
    ),
  ),
  250 =>
  array (
  ...
  array (
    ...
    array (
      ...
      7 => '验证码发课件限制',
      8 => '发课件数超过此设置的用户将不受验证码功能限制，0 表示所有用户均受限制',
  ...
  array (
    ...
    array (
      ...
      7 => '启用验证问答',
      8 => '验证问答功能要求用户必须正确回答系统随机抽取的问题才能继续操作，可以避免恶意注册或发布信息，请选择需要打开验证问答的操作。注意: 启用该功能会使得部分操作变得繁琐，建议仅在必需时打开',
      9 => 'setting_sec_secqaa_minposts',
      10 => '验证问答发课件限制',
      11 => '发课件数超过此设置的用户将不受验证问答功能限制，0 表示所有用户均受限制',
  ...
  array (
    ...
    array (
      ...
      4 => '禁止发课件时间段',
      5 => '每天该时间段内用户不能发课件，请使用 24 小时时段格式，每个时间段一行，如需要也可跨越零点，留空为不限制。例如:每日晚 11:25 到次日早 5:05 可设置为: 23:25-5:05每日早 9:00 到当日下午 2:30 可设置为: 9:00-14:30注意: 格式不正确将可能导致意想不到的问题，用户组中如开启“不受时间段限制”的选项，则该组可不被任何时间段设置约束。所有时间段设置均以站点系统默认时区为准，不受用户自定义时区的影响',
      6 => 'setting_datetime_postmodperiods',
      7 => '发课件审核时间段',
      8 => '每天该时间段内用户发课件不直接显示，需经版主或管理员人工审核才能上传，格式和用法同上',
      9 => 'setting_datetime_postignorearea',
      10 => '发课件不受时间限制的地区列表',
      11 => '当用户处于本列表中的地址时，发课件不受时间段限制。每个地区一行，例如 "北京"(不含引号)，留空为不设置。注意：如要正确无误的判断您 IP 地址所在的地区，请到网上下载 qqwry.dat IP 地址库文件上传到 "data/ipdata/" 目录下更名为 wry.dat，同时删除 tinyipdata.dat 文件',
      12 => 'setting_datetime_postignoreip',
      13 => '发课件不受时间限制的IP列表',
      14 => '当用户处于本列表中的 IP 地址时，发课件不受时间段限制。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头，例如 "192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为不设置',
    ),
  ),
  258 =>
  array (
  ...
  array (
    ...
    array (
      '上传设置' => 'action=setting&operation=attach',
      '课件系统附件' => 'action=setting&operation=attach&anchor=forumattach',
    ),
    'text' =>
    array (
      0 => '上传设置 &raquo; 课件系统附件',
      ...
      5 => '附件 URL 地址、媒体附件播放',
      6 => '开启附件 URL 地址后，上传附件的地址可通过 "attach://aid" 方式在任何课件内引用，并支持媒体类附件的直接播放，此项设置需要在 用户组 - 课件相关 中允许用户组使用多媒体代码方可生效',
      ...
      20 => '附件链接有效期',
      21 => '单位：小时，0 或留空表示附件链接永久有效，过期后链接自动更新。本功能可有效防止附件被盗链或附件被软件批量下载，但是会给用户的正常下载带来不便',
  ...
  array (
    ...
    array (
      '水印设置' => 'action=setting&operation=imgwater',
      '课件系统' => 'action=setting&operation=imgwater&anchor=forum',
    ),
    'text' =>
    array (
      0 => '水印设置 &raquo; 课件系统',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      30 => '是否允许其他应用的用户在站点激活',
      31 => '选择“是”，允许用户在本站点激活；选择“否”，则不允许任何第三方应用在本站点激活',
  ...
  array (
    ...
    array (
      ...
      9 => '不参与排行的版块/群组',
      10 => '填入版块ID或群组ID，对应版块及下面的课件将不进入排行榜，多个版块ID间请用半角逗号 "," 隔开',
  ...
  array (
    ...
    array (
      ...
      2 => '提供方便手机方式浏览的页面，此功能仅限课件系统范围内。本手机功能页仅支持WAP2.0(XHTML方式)以上的手机浏览器进行访问。手机浏览图片宽度为200像素以内缩略图。',
      3 => 'setting_mobile_status',
      4 => '手机版全局设置',
      5 => 'setting_mobile_allowmobile',
      6 => '开启手机版',
      7 => '开启本功能，用户使用手机访问课件系统时，将自动跳转到手机版界面手机访问域名配置请进入: 全局 - 域名设置 - 应用域名底部导航设置请进入：界面 - 导航设置 - 底部导航',
      8 => 'setting_mobile_mobileforward',
      9 => '开启手机浏览器自动跳转',
      10 => '开启后用户使用手机浏览器访问社区课件系统功能页以外页面时自动跳转到课件系统首页进行访问',
      ...
      30 => '首页分区展示方式',
      31 => '如“收起”，课件系统首页将默认只展示分区标题用户需点击分区展开该分区下的版块列表',
      32 => 'setting_mobile_come_from',
      33 => '手机发课件来源自定义',
      34 => '默认留空，如果填写，将在看课件页面"来自手机"处增加自定义文字或图标如:&lt;a href=\'http://m.x.com\'&gt;手机频道&lt;/a&gt;此处支持HTML标签有：&lt;a&gt;&lt;font&gt;&lt;span&gt;&lt;strong&gt;&lt;b&gt;&lt;img&gt;如果使用图标，请保证图片高度在16px(像素)以内',
    ),
  ),
  273 =>
  array (
  ...
  array (
    ...
    array (
      ...
      2 => '课件分表功能可将 forum_thread 表(包含课件标题、创建时间等信息，但不包含课件及回复内容)分在多个数据表中。创建新的课件存档表后，可使用课件移动功能将特定课件移动到存档表中。移动到存档表中的课件，会在课件所在的版块下建立一个存档区(名称可自定义)，通过存档区可浏览存档表中的课件。存档表中的课件，只供浏览，不可回复、评分，不能进行管理操作，但可以删除和移动到非存档区。',
  ...
  array (
    ...
    array (
      ...
      2 => '当站点进行了数据恢复、升级或者工作出现异常的时候，您可以使用本功能重新生成缓存。更新缓存的时候，可能让服务器负载升高，请尽量避开用户访问的高峰时间
				数据缓存：更新站点的全部数据缓存
				模板缓存：更新课件系统模板、风格等缓存文件，当您修改了模板或者风格，但是没有立即生效的时候使用
  ...
  array (
    ...
    array (
      0 => '用户组',
      1 => 'usergroups_tips',
      2 => '用户组分为系统组、用户组和自定义组，用户组以积分确定组别和权限，而系统组和自定义组是人为设定，不会由系统自行改变。系统组和自定义组的设定不需要指定积分，Kejian.TV 预留了从站点管理员到游客等的 8 个系统头衔，自定义组的用户需要在编辑用户时将其加入。用户用户组至少分为两组，其积分下限分别为负值(任一负数)和 0，否则将导致部分用户无法与用户组匹配的问题。',
    ),
  ),
  285 =>
  array (
  ...
  array (
    ...
    array (
      ...
      38 => '允许发站外URL',
      39 => '是否允许发课件包含URL，合理的设置可以有效的减少广告课件的量',
      40 => 'usergroups_edit_basic_allow_statdata',
      41 => '允许查看站点统计',
      42 => 'usergroups_edit_basic_search_post',
      43 => '允许全文搜索',
      44 => '此设置只对搜索课件系统有效。注意: 当数据量大时，全文搜索将非常耗费服务器资源，请慎用',
      ...
      58 => '用户每小时发课件数限制',
      59 => '设置允许用户每小时最多的发课件数量，可以配合灌水预防功能进一步限制用户的发课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
      60 => 'usergroups_edit_basic_hour_posts',
      61 => '用户每小时发学习笔记数限制',
      62 => '设置允许用户每小时最多的发学习笔记数量，可以配合灌水预防功能进一步限制用户的发课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
      ...
      67 => '上传不受限制',
      68 => '设置上传是否不受灌水预防和最大字数等',
      69 => 'usergroups_edit_basic_ignore_censor',
      70 => '忽略需要审核的关键字',
      71 => '选择“是”则此用户组的用户在上传时不会触发需要审核的关键字',
  ...
  array (
    ...
    array (
      ...
      7 => '允许上传回复',
      8 => '设置是否允许上传回复。注意: 只有当用户组阅读权限高于 0 时，才能上传回复',
      9 => 'usergroups_edit_post_direct',
      10 => '允许直接发课件',
      11 => '是否允许直接发课件或者对回复及课件进行审核，此设置受版块审核影响，如果版块设置为不需要审核，则此设置无效',
      12 => 'usergroups_edit_post_allow_down_remote_img',
      13 => '允许下载远程图片',
      14 => '远程图片本地化保存',
      15 => 'usergroups_edit_post_anonymous',
      16 => '允许发匿名课件',
      17 => '是否允许用户匿名上传课件和回复，只要用户组或本课件系统允许，用户均可使用匿名发课件功能。匿名发课件不同于游客发课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
      18 => 'usergroups_edit_post_set_read_perm',
      19 => '允许设置课件权限',
      20 => '设置是否允许设置课件需要指定阅读权限才可浏览',
      21 => 'usergroups_edit_post_maxprice',
      22 => '课件(附件)最高售价',
      23 => '课件(附件)出售使得作者可以将自己上传的课件(附件)隐藏起来，只有当浏览者向作者支付相应的交易积分后才能查看课件(附件)内容。此处设置用户出售课件(附件)时允许设置的最高价格，0 为不允许用户出售。注意: 本功能需在 全局设置中启用交易积分后才可使用。如开启版主及管理员的出售课件(附件)功能，请将其最高价格设置为高于普通用户组允许的最高价格，这样在课件被编辑时不至于导致课件(附件)售价的硬性下调',
      ...
      43 => '编辑课件时间限制(分钟)',
      44 => '课件作者发课件后超过此时间限制将不能再编辑课件，版主和管理员在 全局 - 用户权限 选择“允许用户随时编辑的课件类型”后不受此限制，0 为不限制',
      45 => 'usergroups_edit_post_allowreplycredit',
      46 => '允许设置学习笔记奖励',
      47 => '允许用户在发布课件时给予学习笔记者一定的扩展积分奖励。学习笔记奖励默认积分可在全局 - 积分设置指定',
      ...
      55 => '楼层回复点评',
      56 => '允许用户通过点击课件中的“回复”链接回复他人学习笔记时，自动对该楼层产生点评注意：只有在 全局 - 站点功能 - 课件点评 中开启楼层回复功能，本设置才会生效；点击课件中的“回复”链接，不会对课件产生点评',
      57 => 'usergroups_edit_post_allowcommentitem',
      58 => '允许用户在点评时上传观点',
      59 => '允许用户在点评时上传观点注意：只有在 全局 - 站点功能 - 课件点评 中开启直接点评功能，本设置才会生效',
      60 => 'usergroups_edit_post_allowat',
      61 => '发课件时可 @ 其他人的数量',
      62 => '0为不允许 @ 其他人（包括他关注的人和他的好友）',
      63 => 'usergroups_edit_post_allowsetpublishdate',
      64 => '允许设置定时发布',
      65 => '允许用户在发布课件时设置指定的发课件时间。只能设置在每半小时（如 13:00 或 13:30）自动发布。',
  ...
  array (
    ...
    array (
      ...
      4 => '允许下载附件',
      5 => '设置是否允许在没有设置特殊权限的课件系统中下载附件',
      6 => 'usergroups_edit_attach_getimage',
      7 => '允许查看图片',
      8 => '设置是否允许在没有设置特殊权限的课件系统中查看图片',
      9 => 'usergroups_edit_attach_post',
      10 => '允许上传附件',
      11 => '设置是否允许上传附件到没有设置特殊权限的课件系统中。需要 PHP 设置允许才有效，请参考管理中心首页',
      12 => 'usergroups_edit_attach_set_perm',
      13 => '允许设置附件权限',
      14 => '设置是否允许设置附件需要指定积分以上才可下载',
      15 => 'usergroups_edit_image_post',
      16 => '允许上传图片',
      17 => '设置是否允许上传图片到没有设置特殊权限的课件系统中。需要 PHP 设置允许才有效，请参考管理中心首页',
      18 => 'usergroups_edit_attach_max_size',
      19 => '课件系统最大附件尺寸(单位K 1M=1024K)',
  ...
  array (
    ...
    array (
      ...
      4 => '文章评论字数',
      5 => '设置此用户组上传文章评论字数限制，设置为0将禁止此用户组上传评论',
