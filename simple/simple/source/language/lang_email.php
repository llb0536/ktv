...
{siteurl}</p>',
	...
	'email_register_subject' =>	'课件系统注册地址',
...
{siteurl}</p>',
	...
	'add_member_subject' =>		'您被添加成为用户',
	'add_member_message' => 	'
{newusername} ，
这封信是由 {bbname} 发送的。<br />
<br />
我是 {adminusername} ，{bbname} 的管理者之一。您收到这封邮件，是由于您<br />
刚刚被添加成为 {bbname} 的用户，当前 Email 即是我们为您注册的邮箱地址。<br />
<br />
----------------------------------------------------------------------<br />
重要！<br />
----------------------------------------------------------------------<br />
<br />
如果您对 {bbname} 不感兴趣或无意成为用户，请忽略这封邮件。<br />
<br />
----------------------------------------------------------------------<br />
帐号信息<br />
----------------------------------------------------------------------<br />
...
<br />
如果您并非 {bbname} 的用户，或今天并非您的生日，可能是有人误用了您的邮<br />
