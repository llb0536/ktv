...
$lang = array (
  ...
  'thread_nonexistence' => '抱歉，指定的课件不存在或已被删除或正在被审核',
  'parameters_error' => '参数错误',
  'thread_poll_succeed' => '投票成功 ',
  'thread_rate_range_invalid' => '请输入正确的分值',
  'rate_post_error' => '课件不存在或不能被推送',
  'thread_rate_log_nonexistence' => '抱歉，指定课件在近一年内没有评分记录',
  'targetpost_donotbelongto_thisthread' => '目标课件不属于本课件',
  ...
  'thread_poll_closed' => '抱歉，本课件已关闭，无法继续投票',
  'debate_nofound' => '抱歉，该辩论课件不存在',
  ...
  'thread_nopermission' => '抱歉，本课件要求阅读权限高于 {readperm} 才能浏览',
  ...
  'activate_illegal' => '您所用的 ID 不存在或您不是等待验证用户',
  ...
  'post_edit_delete_succeed' => '课件删除成功 ',
  'debate_end' => '抱歉，辩论已结束',
  'replyperm_login_nopermission' => '抱歉，您尚未登录，没有权限在该版块学习笔记',
  'post_nonexistence' => '课件不存在',
  'post_thread_closed' => '抱歉，本课件已关闭，不再接受新内容',
  'reply_quotepost_error' => '禁止引用自己和课件课件之外的课件',
  'post_flood_ctrl' => '抱歉，您两次上传间隔少于 {floodctrl} 秒，请稍候再上传',
  'post_flood_ctrl_posts_per_hour' => '抱歉，您所在的用户组每小时限制发学习笔记 {posts_per_hour} 个，请稍候再上传',
  ...
  'postperm_login_nopermission' => '抱歉，您尚未登录，没有权限在该版块发课件',
  'post_type_isnull' => '抱歉，您尚未选择课件的类别',
  'post_net_price_iszero' => '抱歉，您的课件售价扣除积分交易税后为 0',
  ...
  'debate_position_nofound' => '抱歉，上传辩论课件需要输入正方和反方观点',
  ...
  'post_forum_newthread_nopermission' => '抱歉，本版块只有特定用户组可以发新课件',
  'thread_flood_ctrl_threads_per_hour' => '抱歉，您所在的用户组每小时限制发课件 {threads_per_hour} 个，请稍候再上传',
  'search_forum_invalid' => '抱歉，您尚未指定搜索课件系统的范围',
  ...
  'ban_view_other_thead' => '抱歉，禁止查看其他用户的课件和课件',
  ...
  'postcomment_not_found' => '课件点评未找到',
  'special_noaction' => '无法操作特殊课件',
  'admin_moderate_invalid' => '抱歉，您尚未选择课件或课件不可执行此类管理',
  'no_privilege_delpost' => '抱歉，您没有权限删除课件',
  'admin_move_invalid' => '抱歉，目标版块不存在',
  'admin_succeed' => '管理操作成功 ',
  'admin_split_new_invalid' => '抱歉，您尚未选择要分割入新课件的课件',
  ...
  'postperm_none_nopermission' => '抱歉，您没有权限在该版块发课件</p></div><div>',
  'replyperm_none_nopermission' => '抱歉，您没有权限在该版块学习笔记</p></div><div>',
  ...
  'post_message_toolong' => '抱歉，您的课件超过 {maxpostsize} 个字符的限制',
  ...
  'thread_reshreply_membernum' => '共有 {membernum}人参与了本课件',
  ...
  'attachment_expired' => '抱歉，原附件链接已失效 <br /><a href="forum.php?mod=attachment&aid={aid}">[ 点击这里重新下载 ]</a><br /><a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}">[ 点击这里查看原课件 ]</a>',
  'attachment_referer_invalid' => '请不要从外部链接下载本站附件',
  'attachment_payto' => '附件所在课件需要付费，请您付费后下载',
  ...
  'group_threadtype_only_founder' => '抱歉，只有{_G/setting/navs/3/navname}创始人可以管理课件分类',
  'group_threadtype_edit_succeed' => '修改课件分类成功 ',
  ...
  'thread_closed' => '该课件已被关闭，不能评论！',
  'postcomment_error' => '抱歉，您不能点评此课件或课件尚未找到',
  'postappend_not_open' => '抱歉，站点没有开启课件补充功能',
  'postappend_only_yourself' => '只能在自己的课件后补充内容',
  'postappend_add_succeed' => '添加成功 ',
  'replynotice_success_1' => '接收设置成功 ',
  'replynotice_success_0' => '取消设置成功 ',
  'replynotice_error' => '抱歉，回复通知设置失败，课件正在审核或不存在',
  'no_privilege_indexheats' => '抱歉，您没有权限删除课件系统热点项目',
  ...
  'thread_poll_none' => '抱歉，本课件非投票课件',
  'thread_poll_nopermission' => '抱歉，您无权查看本课件投票人',
  'thread_rate_moderator_invalid' => '抱歉，作为版主您只能在自己的管辖范围内评分',
  'thread_rate_timelimit' => '抱歉，您不能对上传于 {karmaratelimit} 小时前的课件进行评分',
  'thread_rate_member_invalid' => '抱歉，您不能给自己上传的课件评分',
  'thread_rate_anonymous' => '抱歉，您不能对匿名课件评分',
  'thread_rate_banned' => '抱歉，您不能对屏蔽课件评分',
  'thread_rate_duplicate' => '抱歉，您不能对同一个课件重复评分',
  ...
  'thread_warning_nonexistence' => '抱歉，指定课件没有警告记录',
  'thread_pay_error' => '抱歉，您不能购买本课件',
  ...
  'credits_buy_thread' => '抱歉，您已购买过此课件，请勿重复付费',
  'thread_pay_succeed' => '课件购买成功 ',
  'threadmod_nonexistence' => '抱歉，课件管理记录不存在或已过期删除',
  ...
  'debate_umpire_edit_invalid' => '抱歉，您上传的评论已超过一个小时，您不能再进行编辑',
  ...
  'no_privilege_recommend' => '抱歉，您目前没有权限评价此课件，<a href="home.php?mod=spacecp&ac=usergroup" target="_blank">点击这里查看权限</a>',
  'recommend_self_disallow' => '评价指数 <strong id="recommentc" class="xi1 xs2">{recommendc}</strong><br />您不能评价自己的课件',
  'recommend_duplicate' => '评价指数 <strong id="recommentc" class="xi1 xs2">{recommendc}</strong><br />您已评价过本课件',
  ...
  'forum_group_not_groupmember' => '抱歉，您还不是本{_G/setting/navs/3/navname}成员不能发课件<br /><a href="forum.php?mod=group&action=join&fid={fid}" target="_blank">马上加入该{_G/setting/navs/3/navname}</a>',
  'forum_group_not_groupmember_guest' => '抱歉，您还不是本{_G/setting/navs/3/navname}成员不能发课件',
  'forum_disablepost' => '本版块禁止发课件',
  'post_newbie_span' => '抱歉，您在注册时间起 {newbiespan} 分钟后才能拥有发课件权限',
  'post_hide_nopermission' => '抱歉，您没有权限使用 [hide] 代码',
  'reward_credits_closed' => '交易积分被关闭，请联系管理员。',
  'forum_access_disallow' => '抱歉，您在本版没有权限进行此操作',

  'post_check' => '抱歉，指定的课件不存在或已被删除或正在被审核<br /><a href="forum.php?mod=viewthread&tid={tid}">[ 尝试点击这里转入课件 ]</a>',
  'redirect_nextnewset_nonexistence' => '抱歉，没有比当前更新的课件',
  'redirect_nextoldset_nonexistence' => '抱歉，没有比当前更早的课件',
  ...
  'thread_at_usernum_limit' => '本课件的@用户数达到上限',
  ...
  'search_forum_closed' => '抱歉，课件系统搜索已关闭',
  ...
  'collection_comment_succ' => '上传评论成功',
  'collection_comment_remove_succ' => '评论成功删除',
  'collection_recommend_url' => '请填写课件地址',
  'collection_recommend_succ' => '已经成功向淘专辑作者发送了推荐消息',
  'collection_recommend_message' => '{fromuser}  向您的专辑《{collectioname}》推荐了一个课件：[url]{url}[/url]',
  ...
  'collection_forum_deny' => '抱歉，管理员设置了本版课件不能被加入淘专辑',
  'collection_none_avail_collection' => '抱歉，现在没有可以能够淘课件的淘专辑，您所在的用户组也无法再创建新的淘专辑。',
  'collection_no_selected' => '您还没有选择可以添加的淘专辑',
  'collection_non_creator' => '抱歉，只有创建人和参与者可以管理淘专辑',
  'collection_thread_exists' => '您选择的课件已经在淘专辑中了，不需要重复添加',
  'collection_collect_succ' => '淘课件成功，课件已经被加入到相应淘专辑中',
  'collection_no_thread' => '无法找到要删除的课件，请先选择要删除的课件',
  'collection_remove_thread' => '删除淘专辑内课件成功，即将返回淘专辑页面',
  ...
  'collection_teamworkers_exit_succ' => '取消共同维护成功，即将进入淘课件首页',
  ...
  'no_posts_for_pushplus' => '抱歉，您尚未指定要添加的课件',
  'pushplus_do_success' => '已成功添加指定课件到文章',
  ...
  'all_posts_pushed_already' => '所有指定课件均已连载过了',
  ...
  'article_push_tid_invalid_repeat' => '该课件已生成过文章，不能重复生成',
  ...
  'post_edit_nopermission' => '抱歉，您没有权限编辑他人上传的课件',
  'post_edit_timelimit' => '抱歉，您的课件从上传到现在已超过 {edittimelimit} 分钟，不能再进行编辑',
  'debate_umpire_comment_invalid' => '抱歉，裁判已进行过评判，您不能再进行编辑',
  'post_edit_nopermission_threadplign' => '抱歉，您没有权限编辑本课件或特殊课件功能已关闭',
  'reward_credits_invalid' => '抱歉，悬赏积分设置不合理',
  'reward_credits_fall' => '抱歉，悬赏积分不能减少',
  'post_edit_thread_replaycredit_nocredit' => '您的积分不足，不能为学习笔记奖励增加积分',
  'post_edit_thread_ban_del' => '抱歉，编辑课件时不允许删除课件',
  'post_edit_reward_already_reply' => '抱歉，您不能删除已经有回复的悬赏',
  'post_edit_thread_already_reply' => '对不起，您不能删除已经有回复的课件，请返回。',
  'post_edit_reward_nopermission' => '抱歉，悬赏已结束，无法退还积分',
  'post_edit_delete_rushreply_nopermission' => '抱歉，抢楼课件不能删除',
  'auditstatuson_succeed' => '审核成功，点击查看该课件',
  'audit_edit_succeed' => '<a href="javascript:if(opener)opener.location.reload();window.close();"> 编辑成功，点击关闭本页</a>',
  'edit_newthread_mod_succeed' => '编辑后的课件需要审核，请等待审核通过',
  'edit_reply_mod_succeed' => '编辑后的回复需要审核，请等待审核通过',
  'post_edit_succeed' => '课件编辑成功，现在将转入课件页，请稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入课件列表 ]</a>',

  'post_forum_newreply_nopermission' => '抱歉，本版块只有特定用户组可以回复',
  'comment_add_succeed' => '课件点评成功 ',
  'post_rushreply_creditlimit' => '抱歉，您的 {creditlimit_title} 不足，本抢楼课件限制最小 {creditlimit_title} 为 {creditlimit}',
  'trade_newreply_nopermission' => '抱歉，只有已开放的商品课件可以回复',
  'post_reply_succeed' => '非常感谢，回复发布成功，现在将转入课件页，请稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入课件列表 ]</a>',
  'trade_add_succeed' => '非常感谢，您的商品已经发布，现在将转入课件页，请稍候……<br /><a href="forum.php?mod=post&action=reply&fid={fid}&tid={tid}&addtrade=yes">[ 继续添加商品请点击这里 ]</a><br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入课件列表 ]</a>',

  'postperm_login_nopermission_mobile' => '您尚未<a href="member.php?mod=logging&action=login&referer={referer}&mobile=yes">登录</a>，没有权限在该版块发课件',
  'post_sort_isnull' => '抱歉，您尚未选择课件的分类信息',
  ...
  'threadtype_expiration_invalid' => '抱歉，此课件必须指定有效期',
  'replycredit_morethan_self' => '抱歉，学习笔记送积分额度大于您的积分',
  'post_newthread_set_cover' => '正在设置课件封面, &nbsp; ',
  ...
  'no_privilege_blog' => '抱歉，您目前没有权限上传日志，<a href="home.php?mod=spacecp&ac=usergroup" target="_blank">点击这里查看权限</a>',
  ...
  'no_privilege_doing' => '抱歉，您目前没有权限上传记录，<a href="home.php?mod=spacecp&ac=usergroup" target="_blank">点击这里查看权限</a>',
  ...
  'follow_anonymous_unfollow' => '匿名课件不允许被转播',
  'follow_content_not_exist' => '转播的内容不存在',
  'follow_input_word_limit' => '您输入的转播理由超过140个字',
  'follow_only_allow_the_relay_time' => '抱歉，第二次转播必须同时进行学习笔记操作',
  ...
  'no_privilege_banpost' => '抱歉，您没有权限屏蔽课件',
  'admin_banpost_invalid' => '抱歉，您尚未选择要屏蔽的课件',

  'no_privilege_copythread' => '抱歉，您没有权限或课件不存在',

  'no_privilege_delcomment' => '抱歉，您没有权限删除点评',

  'admin_delpost_invalid' => '抱歉，您尚未选择要删除的课件',

  'no_privilege_viewip' => '抱歉，您没有权限查看 IP',
  'admin_getip_nopermission' => '抱歉，您没有权限查看更高级别的管理员 IP',

  'no_privilege_mergethread' => '抱歉，您没有权限合并课件',
  'admin_merge_nonexistence' => '抱歉，课件 ID (tid) 不存在',
  'admin_merge_invalid' => '抱歉，请选择其他课件进行合并',

  'recommend_group_invalid' => '抱歉，您选择的课件已被推荐版块',
  'admin_nonexistence' => '抱歉，您尚未选择操作项目',
  'no_privilege_stickthread' => '抱歉，您没有权限设置课件置顶',
  'no_privilege_highlightthread' => '抱歉，您没有权限设置课件高亮',
  'no_privilege_digestthread' => '抱歉，您没有权限设置课件精华',
  'no_privilege_recommendthread' => '抱歉，您没有权限推荐课件',
  'no_privilege_bumpthread' => '抱歉，您没有权限提升此课件',
  'no_privilege_downthread' => '抱歉，您没有权限下沉此课件',
  'no_privilege_closethread' => '抱歉，您没有权限关闭此课件',
  'no_privilege_openthread' => '抱歉，您没有权限开启已关闭的课件',
  'no_privilege_movethread' => '抱歉，您没有权限移动此课件',
  'admin_move_have_mod' => '抱歉，目标版块需要内容审核',
  'admin_move_nopermission' => '抱歉，目标版块无发课件权',
  'no_privilege_edittypethread' => '抱歉，您没有权限设置课件分类',
  'admin_type_invalid' => '抱歉，目标分类无效',
  'admin_expiration_invalid' => '抱歉，有效期无效, 有效期应该介于{min}至{max}之间',

  'special_refundment_invalid' => '抱歉，特殊课件不能执行强制退款',

  'no_privilege_removereward' => '抱歉，您没有权限移除悬赏课件状态',
  'reward_end' => '抱歉，请确认是否是悬赏课件或者悬赏已结束',

  'no_privilege_repairthread' => '抱歉，您没有权限修复此课件',
  'admin_repair_succeed' => '课件修复成功 ',

  'no_privilege_restore' => '抱歉，您没有权限恢复此课件',

  'no_privilege_splitthread' => '抱歉，您没有权限分割此课件',
  'admin_split_invalid' => '抱歉，课件没有回复，无法分割',
  'admin_split_subject_invalid' => '抱歉，您尚未输入标题',

  'no_privilege_stampthread' => '抱歉，您没有权限给课件添加图章',

  'no_privilege_stamplist' => '抱歉，您没有权限给课件添加图标',

  'no_privilege_stickreply' => '抱歉，您没有权限置顶此课件',
  'admin_stickreply_invalid' => '抱歉，目标课件不存在或者为课件',

  'no_privilege_warnpost' => '抱歉，您没有权限警告此课件',
  'admin_warn_invalid' => '抱歉，您尚未选择要警告的作者的课件',
  ...
  'postperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能发课件，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。</p></div><div><p><b>有权发课件的用户组或认证用户为：</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
  'replyperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能学习笔记，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。</p></div><div><p><b>有权学习笔记的用户组或认证用户为：</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
  ...
  'forum_archiver_disabled' => '抱歉，课件系统 简明版 功能尚未开启',

  'post_thread_closed_by_dateline' => '抱歉，管理员设置了本版块上传于 {autoclose} 天以前的课件自动关闭，不再接受新回复',
  'post_thread_closed_by_lastpost' => '抱歉，管理员设置了本版块最后回复于 {autoclose} 天以前的课件自动关闭，不再接受新回复',
  ...
  'magics_mod_forbidden' => '抱歉，此课件已被版主操作，禁止使用道具',
  ...
  'post_message_tooshort' => '抱歉，您的课件小于 {minpostsize} 个字符的限制',
  ...
  'post_url_nopermission' => '抱歉，您没有权限上传 URL 连接',
