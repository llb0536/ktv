...
截止至目前，您已被警告 {authorwarnings} 次，请注意！<div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reason_stickreply' => '您在课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的学习笔记被 {actor} 置顶 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stickdeletereply' => '您在课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的学习笔记被 {actor} 撤销置顶 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_quickclear' => '您的{cleartype} 被 {actor} 清除 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'modthreads_delete' => '您上传的课件 {threadsubject} 未通过审核，现已被删除！',

	'modthreads_validate' => '您上传的课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> 已审核通过！ &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'modreplies_delete' => '您上传回复未通过审核，现已被删除！ <p class="summary">回复内容：<span>{post}</span></p>',

	'modreplies_validate' => '您上传的回复已审核通过！ &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <p class="summary">回复内容：<span>{post}</span></p>',
...
<p class="summary">订单号：<span>{orderid}</span></p><p class="summary">支出：<span>人民币 {price} 元</span></p><p class="summary">收入：<span>{value}</span></p>',
	...
	'reward_bestanswer' => '您的回复被悬赏课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的作者 {actor} 选为最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reward_bestanswer_moderator' => '您在悬赏课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回复被选为最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'comment_add' => '{actor} 点评了您曾经在课件 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 上传的课件 &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reppost_noticeauthor' => '{actor} 回复了您的课件 <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a> &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看</a>',
	...
	'manage_verifypost' => '有新的待审核学习笔记。<a href="admin.php?action=moderate&operation=replies&dateline=all">现在进行审核</a>',
	'manage_verifyuser' => '有新的待审核用户。<a href="admin.php?action=moderate&operation=members">现在进行审核</a>',
	...
	'manage_verifyrecyclepost' => '学习笔记回收站有新的待处理学习笔记。<a href="admin.php?action=recyclebinpost">现在处理</a>',
