...
$lang = array(
	...
	'get_passwd_message' => '您只需在提交请求后的三天之内，通过点击下面的链接重置您的密码：<br />\\1<br />(如果上面不是链接形式，请将地址手工粘课件到浏览器地址栏再访问)<br />上面的页面打开后，输入新的密码后提交，之后您即可使用新的密码登录了。',
	...
	'logs_credit_update_RCT' => '学习笔记奖励',
	'logs_credit_update_RCA' => '学习笔记中奖',
	'logs_credit_update_RCB' => '返还学习笔记奖励积分',
