...
$lang = array (
  ...
  'preview_msg' => '<a href="javascript:;" class="xi2">Crossday Kejian.TV</a> 社区系统(简称 <stong class="xw1 xi1">Kejian.TV</stong>)是一个采用 PHP 和 MySQL 等其他多种数据库构建的高效建站解决方案。',
  'preview_smalltext' => 'SMALL FONT',
  'preview_text' => '普通文本',
  'preview_threadtext' => '课件列表字体',
  'table_header' => '表头',
  'album' => '相册',
  'article' => '文章',
  'blog' => '日志',
