...
$lang = array(
  ...
  'ranklist_title_member_post' => '发课件数排行',
  'ranklist_title_member_blog' => '日志数排行',
  'ranklist_title_member_onlinetime' => '在线时间排行',

  'ranklist_title_thread_reply' => '课件回复排行',
  'ranklist_title_thread_view' => '课件查看排行',
  'ranklist_title_thread_share' => '课件分享排行',
  'ranklist_title_thread_favorite' => '课件收藏排行',
  'ranklist_title_thread_heat' => '课件热度排行',
  ...
  'ranklist_title_forum_thread' => '版块发课件排行',
  'ranklist_title_forum_post' => '版块回复排行',
  'ranklist_title_forum_post_30' => '版块 30 天发课件排行',
  'ranklist_title_forum_post_24' => '版块最近 24 小时发课件排行',

  'ranklist_title_group_credit' => '群组积分排行',
  'ranklist_title_group_member' => '群组成员数排行',
  'ranklist_title_group_thread' => '群组发课件排行',
  'ranklist_title_group_post' => '群组回复排行',
  'ranklist_title_group_post_30' => '群组最近 30 天发课件排行',
  'ranklist_title_group_post_24' => '群组最近 24 小时发课件排行',
