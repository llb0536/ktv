...
var App = {
    ...
    ajax_get_info :function(page_id){
        if(page_id>1){
            $.ajax({
            url:"/ajax_get_info?page="+page_id,
            type:"get",
            dataType:"text",
            success:function(res){
            if(res){
                $("#ajax_load").hide();
                $("#ajax_info").replaceWith(res);
            }
        },
        error:function(){
            var res="<div id='ajax_info'>您的动态加载失败，请 <a href='javascript:void(0);' onclick='App.ajaxLoad();App.ajax_get_info("+page_id+");'>重新刷新</a> 试试</div>";
            $("#ajax_load").hide();
            $("#ajax_info").replaceWith(res);
        },
        timeout:5000
        ...
        error:function(){
            var res="<div id='ajax_info'>您的动态加载失败，请 <a href='javascript:void(0);' onclick='App.ajaxLoad();App.ajax_get_info(1);'>重新刷新</a> 试试</div>";
            $("#ajax_load").hide();
            $("#ajax_info").replaceWith(res);
        },
        timeout:5000
