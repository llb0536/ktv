...
=end
  ...
  def set_seo_meta(title, options = {})
    keywords = options[:keywords] || "职业规划,问答,学术,加薪,求助,"
    description = options[:description] || "求助是课件交流系统旗下的学术领域问答交流平台.求助助你制定专业的职业规划,提供求助指导,分享学术知识,赢取工作机会.求助拥有大批学术专家,行业资深人士,知名企业HR,同行,校友."
