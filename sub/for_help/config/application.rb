...
if defined?(Bundler)
  if 'development'==Rails.env
    require 'devise'
    require File.expand_path('../initializers/devise.rb',__FILE__)
  end
...
module Quora
  class Application < Rails::Application
    ...
    config.action_controller.default_url_options = {:host => "wendao.kejian.tv"}
    ...
    config.action_mailer.default_url_options = { :host => "wendao.kejian.tv" }
