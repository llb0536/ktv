...
Quora::Application.routes.draw do
  ...
  constraints(ApiSubdomainNOT) do
    match '/home/visit'=>'home#visit'
    match '/expert'=>'home#expert'
    match '/elite'=>'home#elite'
    ...
    namespace :cpanel do
      ...
      match '/visit' => 'stats#visit',:as=>'visit'
      match '/stats/short_adv' => 'stats#short_adv'
      match '/stats/edit_short_adv' => 'stats#edit_short_adv'
