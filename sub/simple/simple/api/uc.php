...
class uc_note {
	...
	function updatebadwords($get, $post) {
		...
		$cachefile = DISCUZ_ROOT.'./uc_client/data_'.PSVR_KTV_SUB.'/cache/badwords.php';
	...
	function updatehosts($get, $post) {
		...
		$cachefile = DISCUZ_ROOT.'./uc_client/data_'.PSVR_KTV_SUB.'/cache/hosts.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
	...
	function updateapps($get, $post) {
		...
		$cachefile = DISCUZ_ROOT.'./uc_client/data_'.PSVR_KTV_SUB.'/cache/apps.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
	...
	function updateclient($get, $post) {
		...
		$cachefile = DISCUZ_ROOT.'./uc_client/data_'.PSVR_KTV_SUB.'/cache/settings.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
	...
	function updatecreditsettings($get, $post) {
		...
		$cachefile = DISCUZ_ROOT.'./uc_client/data_'.PSVR_KTV_SUB.'/cache/creditsettings.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
