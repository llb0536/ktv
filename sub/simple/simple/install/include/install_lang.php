...
$lang = array(
	...
	'tips_ucenter_comment' => 'UCenter 是 Kejian.TV 公司产品的核心服务程序，Kejian.TV Board 的安装和运行依赖此程序。如果您已经安装了 UCenter，请填写以下信息。否则，请到 <a href="http://www.kejian.tv/" target="blank">Kejian.TV 产品中心</a> 下载并且安装，然后再继续。',
	...
	'tablepre_comment' => '同一数据库运行多个课件交流系统时，请修改前缀',
	...
	'admin_exist_password_error' => '该用户已经存在，如果您要设置此用户为课件交流系统的管理员，请正确输入该用户的密码，或者请更换课件交流系统管理员的名字',
...
<p>感谢您选择课件交流系统产品。希望我们的努力能为您提供一个高效快速、强大的站点解决方案，和强大的社区课件交流系统解决方案。课件交流系统公司网址为 http://www.kejian.tv，产品官方讨论区网址为 http://www.kejian.tv。</p>

<p>用户须知：本协议是您与课件交流系统公司之间关于您使用课件交流系统公司提供的各种软件产品及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，包括免除或者限制课件交流系统责任的免责条款及对您的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或课件交流系统随时对其的修改，您应不使用或主动取消课件交流系统公司提供的课件交流系统产品。否则，您的任何对课件交流系统产品中的相关服务的注册、登陆、下载、查看等使用行为将被视为您对本服务条款全部的完全接受，包括接受课件交流系统对服务条款随时所做的任何修改。
<p>本服务条款一旦发生变更, 课件交流系统将在网页上公布修改内容。修改后的服务条款一旦在网站管理后台上公布即有效代替原来的服务条款。您可随时登陆课件交流系统官方课件交流系统查阅最新版服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，课件交流系统公司有权随时中止或终止您对课件交流系统产品的使用资格并保留追究相关法律责任的权利。</p>
<p>在理解、同意、并遵守本协议的全部条款后，方可开始使用课件交流系统产品。您可能与课件交流系统公司直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p></p>

<p>课件交流系统拥有本软件的全部知识产权。本软件只供许可协议，并非出售。课件交流系统只允许您在遵守本协议各项条款的情况下复制、下载、安装、使用或者以其他方式受益于本软件的功能或者知识产权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
   <li>您可以在完全遵守本许可协议的基础上，将本软件应用于非商业用途，而不必支付软件版权许可费用。</li>
   <li>您可以在协议规定的约束和限制范围内修改课件交流系统产品源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
   <li>您拥有使用本软件构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与使用本软件构建的网站内容的审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用课件交流系统软件和服务带来的全部责任，若造成课件交流系统公司或用户损失的，您应予以全部赔偿。</li>
   <li>若您需将课件交流系统软件或服务用户商业用途，必须另行获得课件交流系统的书面许可，您在获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</li>
   <li>您可以从课件交流系统提供的应用中心服务中下载适合您网站的应用程序，但应向应用程序开发者/所有者支付相应的费用。</li>
</ol>

<h3>II. 协议规定的约束和限制</h3>
<ol>
   <li>未获课件交流系统公司书面商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.kejian.tv参考相关说明，也可以致电8610-51282255了解详情。</li>
   <li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
   <li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用课件交流系统产品的整体或任何部分，未经书面许可，页面页脚处的课件交流系统产品名称和课件交流系统公司下属网站（http://www.kejian.tv、或 http://www.kejian.tv） 的链接都必须保留，而不能清除或修改。</li>
   <li>禁止在课件交流系统产品的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
<ol>
   ...
   <li>课件交流系统公司不对使用本软件构建的网站中或者课件交流系统中的文章或信息承担责任，全部责任由您自行承担。</li>
   <li>课件交流系统公司无法全面监控由第三方上传至应用中心的应用程序，因此不保证应用程序的合法性、安全性、完整性、真实性或品质等；您从应用中心下载应用程序时，同意自行判断并承担所有风险，而不依赖于课件交流系统公司。但在任何情况下，课件交流系统公司有权依法停止应用中心服务并采取相应行动，包括但不限于对于相关应用程序进行卸载，暂停服务的全部或部分，保存有关记录，并向有关机关报告。由此对您及第三人可能造成的损失，课件交流系统公司不承担任何直接、间接或者连带的责任。</li>
   <li>课件交流系统公司对课件交流系统提供的软件和服务之及时性、安全性、准确性不作担保，由于不可抗力因素、课件交流系统公司无法控制的因素（包括黑客攻击、停断电等）等造成软件使用和服务中止或终止，而给您造成损失的，您同意放弃追究课件交流系统公司责任的全部权利。   6.课件交流系统公司特别提请您注意，课件交流系统公司为了保障公司业务发展和调整的自主权，课件交流系统公司拥有随时经或未经事先通知而修改服务内容、中止或终止部分或全部软件使用和服务的权利，修改会公布于课件交流系统公司网站相关页面上，一经公布视为通知。 课件交流系统公司行使修改或中止、终止部分或全部软件使用和服务的权利而造成损失的，课件交流系统公司不需对您或任何第三方负责。</li>
</ol>

<p>有关课件交流系统产品最终用户授权协议、商业授权与技术服务的详细内容，均由课件交流系统公司独家提供。课件交流系统公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权利，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>一旦您开始安装课件交流系统产品，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权利的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>

<p>本许可协议条款的解释，效力及纠纷的解决，适用于中华人民共和国大陆法律。</p>

<p>若您和课件交流系统之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，您在此完全同意将纠纷或争议提交课件交流系统所在地北京市海淀区人民法院管辖。课件交流系统公司拥有对以上各项条款内容的解释权及修改权。</p>

<p>（正文完）</p>

<p align="right">课件交流系统公司</p>
	...
	'max_size' => '支持/最大尺寸',
	'project' => '项目',
	'ucenter_required' => 'Kejian.TV 所需配置',
	'ucenter_best' => 'Kejian.TV 最佳',
	'curr_server' => '当前服务器',
	'env_check' => '环境检查',
	'os' => '操作系统',
	'php' => 'PHP 版本',
