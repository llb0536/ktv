...
if($operation == 'filecheck') {
	...
	if($step == 1) {
		...
		$md5data = array();
		$cachelist = checkcachefiles('data'.PSVR_KTV_SUB.'/sysdata/');
		checkfiles('./', '', 0);
		checkfiles('config/', '', 1, 'config_global.php,config_ucenter.php');
		checkfiles('data'.PSVR_KTV_SUB.'/', '\.xml', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/log/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/plugindata/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/download/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/addonmd5/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/avatar/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/cache/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/ipdata/', '\.htm|\.dat', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/template/', '\.htm', 0);
		checkfiles('data'.PSVR_KTV_SUB.'/threadcache/', '\.htm', 0);
		checkfiles('template/', '');
		checkfiles('api/', '');
		...
		checkfiles('uc_client/data'.PSVR_KTV_SUB.'/', '\.htm');
		...
		checkfiles('uc_server/data'.PSVR_KTV_SUB.'/', '\.htm');
	...
	if(!empty($_GET['previewthumb'])) {
		...
		@unlink(DISCUZ_ROOT.'./data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp1.jpg');
		@unlink(DISCUZ_ROOT.'./data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp2.jpg');
		$image = new image;
		$r = 0;
		...
		if($r > 0) {
			...
			echo '<img src="data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp1.jpg?'.random(5).'"><br /><br />'.
			...
			echo '<img src="data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp2.jpg?'.random(5).'"><br /><br />'.
				$lang['imagepreview_imagesize_source'].' '.number_format($sizesource).' Bytes &nbsp;&nbsp;'.
		...
		require_once libfile('class/image');
		@unlink(DISCUZ_ROOT.'./data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp3.jpg');
		$image = new image;
		...
		if($r > 0) {
			...
			echo '<img src="data'.PSVR_KTV_SUB.'/attachment/temp/watermark_temp3.jpg?'.random(5).'"><br /><br />'.
				$lang['imagepreview_imagesize_source'].' '.number_format($sizesource).' Bytes &nbsp;&nbsp;'.
