...
(
	...
	'intercat_desc' => '展现方式: 论坛分类间广告显示于课程列表相邻的两个课程分类之间，可使用 960x60 或其他尺寸图片和 Flash 的形式。当前页面有多个分类间广告时，系统会从中抽取与课程分类数相等的条目进行随机显示。<br />价值分析:由于出现在课程列表页比较明显的位置，广告展示效果较好，但是过多过大的广告可能会招致访问者反感。 ',
	'intercat_fids' => '投放分区',
