...
$lang = array
(
	'thread_name' => '课件交流系统/群组 帖内广告',
	'thread_desc' => '展现方式: 帖内广告显示于课件内容的上方、下方或右方，课件内容的上方和下方通常使用文字的形式，课件内容右方通常使用图片的形式。当前页面有多个帖内广告时，系统会从中抽取与每页帖数相等的条目进行随机显示。您可以在 全局设置中的其他设置中修改每帖显示的广告数量。<br />价值分析: 由于课件是课件交流系统最核心的组成部分，嵌入课件内容内部的帖内广告，便可在用户浏览课件内容时自然的被接受，加上随机播放的特性，适合于特定内容的有效推广，也可用于课件交流系统自身的宣传和公告之用。建议设置多条帖内广告以实现广告内容的差异化，从而吸引更多访问者的注意力。',
	'thread_fids' => '投放课程',
	'thread_fids_comment' => '设置广告投放的课件交流系统课程，当广告投放范围中包含“课件交流系统”时有效',
