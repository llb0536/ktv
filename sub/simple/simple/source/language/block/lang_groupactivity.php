...
(
	...
	'groupactivity_items_comment' => '设置一次显示的课件条目数，请设置为大于 0 的整数',
	'groupactivity_titlelength' => '标题最大字节数',
	'groupactivity_titlelength_comment' => '设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
	'groupactivity_fnamelength' => '标题最大字节数包含课程名称',
	'groupactivity_fnamelength_comment' => '设置标题长度是否将所在课程名称的长度一同计算在内',
	'groupactivity_summarylength' => '课件简短内容文字数',
	'groupactivity_summarylength_comment' => '设置课件简短内容的文字数，0 为使用默认值 255',
	'groupactivity_tids' => '指定课件',
	'groupactivity_tids_comment' => '设置要指定显示的课件 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'groupactivity_typeids' => '课件老师',
	'groupactivity_typeids_comment' => '设置特定分类的课件。注意: 全选或全不选均为不进行任何过滤',
	'groupactivity_typeids_all' => '全部的课件老师',
	'groupactivity_sortids' => '分类信息',
	'groupactivity_sortids_comment' => '设置特定分类信息的课件。注意: 全选或全不选均为不进行任何过滤',
	'groupactivity_sortids_all' => '全部的分类信息',
	'groupactivity_digest' => '精华课件过滤',
	'groupactivity_digest_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'groupactivity_digest_0' => '普通课件',
	'groupactivity_digest_1' => '精华 I',
	'groupactivity_digest_2' => '精华 II',
	'groupactivity_digest_3' => '精华 III',
	'groupactivity_stick' => '置顶课件过滤',
	'groupactivity_stick_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'groupactivity_stick_0' => '普通课件',
	'groupactivity_stick_1' => '置顶 I',
	'groupactivity_stick_2' => '置顶 II',
	'groupactivity_stick_3' => '置顶 III',
	'groupactivity_special' => '特殊课件过滤',
	'groupactivity_special_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'groupactivity_special_1' => '投票课件',
	'groupactivity_special_2' => '商品课件',
	'groupactivity_special_3' => '悬赏课件',
	'groupactivity_special_4' => '活动课件',
	'groupactivity_special_5' => '辩论课件',
	'groupactivity_special_0' => '普通课件',
	'groupactivity_special_reward' => '悬赏课件过滤',
	'groupactivity_special_reward_comment' => '设置特定类型的悬赏课件',
	'groupactivity_special_reward_0' => '全部',
	'groupactivity_special_reward_1' => '已解决',
	'groupactivity_special_reward_2' => '未解决',
	'groupactivity_recommend' => '推荐课件过滤',
	'groupactivity_recommend_comment' => '设置是否只显示推荐的课件',
	'groupactivity_orderby' => '课件排序方式',
	'groupactivity_orderby_comment' => '设置以哪一字段或方式对课件进行排序',
	'groupactivity_orderby_lastpost' => '按最后评论时间倒序排序',
	'groupactivity_orderby_dateline' => '按发布时间倒序排序',
	'groupactivity_orderby_replies' => '按评论数倒序排序',
	'groupactivity_orderby_views' => '按浏览次数倒序排序',
	'groupactivity_orderby_heats' => '按热度倒序排序',
	'groupactivity_orderby_recommends' => '按课件评价倒序排序',
