...
(
	...
	'grouptrade_items_comment' => '设置一次显示的课件条目数，请设置为大于 0 的整数',
	'grouptrade_titlelength' => '标题最大字节数',
	'grouptrade_titlelength_comment' => '设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
	'grouptrade_fnamelength' => '标题最大字节数包含课程名称',
	'grouptrade_fnamelength_comment' => '设置标题长度是否将所在课程名称的长度一同计算在内',
	'grouptrade_summarylength' => '课件简短内容文字数',
	'grouptrade_summarylength_comment' => '设置课件简短内容的文字数，0 为使用默认值 255',
	'grouptrade_tids' => '指定课件',
	'grouptrade_tids_comment' => '设置要指定显示的课件 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'grouptrade_typeids' => '课件老师',
	'grouptrade_typeids_comment' => '设置特定分类的课件。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_typeids_all' => '全部的课件老师',
	'grouptrade_sortids' => '分类信息',
	'grouptrade_sortids_comment' => '设置特定分类信息的课件。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_sortids_all' => '全部的分类信息',
	'grouptrade_digest' => '精华课件过滤',
	'grouptrade_digest_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_digest_0' => '普通课件',
	'grouptrade_digest_1' => '精华 I',
	'grouptrade_digest_2' => '精华 II',
	'grouptrade_digest_3' => '精华 III',
	'grouptrade_stick' => '置顶课件过滤',
	'grouptrade_stick_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_stick_0' => '普通课件',
	'grouptrade_stick_1' => '置顶 I',
	'grouptrade_stick_2' => '置顶 II',
	'grouptrade_stick_3' => '置顶 III',
	'grouptrade_special' => '特殊课件过滤',
	'grouptrade_special_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'grouptrade_special_1' => '投票课件',
	'grouptrade_special_2' => '商品课件',
	'grouptrade_special_3' => '悬赏课件',
	'grouptrade_special_4' => '活动课件',
	'grouptrade_special_5' => '辩论课件',
	'grouptrade_special_0' => '普通课件',
	'grouptrade_special_reward' => '悬赏课件过滤',
	'grouptrade_special_reward_comment' => '设置特定类型的悬赏课件',
	'grouptrade_special_reward_0' => '全部',
	'grouptrade_special_reward_1' => '已解决',
	'grouptrade_special_reward_2' => '未解决',
	'grouptrade_recommend' => '推荐课件过滤',
	'grouptrade_recommend_comment' => '设置是否只显示推荐的课件',
	'grouptrade_orderby' => '课件排序方式',
	'grouptrade_orderby_comment' => '设置以哪一字段或方式对课件进行排序',
	'grouptrade_orderby_lastpost' => '按最后评论时间倒序排序',
	'grouptrade_orderby_dateline' => '按发布时间倒序排序',
	'grouptrade_orderby_replies' => '按评论数倒序排序',
	'grouptrade_orderby_views' => '按浏览次数倒序排序',
	'grouptrade_orderby_heats' => '按热度倒序排序',
	'grouptrade_orderby_recommends' => '按课件评价倒序排序',
