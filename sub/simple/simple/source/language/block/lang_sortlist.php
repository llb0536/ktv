...
(
	...
	'sortlist_fnamelength' => '标题最大字节数包含课程名称',
	'sortlist_fnamelength_comment' => '设置标题长度是否将所在课程名称的长度一同计算在内',
	...
	'sortlist_orderby_lastpost' => '按最后评论时间倒序排序',
	'sortlist_orderby_dateline' => '按发布时间倒序排序',
	'sortlist_orderby_replies' => '按评论数倒序排序',
