...
(
	...
	'threadlist_items_comment' => '设置一次显示的课件条目数，请设置为大于 0 的整数',
	'threadlist_titlelength' => '标题最大字节数',
	'threadlist_titlelength_comment' => '设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
	'threadlist_fnamelength' => '标题最大字节数包含课程名称',
	'threadlist_fnamelength_comment' => '设置标题长度是否将所在课程名称的长度一同计算在内',
	'threadlist_summarylength' => '课件简短内容文字数',
	'threadlist_summarylength_comment' => '设置课件简短内容的文字数，0 为使用默认值 255',
	'threadlist_tids' => '指定课件',
	'threadlist_tids_comment' => '设置要指定显示的课件 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'threadlist_typeids' => '课件老师ID',
	'threadlist_typeids_comment' => '输入课件老师ID，多个 ID 之间用半角逗号“,”隔开。',
	'threadlist_typeids_all' => '全部的课件老师',
	'threadlist_sortids' => '分类信息',
	'threadlist_sortids_comment' => '设置特定分类信息的课件。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_sortids_all' => '全部的分类信息',
	'threadlist_digest' => '精华课件过滤',
	'threadlist_digest_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_digest_0' => '普通课件',
	'threadlist_digest_1' => '精华 I',
	'threadlist_digest_2' => '精华 II',
	'threadlist_digest_3' => '精华 III',
	'threadlist_stick' => '置顶课件过滤',
	'threadlist_stick_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_stick_0' => '普通课件',
	'threadlist_stick_1' => '置顶 I',
	'threadlist_stick_2' => '置顶 II',
	'threadlist_stick_3' => '置顶 III',
	'threadlist_special' => '特殊课件过滤',
	'threadlist_special_comment' => '设置特定的课件范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_special_1' => '投票课件',
	'threadlist_special_2' => '商品课件',
	'threadlist_special_3' => '悬赏课件',
	'threadlist_special_4' => '活动课件',
	'threadlist_special_5' => '辩论课件',
	'threadlist_special_0' => '普通课件',
	'threadlist_special_reward' => '悬赏课件过滤',
	'threadlist_special_reward_comment' => '设置特定类型的悬赏课件',
	'threadlist_special_reward_0' => '全部',
	'threadlist_special_reward_1' => '已解决',
	'threadlist_special_reward_2' => '未解决',
	'threadlist_recommend' => '推荐课件过滤',
	'threadlist_viewmod' => '文章模式查看',
	'threadlist_recommend_comment' => '设置是否只显示推荐的课件',
	'threadlist_picrequired' => '必须含图片附件',
	'threadlist_picrequired_comment' => '设置是否只显示含有图片附件的课件',
	'threadlist_orderby' => '课件排序方式',
	'threadlist_orderby_comment' => '设置以哪一字段或方式对课件进行排序',
	'threadlist_orderby_lastpost' => '按最后评论时间倒序排序',
	'threadlist_orderby_dateline' => '按发布时间倒序排序',
	'threadlist_orderby_replies' => '按评论数倒序排序',
	'threadlist_orderby_views' => '按浏览次数倒序排序',
	'threadlist_orderby_heats' => '按热度倒序排序',
	'threadlist_orderby_recommends' => '按课件评价倒序排序',
	...
	'threadlist_postdateline' => '课件发布时间',
