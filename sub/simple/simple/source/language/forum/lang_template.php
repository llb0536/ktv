...
$lang = array (
  ...
  'delete' => '删除',
  'follow_quickreply' => '评论',
  'follow_relay' => '转播',
  'poston' => '发表于',
  'forumlist' => '课程列表',
  'forumlist_allforum' => '所有课程',
  ...
  'reply' => '评论',
  'view_all_replies' => '去课件交流系统查看所有评论',
  'all' => '全部',
  'announcement' => '公告',
  'author' => '作者',
  'month' => '月',
  ...
  'collection_keywords_desc' => '请使用空格隔开关键词，最多可填写 5 个。您可以使用这些关键词和淘贴标题搜索课件，快速创建淘贴专辑。',
  ...
  'collection_sortby_threadnum' => '按课件数排序',
  ...
  'collection_cloud_link' => '搜索相关课件',
  'collection_cloud_search' => '淘专辑还没有内容，您可以点击 <a href="forum.php?mod=collection&action=view&ctid={$ctid}&op=related" class="xi2">搜索相关课件</a> 找到相关内容。',
  ...
  'post_hide_credits_hidden' => '，本课件隐藏的内容需要积分高于 $creditsrequire 才可浏览，您当前积分为 {$_G[member][credits]}',
  'post_hide_reply_hidden' => '，如果您要查看本课件隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">评论</a>',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'credits_policy' => '积分说明',
  'e_attach_insert' => '点击附件文件名添加到课件内容中',
  'e_img_albumlist' => '相册图片',
  'e_img_attach' => '上传图片',
  'e_img_height' => '高(可选)',
  'e_img_insertphoto' => '点击图片添加到课件内容中',
  ...
  'forum_activeusers' => '正在浏览此课程的会员',
  'forum_archive' => '存档',
  'forum_domain' => '本课程域名',
  'forum_favorite' => '收藏本课程',
  'forum_modedby' => '版主',
  'forum_moderate_unhandled' => '<a href="home.php?mod=space&uid=$_G[uid]&do=thread&view=me&type=thread&from=&filter=aduit">您有 $threadmodcount 个课件正等待审核中，点击查看</a>',
  'forum_recommend' => '推荐课件',
  ...
  'their' => '所属分类',
  'threads_all' => '全部课件',
  'viewd_threads' => '浏览过的课件',
  'viewed_forums' => '浏览过的课程',
  'click_to_show_reason' => '点击查看原因',
  'connect_fill_profile_to_post' => '您需要 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">绑定已有帐号</a> 后才可以上传课件',
  'login_to_post' => '您需要登录后才可以上传课件',
  'no_permission_to_post' => '您现在无权上传课件。',
  'post_advancemode' => '高级模式',
  'post_relay' => '转播给听众',
  'post_sync_method' => '将此课件同步到',
  'quick_post' => '快速上传课件',
  'select_thread_catgory' => '选择课件老师',
  'favorite_forums' => '收藏的课程',
  'forum_nav' => '课程导航',
  'all_reward' => '全部悬赏',
  'closed_thread' => '关闭的课件',
  'digest_posts' => '精华',
  'forum_group' => '课程/群组',
  'forum_nothreads' => '本课程或指定的范围内尚无课件',
  'forum_thread' => '课程课件',
  'from' => '来自',
  'have_newreplies' => '有新评论',
  'heats' => '级热门',
  'last_1_days' => '一天',
  'last_2_days' => '两天',
  ...
  'list_one_month' => '一个月',
  'list_one_week' => '一周',
  'list_post_time' => '上传课件时间',
  'list_three_month' => '三个月',
  'new_window' => '新窗',
  'new_window_thread' => '在新窗口中打开课件',
  'order_heats' => '热门',
  'order_recommends' => '推荐',
  'orderby' => '排序',
  'pics' => '张图片',
  'post_mobile' => '手机上传课件',
  'posts_deducted' => '课件被减分',
  'rate_credit_add' => '课件被加分',
  'replycredit' => '课件评论奖励',
  'rewarding' => '进行中',
  'rushreply' => '抢楼',
  'screening' => '筛选',
  ...
  'forum_password_require' => '本课程需要密码，您必须在下面输入正确的密码才能浏览这个课程',
  'guide' => '导读',
  'guide_attend' => '人参与',
  'guide_digest' => '最新精华',
  'guide_forum_select' => '选择课程',
  'guide_hot' => '最新热门',
  'guide_index' => '导读首页',
  'guide_my' => '我的课件',
  'guide_new' => '查看新课件',
  'guide_nothreads' => '暂时还没有课件',
  'keyword' => '关键字',
  'posts_type' => '课件类型',
  'forum_moderate' => '审核',
  'logout' => '退出',
  'mod_error_invalid' => '抱歉，您无此权限',
  'mod_notice' => '课件交流系统管理员在“管理面板”中权限和超级版主基本相同，如果需要更多功能，请进入 <a href="admin.php?mod=forum" target="_blank"><u>管理中心</u></a> ',
  'mod_notice_title' => '内部留言',
  'mod_option_error' => '系统错误',
  'mod_option_forum_edit' => '课程编辑',
  'mod_option_forum_recommend' => '推荐课件',
  'mod_option_member_access' => '用户权限',
  'mod_option_member_ban' => '禁止用户',
  'mod_option_member_edit' => '编辑用户',
  'mod_option_member_ipban' => '禁止 IP',
  'mod_option_return' => '返回课件交流系统',
  'mod_option_subject' => '课件管理',
  'modcp_logs' => '管理日志',
  'modcp_report' => '管理举报',
  'action' => '操作',
  'delete_check' => '删?',
  ...
  'mod_message_forum_updaterecommend' => '推荐课件更新成功，请继续操作',
  'more_settings' => '更多设置',
  'post_html' => 'HTML 代码',
  'post_imgcode' => '[img] 代码',
  ...
  'mod_moderate_selectforum' => '课程选择',
  'mod_notice_access' => '通常情况下，用户在课程的权限是根据他的用户组决定的，此处您可以限制某个用户在某课程的权限。<br />注意: 看帖是基本权限，一旦禁止, 其他权限会同时进行禁止。<br />图例说明: <img src="static/image/common/access_normal.gif" class="vm" /> 默认权限&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_disallow.gif" class="vm" /> 强制禁止&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/image/common/access_allow.gif" class="vm" />强制允许 ',
  'moderator' => '版主',
  'admin' => '课件交流系统管理员',
  'days' => '天',
  'expire' => '有效期',
  ...
  'ignore' => '忽略',
  'invalidate' => '否决',
  'mod_message_moderate_nopermission' => '抱歉，您没有管理任何课程的权限，无法执行此操作',
  'mod_moderate_ignorereply_num' => '已忽略评论',
  'mod_moderate_ignorethread_num' => '已忽略课件',
  ...
  'mod_moderate_reply_num' => '未审核评论',
  'mod_moderate_select' => '当前已选定 <span id="modlayercount">0</span> 个',
  'mod_moderate_thread_num' => '未审核课件',
  'mod_moderate_thread_range' => '课件范围',
  'mod_notice_moderate' => '审核结果: $modpost[\'validate\'] 篇课件审核通过，$modpost[\'delete\'] 篇课件删除，$modpost[\'ignore\'] 篇课件进入忽略列表等待审核',
  'mod_option_moduser' => '用户',
  'mod_option_subject_mod' => '审核',
  'mod_option_subject_modreplies' => '评论',
  'mod_option_subject_modthreads' => '课件',
  ...
  'mod_moderate_reply' => '审核评论',
  'mod_moderate_thread' => '审核课件',
  'mod_option_selectforum' => '课程选择',
  'mod_option_subject_delete' => '课件管理',
  'mod_option_subject_forum' => '课程课件',
  'mod_option_subject_recyclebin' => '课件回收站',
  'mod_option_subject_recyclebinpost' => '课件评论回收站',
  'modcp_forum' => '当前课程',
  'modcp_posts_author' => '课件作者',
  'modcp_posts_dateline_range' => '时间范围',
  'modcp_posts_error_1' => '搜索条件不足！您至少应当在 关键字，课件作者或者上传课件 IP 当中设置一个搜索的条件',
  'modcp_posts_error_2' => '时间范围错误！版主只能删除近 1 周的课件，超级版主可以删除 2 周内的课件，请重新选择开始时间',
  'modcp_posts_error_3' => '您输入的关键字不合法！每个关键字至少由 2 个汉字或者 4 个英文字符组成',
  'modcp_posts_error_4' => '抱歉，您无权使用批量删帖功能',
  'modcp_posts_ip' => '上传课件 IP',
  'modcp_posts_keyword' => '内容关键字',
  'modcp_posts_member_credits' => '不更新用户积分',
  'modcp_posts_search' => '共搜索出结果 <strong>$total</strong> 条',
  'modcp_posts_thread' => '课件',
  'modcp_posts_threadfirst' => '课件首帖',
  'modcp_posts_threadreply' => '课件评论帖',
  'modcp_posts_to' => '至',
  'modcp_posts_type' => '课件类型',
  'modcp_posts_week_1' => '您只能操作最近 1 周的课件',
  'modcp_posts_week_2' => '您只能操作最近 2 周的课件',
  'modcp_select_forum' => '请选择课程',
  'posttable_branch' => '课件分表:',
  'mod_option_selectthreadclass' => '课件老师',
  'modcp_dateline_range' => '发表时间范围',
  'modcp_forum_select_msg' => '请选择课程进行管理',
  'modcp_no_reply_range' => '多少天内无评论',
  'modcp_reply_range' => '评论次数范围',
  'modcp_restore' => '恢复',
  'modcp_select_threadclass' => '请选择课件老师',
  'modcp_subject_keyword' => '标题关键字',
  'modcp_thread_msg' => '没有找到相关课件',
  ...
  'modcp_report_nothing' => '没有新的举报或没有选择课程',
  'modcp_report_perpage' => '每页显示举报数',
  'modcp_report_post' => '举报课件',
  ...
  'credits' => '积分',
  'min_limit' => '下限',
  'post_price_charge_comment' => '课件最多能销售 {$_G[setting][maxchargespan]} 个小时',
  'post_price_comment' => '最高 {$_G[group][maxprice]} {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]}',
  'post_price_free_chargehours' => '，本课件还能销售 $freechargehours 个小时',
  'post_price_income_comment' => '课件出售最高收入上限为 {$_G[setting][maxincperthread]} {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]}&nbsp;&nbsp;&nbsp;&nbsp;',
  ...
  'replycredit_however' => '本课件尚有',
  'replycredit_member' => '每人最多可获得',
  'replycredit_once' => '每次课件评论奖励:',
  'replycredit_rate' => '中奖率',
  'replycredit_reward' => '奖励',
  'replycredit_time' => '次',
  'replycredit_total' => '课件评论奖励总额:',
  'rushreply_change' => '将该课件设为抢楼件',
  'rushreply_end' => '截止楼层:',
  ...
  'img_unused' => '个未使用的图片',
  'modify' => '修改',
  'post_message1' => '添加商品信息，完成后可在本课件中继续添加多个商品',
  'addfeed' => '发送动态',
  'auditstatuson' => '通过审核',
  'del_thread_warning' => '删除后无法撤销',
  'disable' => '禁用',
  'hiddenreplies' => '课件评论仅作者可见',
  'post_additional_options' => '附加选项',
  'post_anonymous' => '使用匿名上传课件',
  'post_delpost' => '删除本课件',
  'post_descviewdefault' => '课件评论倒序排列',
  'post_digest_thread' => '精华课件',
  'post_imgurl' => '解析图片链接',
  'post_noticeauthor' => '接收评论通知',
  'post_parseurl' => '链接识别',
  'post_show_sig' => '使用个人签名',
  'post_stick_thread' => '课件置顶',
  'reward_price_back' => '，返还悬赏费用，不退还手续费',
  'smilies' => '表情',
  'nav_forum' => '进入课程',
  'nav_forum_frequently' => '常用课程',
  'post_forum_navigation' => '课件交流系统导航',
  ...
  'stats_main_board_activity' => '课件交流系统活跃指数',
  'stats_main_forums_count' => '课程数',
  'stats_main_hot_forum' => '最热门的课程',
  'stats_main_member' => '会员统计',
  'stats_main_members' => '注册会员',
  'stats_main_members_count' => '最近 24 小时新增会员数',
  'stats_main_new' => '新会员',
  'stats_main_nmpd' => '平均每日注册会员数',
  'stats_main_nonposters' => '未上传课件会员',
  'stats_main_nppd' => '平均每日新增课件数',
  'stats_main_posters' => '上传课件会员',
  'stats_main_posters_percent' => '上传课件会员占总数',
  'stats_main_posts_avg' => '平均每人上传课件数',
  'stats_main_posts_count' => '课件数',
  'stats_main_rpt' => '平均每个课件被评论次数',
  'stats_main_threads_count' => '课件数',
  'stats_main_todays_newposts' => '最近 24 小时新增课件数',
  'stats_main_topposter' => '今日课件交流系统之星',
  'stats_main_total_posted' => '上传课件数',
  ...
  'stats_browser' => '浏览器',
  'stats_date' => '日期',
  'stats_day_posts' => '每日新增课件记录',
  'stats_forum_stat_log' => '课程统计日志',
  'stats_forums_forumname' => '课程名称',
  'stats_forums_month' => '月份',
  'stats_forums_stat' => '课程统计',
  'stats_forums_sub' => '子版',
  'stats_history' => '历史记录',
  'stats_hour' => '时段流量',
  'stats_modworks' => '管理统计',
  ...
  'stats_month_posts' => '每月新增课件记录',
  'stats_os' => '操作系统',
  'stats_posthist' => '上传课件量记录',
  'stats_views' => '流量统计',
  'stats_week' => '星期流量',
  'admin_status' => '管理级别',
  ...
  'stats_posts_thismonth' => '最近 30 天上传课件',
  'stats_team' => '管理团队',
  ...
  'admin_bump' => '提升课件',
  'admin_close' => '关闭课件',
  'admin_delthread_confirm' => '您确认要 <strong>删除</strong> 选择的课件么?',
  'admin_delthread_nopermission' => '您没有删除此课件权限',
  'admin_digest_add' => '精华',
  ...
  'admin_open' => '打开课件',
  'admin_select_piece' => '选择了 $modpostsnum 篇课件',
  'admin_target' => '目标课程',
  'admin_targettype' => '目标分类',
  'admin_type_msg' => '当前课程无分类设置，请联系管理员到后台设置课件老师',
  ...
  'recommend' => '推荐',
  'thread_highlight' => '高亮',
  'topicadmin_crime_delpost_nums' => '用户 $crimeauthor 课件已被违规删除 $crimenum 次',
  'types' => '分类',
  'admin_banpost' => '屏蔽',
  'admin_delposts' => '删除选定课件',
  'admin_merge' => '合并',
  'admin_merge_tid' => '填写要合并的课件 ID (tid)',
  'admin_select_one_piece' => '选择了 1 篇课件',
  'admin_split_comment' => '分割 &rarr;填写楼号 (用 "," 间隔)',
  'admin_split_newsubject' => '新标题',
  'admin_stamp_none' => '无图章',
  'admin_stamp_select' => '选择课件图章',
  'admin_stamplist_current' => '当前图标',
  'admin_stamplist_none' => '无图标',
  'admin_stamplist_select' => '选择课件图标',
  'admin_stickreply' => '置顶到课件帖',
  'admin_threadsplit_restore' => '您确认要将此课件移除存档区吗？',
  'admin_unbanpost' => '解除',
  'admin_unstickreply' => '解除置顶',
  'pay_buyers' => '已购买人数',
  'topicadmin_crime_banpost_nums' => '用户 $crimeauthor 课件已被屏蔽 $crimenum 次',
  ...
  'topicadmin_warn_prompt' => '{$_G[setting][warningexpiration]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止上传课件 {$_G[setting][warningexpiration]} 天',
  ...
  'minimize' => '最小化',
  'piece' => '篇',
  'topicadmin_recommend_forum' => '推荐到课程',
  ...
  'trade_guest_alarm' => '您目前为游客，购买后您无法在本课程查看交易状态，请到支付网站查询',
  'trade_nums' => '购买数量',
  ...
  'set_tag_to_reply_users' => '给参与课件评论的会员贴标签',
  'follow' => '收听TA',
  'have_ignored' => '已忽略',
  'i_want' => '我要',
  'last_thread' => '上一课件',
  ...
  'modmenu_deletethread' => '删除课件',
  'modmenu_digestpost' => '精华',
  'modmenu_grouprecommend' => '推到课程',
  ...
  'thread_author' => '楼主',
  'thread_printable' => '打印',
  'thread_replycredit_tips1' => '评论本课件可获得 {$_G[forum_thread][replycredit_rule][extcredits]} {$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][unit]}{$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][title]}奖励!',
  ...
  'thread_rushreply' => '本课件为抢楼件，欢迎抢楼!',
  'thread_rushreply_check_back' => '返回抢楼件',
  'thread_rushreply_end' => '截止楼层：',
  'thread_rushreply_floor' => '奖励楼层',
  'thread_rushreply_limit' => '本课件为抢楼件，{$rushresult[creditlimit_title]}大于{$rushresult[creditlimit]}可以抢楼',
  ...
  'debater' => '辩手',
  'login_to_reply' => '您需要登录后才可以课件评论',
  'post_fastreply_gotolast' => '课件评论后跳转到最后一页',
  'post_newreply' => '发表评论',
  'post_reply_relay' => '课件评论并转播',
  ...
  'ban_member' => '禁止',
  'clear' => '清理',
  'collection_fromctid' => '您是从淘专辑 <a href="forum.php?mod=collection&action=view&ctid=$post[sourcecollection][ctid]" target="_blank" class="xi2">$post[sourcecollection][name]</a> 访问到本课件的，欢迎对专辑打分：',
  'collection_rate' => '评分',
  'collection_related' => '本课件被以下淘专辑推荐:',
  'debate_filter' => '按立场筛选',
  'follower' => '听众',
  'from_mobile' => '来自手机',
  'ignore_replynotice' => '取消评论通知',
  ...
  'people_score' => '人评分',
  'post_ascview' => '正序浏览',
  'post_copied' => '课件地址复制成功',
  'post_descview' => '倒序浏览',
  'post_from_mobile' => '该课件通过手机客户端发布',
  'prosit' => '恭喜',
  'published' => '发表',
  'receive_replynotice' => '接收评论通知',
  'related_thread' => '相关课件',
  'removerate' => '撤销评分',
  'rushreply_hit' => '抢中本楼',
  ...
  'thread_magic' => '使用道具',
  'thread_mod' => '课件模式',
  'thread_mod_by' => '本课件由 $lastmod[modusername] 于 $lastmod[moddateline] $lastmod[modaction]',
  'thread_mod_recommend_by' => '本课件由 $lastmod[modusername] 于 $lastmod[moddateline] $lastmod[modaction]到 $lastmod[reason]',
  'thread_realy' => '转播',
  ...
  'viewthread_share_to_t' => 'Kejian.TV微博',
  'viewthread_share_to_pengyou' => 'Kejian.TV朋友',
  'warn_get' => '受到警告',
  'admin_message_banned' => '提示: <em>作者被禁止或删除 内容自动屏蔽，只有管理员或有管理权限的成员可见</em>',
  'admin_message_single_banned' => '提示: <em>该课件被管理员或版主屏蔽，只有管理员或有管理权限的成员可见</em>',
  ...
  'attach_nopermission_notice' => '本课件中包含更多资源',
  'has_expired' => '该信息已经过期',
  'have' => '已有',
  'image_big' => '大图',
  ...
  'message_single_banned' => '提示: <em>该课件被管理员或版主屏蔽</em>',
  'more_images' => '更多图片',
  'pack' => '收起',
  'pay_threads' => '付费课件, 价格',
  'published_in_floor' => '查看楼层',
  'rate_total' => '总评分',
  'replies_recommended' => '课件评论推荐',
  'pay_comment' => '本课件需向作者支付 <strong>{$thread[price]} {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]}{$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]}</strong> 才能浏览',
  'pay_free_time' => '本课件购买截止日期为 $thread[endtime]，到期后将免费',
  'people_buy' => '人购买',
  ...
  'viewthread_trade_message1' => '您可以在本课件中继续',
  ...
  'warn_view_prompt' => '$warnuser 已被累计警告 $warnnum 次，{$_G[setting][warningexpiration]} 天内累计被警告 {$_G[setting][warninglimit]} 次，将被自动禁止上传课件 {$_G[setting][warningexpiration]} 天',
  'main_nav' => '主导航',
  'quick_nav' => '快捷导航',
  'post_deleted' => '无效楼层，该课件已经被删除',
  'have_posted' => '已发表',
  'guide_draft' => '草稿',
  'pending' => '待审核',
);
