...
$lang = array (
  ...
  'post_hide_reply_hidden' => '，如果您要查看本帖隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">评论</a>',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'thread_author' => '楼主',
  'thread_printable' => '打印',
  'thread_replycredit_tips1' => '评论本帖可获得 {$_G[forum_thread][replycredit_rule][extcredits]} {$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][unit]}{$_G[setting][extcredits][$_G[forum_thread][replycredit_rule][extcreditstype]][title]}奖励!',
  ...
  'thread_rushreply' => '本帖为抢楼件，欢迎抢楼!',
  'thread_rushreply_check_back' => '返回抢楼件',
  'thread_rushreply_end' => '截止楼层：',
  'thread_rushreply_floor' => '奖励楼层',
  'thread_rushreply_limit' => '本帖为抢楼件，{$rushresult[creditlimit_title]}大于{$rushresult[creditlimit]}可以抢楼',
