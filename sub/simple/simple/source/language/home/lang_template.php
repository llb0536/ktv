...
$lang = array (
  ...
  'follow_new_thread' => '发表课件',
  'follow_open_feed' => '展开全文',
  'follow_other_forum' => '浏览其它课程',
  ...
  'follow_reply' => '转播',
  'follow_special_thread_tip' => '这是一个特殊课件，点这里可以回原帖查看详细内容',
  ...
  'interactive_help_message' => '<li>来访用户：指的是每天访问本站的唯一用户数。一个用户访问多次，也只算一次</li>
  									<li>{$_G[setting][navs][2][navname]}：指的是每天发布课件、投票、活动、悬赏、辩论、商品和课件课件评论的总数量 </li>
									<li>群组：指的是每天创建{$_G[setting][navs][3][navname]}、{$_G[setting][navs][3][navname]}课件、{$_G[setting][navs][3][navname]}课件评论的总数量 </li>
  ...
  'system_email_not_replay' => '此邮件为系统自动发出的邮件，请勿直接评论 ',
  'all_friends' => '全部好友',
  ...
  'edit' => '编辑',
  'explain_album' => '您在课件交流系统或日志里面上传的图片附件，全部存放在 <a href="home.php?mod=space&uid=$space[uid]&do=album&id=-1" class="xw1 xi2">默认相册</a> 里',
  ...
  'content' => '内容',
  'delete_reply' => '删除评论',
  'delete_reply_message' => '确定删除指定的评论吗？',
  'edit_content' => '编辑内容',
  ...
  'see_all_poke' => '查看所有招呼',
  'to' => '向',
  'you_can_reply_ignore' => '您可以评论招呼或者进行忽略',
  'poke_0' => '不用动作',
  'add_share' => '添加分享',
  'allow' => '允许 ',
  'ban' => '禁止',
  ...
  'forum_post' => '课件交流系统上传课件',
  'forum_reply' => '课件交流系统课件评论',
  'friend_add' => '添加好友',
  'friend_privacy' => '好友可见',
  'friend_top' => '排行榜',
