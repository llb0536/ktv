...
(
	...
	'connect_setting_t_allow' => '开启上传课件同步推送到Kejian.TV微博',
	'connect_setting_t_allow_comment' => '开启后，用户上传课件可以同步推送到Kejian.TV微博，展现给用户的微博听众',
	...
	'connect_setting_t_reply_comment' => '推送课件或分享课件到Kejian.TV微博后，是否允许微博评论和转播内容回流',
	...
	'connect_setting_turl_allow_comment' => '用户点击本站官方微博快速收听按钮，将立即成为您所设置的Kejian.TV微博帐号听众，随时收取微博的动态',
	...
	'connect_setting_qshare_allow_comment' => '用户选中课件内容中的任何一段文本时，可方便快捷的将选中的文本内容和区域内图片转播到Kejian.TV微博',
	'connect_setting_weibo_appkey' => 'Kejian.TV微博开放平台AppKey',
	'connect_setting_weibo_appkey_comment' => '填写AppKey将在Kejian.TV微博中显示设置的来源字段信息，可不填写。怎样申请AppKey？请访问Kejian.TV微博开放平台，<a href="http://open.t.qq.com/apps_welcome.php" target="_blank">创建应用获取AppKey</a>',
	...
	'qqgroup_search_order_replies' => '评论数倒序',
	'qqgroup_search_order_heats' => '热度倒序',
	'qqgroup_search_order_dateline' => '发布时间倒序',
	'qqgroup_search_order_lastpost' => '最后评论倒序',
	...
	'recyclebin_search_security_post' => '仅包含防水墙处理的课件评论',
	...
	'security_tips' => '小技巧',
	'security_tips_1' => '<li><p>系统识别到违规课件和违规课件评论后，自动将课件和课件评论放入<a href="admin.php?action=recyclebin" style="text-decoration:none; color:#0000FF;">回收站</a></p></li>',
	...
	'security_forum_white_list' => '课程白名单',
	'security_forum_white_list_comment' => '所选课程内的课件和评论，防水墙不做处理，可以按住 CTRL 多选',
	'security_recyclebin_thread' => '到回收站处理课件',
	'security_recyclebin_post' => '到回收站处理课件评论',
	'security_thread_status' => '课件状态',
	'security_post_status' => '课件评论状态',
	...
	'search_setting_allow_thread_related' => '开启课件相关帖',
