...
$lang = array (
  ...
  'counter_member_succeed' => '用户上传课件数重建完成',
  ...
  'forums_edit_succeed' => '课程设置更新成功 ',
  'forums_copy_source_invalid' => '您没有选择要复制的源课程',
  ...
  'postsplit_forum_must_be_closed' => '请在站点关闭的状态下进行课件移动操作',
  'postsplit_done' => '数据转移成功，接下来将对源课件表进行优化操作，注意：优化表所耗时间比较长，在这期间绝对不能重起服务器或者停止MySQL服务',
  ...
  'threads_move_invalid' => '您没有选择或选择的目标课程/分类不存在',
  'threads_forumstick_url_invalid' => '您输入的URL无效',
  'threads_forumstick_targets_empty' => '请选择一个或多个目标课程',
  'select_thread_empty' => '没有选择课件',
  ...
  'counter_groupmember_post_succeed' => '群组成员上传课件数重建完成',
  'counter_groupnum_succeed' => '分类群组数重建完成',
  'counter_blog_replynum_succeed' => '日志评论数重建完成',
  'counter_friendnum_succeed' => '空间好友数重建完成',
  'counter_album_picnum_succeed' => '相册图片数重建完成',
  'counter_thread_cover_fiderror' => '课程ID错误',
  'counter_thread_cover_fidnopicstyle' => '指定课程没有开启图片列表模式',
  'counter_thread_cover_succeed' => '课件封面重建完成',
  ...
  'forums_update_succeed' => '课程设置更新成功 ',
  'forums_moderators_update_succeed' => '版主设置更新成功 ',
  'forums_merge_source_sub_notnull' => '源课程下级课程不为空，请先返回修改相关下级课程的上级设置',
  'forums_merge_succeed' => '课程合并成功 ',
  'forums_edit_nonexistence' => '请先选择您要进行操作的课程：',
  'forums_nonexistence' => '指定的课程不存在',
  'forums_name_toolong' => '课程名称不能超过50个字符',
  'forums_edit_name_invalid' => '分类名称不能为空',
  'forums_edit_sub_notnull' => '存在下级课程，不能修改本课程的上级课程归属',
  'forums_edit_threadsort_nonexistence' => '没有选择默认的分类信息',
  'forums_delete_succeed' => '课程删除成功 ',
  'forums_delete_sub_notnull' => '存在下级课程，请先返回删除本分类或本课程的下级课程',
  'forums_delete_confirm' => '本操作不可恢复，您确定要删除该课程，清除其中课件和附件吗？<br />注意: 删除课程并不会更新用户上传课件数和积分',
  'forums_delete_alarm' => '本操作不可恢复，正在删除课程数据...',
  'forums_copy_target_invalid' => '您没有选择要复制的目标课程',
  'forums_copy_options_invalid' => '您没有选择要复制的项目',
  'forums_copy_succeed' => '课程设置复制成功 ',
  ...
  'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中课件和附件吗？<br />注意：删除群组并不会更新用户上传课件数和积分',
  'grouptype_delete_alarm' => '本操作不可恢复，正在删除群组数据...',
  'group_name_exist' => '该群组名称已经存在',
  'group_edit_succeed' => '群组编辑成功 ',
  'group_thread_removing' => '正在删除群组内的课件，请勿关闭浏览器！',
  ...
  'postsplit_table_create_succeed' => '新的课件表创建成功，正在进入最后的数据转移操作',
  'postsplit_finish' => '目标分表已确认，正在进入最后的数据转移操作',
  'postsplit_unallow' => '当前表未达到指定的分表界限，不建议进行分表操作',
  'postsplit_abnormal' => '非正常的课件分表操作',
  'postsplit_do_succeed' => '恭喜您,课件分表操作成功,请返回',
  'postsplit_resetpid_succeed' => 'Post ID 重置完成',

  'recyclebin_none_selected' => '没有选择要操作的课件',
  'recyclebin_clean_next' => '回收站更新, 已经删除 {threadsdel} 个课件，程序将自动继续',
  ...
  'threads_forumstick_del_nochoice' => '您没有选择要取消置顶的课件',
  'threads_forumstick_del_succeed' => '置顶课件列表更新成功 ',
  'threads_forumstick_edit_succeed' => '目标课程更改成功 ',
  'threads_forumstick_add_succeed' => '课件添加成功 ',
  'delete_position_succeed' => '删除课件索引成功 ',
  'delete_position_gotu_add' => '已经删除了课件索引，正转向重新创建课件索引，请勿关闭浏览器！',
  'add_postposition_succeed' => '添加课件索引成功 ',
  'addpostposition_continue' => '正在添加课件索引，请勿关闭浏览器！',

  'threadsplit_manage_update_succeed' => '更新信息成功 ',
  'threadsplit_table_create_succeed' => '课件存档表创建成功 ',
  'threadsplit_table_no_exists' => '要删除的表不存在',
  'threadsplit_drop_table_no_empty_error' => '不能删除非空的课件表',
  'threadsplit_drop_table_succeed' => '课件存档表删除成功 ',
  'threadsplit_forum_must_be_closed' => '移动课件前请先关闭站点',
  'threadsplit_no_target_table' => '请选择目标数据表',
  'threadsplit_move_source_target_no_same' => '目标表和原始表不能相同',
  'threadsplit_moving' => '已经移动了 {count} 个课件，共有 {total} 个课件<br /><input type="hidden" name="conditions" value="{conditions}" /><input type="hidden" name="threads_per_time" value="{threads_per_time}" />',
  'threadsplit_move_succeed' => '课件移动完成，下面更新课程存档区',
  'threadsplit_manage_forum_processing' => '已处理完 {table}，请稍候...',
  'threadsplit_manage_forum_complete' => '已更新所有课程存档区',

  'forums_threadtypes_succeed' => '课件老师更新成功 ',
  'threadtype_infotypes_noexist' => '课件选项分类不存在',
  ...
  'moderate_replies_succeed' => '审核操作成功，共 {validates} 个评论被通过，{ignores} 个评论被忽略，{deletes} 个评论被删除',

  'moderate_shares_succeed' => '审核操作成功，共 {validates} 个分享被通过，{ignores} 个分享被忽略，{deletes} 个分享被删除',

  'moderate_threads_succeed' => '审核操作成功，共 {validates} 个课件被通过，{ignores} 个课件被忽略，{recycles} 个课件被放入回收站，{deletes} 个课件被删除',
