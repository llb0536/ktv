...
$lang = array (
  ...
  array (
    ...
    array (
      ...
      18 => '备份文件名',
      19 => 'db_import_tips',
      20 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将论坛关闭，恢复全部完成后可以将论坛重新开放。恢复数据前请在 Kejian.TV2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
      21 => 'db_import',
      22 => '数据恢复',
    ),
  ),
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 支付宝',
      1 => 'ec_alipay_tips',
      2 => '“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Kejian.TV 用户提供积分购买及论坛 B2C、C2C 交易平台。您只需进行简单的设置，即可使论坛内容和人气，真成为除广告收入外的重要利润来源，从而实现论坛的规模化经营。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方论坛另行通知以外，Kejian.TV 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方论坛提供的信息为准。您使用支付宝服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京课件交流系统科技有限责任公司不对因使用此功能造成的任何损失承担责任。支付宝业务咨询 Email 为 6688@taobao.com；支付宝客户服务电话为 +86-0571-88156688。',
      3 => 'ec_alipay',
      4 => '支付宝设置',
      5 => 'ec_alipay_account',
      6 => '收款支付宝账号',
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方论坛另行通知以外，Kejian.TV 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方论坛提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京课件交流系统科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      9 => '论坛首页下级子课程横排',
      10 => '设置进入论坛首页时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
  ...
  array (
    ...
    array (
      ...
      9 => '论坛课程下级子课程横排',
      10 => '设置进入论坛课程时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
      ...
      18 => '论坛课程下级子课程横排',
      19 => '设置进入论坛课程时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
...
',
  ...
  array (
    ...
    array (
      0 => '论坛批量删帖',
      1 => 'prune_tips',
      2 => '批量删帖仅用于删除违规课件使用，如您需要批量删除历史旧帖，请使用批量课件管理功能。使用此功能，需同时提供起始时间和终止时间其中之一，及上传课件用户名、上传课件 IP、内容关键字其中之一，至少共二项必要的条件，否则将无法进行操作。如果符合删除条件的课件为课件第一帖，或该课件无评论，将删除整个课件。如果您不是论坛管理员，您只能删除从某一时间到现在的范围内的课件。超级版主的删帖的时间范围为二星期(14 天)；版主的时间范围为一星期(7 天)且只能删除所管辖论坛内的课件。关键字可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。',
  ...
  array (
    ...
    array (
      ...
      18 => '启用全局置顶',
      19 => '选择“是”，置顶 III 的课件将在全部论坛显示，置顶 II 的课件将在当前分区中显示。注意: 本功能会加重服务器负担',
  ...
  array (
    ...
    array (
      ...
      8 => '缓存课件有效期',
      9 => '设置课件页面缓存更新的时间，单位为秒，0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑论坛来指定课件页面缓存系数',
      ...
      16 => '缓存系数',
      17 => '页面缓存功能可以将会员经常访问的课件临时缓存起来，缓解大型论坛服务器压力。缓存阀值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
  ...
  array (
    ...
    array (
      ...
      35 => '是否关闭session机制',
      36 => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能（注意：游客数和用户的在线时长将不再进行统计，论坛首页和课程列表页面的在线用户列表功能将不可用）',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      30 => '首页分区展示方式',
      31 => '如“收起”，论坛首页将默认只展示分区标题用户需点击分区展开该分区下的课程列表',
  ...
  array (
    ...
    array (
      ...
      16 => '允许发匿名帖',
      17 => '是否允许用户匿名发表课件和评论，只要用户组或本论坛允许，用户均可使用匿名上传课件功能。匿名上传课件不同于游客上传课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
