...
',
  ...
  array (
    ...
    array (
      ...
      2 => '点评方式',
      3 => '设置点评的发表方式，如不选择表示不启用点评功能。开启任意一种点评方式都需要在用户组中设置点评权限“直接点评”即通过课件每楼层中的“点评”链接发表点评“楼层评论”即通过课件每楼层中的“评论”链接上传课件评论时，自动对该楼层产生点评注意：点击课件中的“评论”链接，不会对课件产生点评',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      58 => '会员每小时发课件数限制',
      59 => '设置允许会员每小时最多的发课件数量，可以配合灌水预防功能进一步限制会员的上传课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
      60 => 'usergroups_edit_basic_hour_posts',
      61 => '会员每小时发课件评论数限制',
      62 => '设置允许会员每小时最多的发课件评论数量，可以配合灌水预防功能进一步限制会员的上传课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
