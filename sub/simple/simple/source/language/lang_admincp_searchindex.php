...
$lang = array (
  ...
  array (
    'index' =>
    array (
      '课件鉴定' => 'action=misc&operation=stamp',
    ),
    'text' =>
    array (
      0 => '课件鉴定',
  ...
  array (
    'index' =>
    array (
      '群组课件管理' => 'action=threads&operation=group',
    ),
    'text' =>
    array (
      0 => '群组课件管理',
  ...
  array (
    'index' =>
    array (
      '课程/群组置顶' => 'action=threads&operation=forumstick',
    ),
    'text' =>
    array (
      0 => '课程/群组置顶',
  ...
  array (
    'index' =>
    array (
      '课程合并' => 'action=forums&operation=merge',
    ),
    'text' =>
    array (
      0 => '课程合并',
  ...
  array (
    'index' =>
    array (
      '课件分表' => 'action=postsplit&operation=manage',
    ),
    'text' =>
    array (
      0 => '课件分表',
  ...
  array (
    'index' =>
    array (
      '课件分表' => 'action=threadsplit&operation=manage',
    ),
    'text' =>
    array (
      0 => '课件分表',
  ...
  array (
    ...
    array (
      '管理组' => 'action=admingroup',
      '课件管理权限' => 'action=admingroup&operation=edit&anchor=threadperm',
    ),
    'text' =>
    array (
      0 => '管理组 &raquo; 课件管理权限',
      ...
      4 => '允许置顶课件',
      5 => '设置是否允许置顶管理范围内课件的级别。如果打开全局置顶的功能，置顶 III 将全站置顶，置顶 II 将在当前分类置顶',
      6 => 'admingroup_edit_digest_thread',
      7 => '允许精华课件',
      8 => '设置是否允许精华管理范围内课件的级别',
      ...
      16 => '允许推荐课件',
      17 => '设置是否允许推荐管理范围内的课件 (要在相应课程的扩展设置里开启推荐课件功能)',
      18 => 'admingroup_edit_stamp_thread',
      19 => '允许添加课件图章',
      20 => '设置是否允许给课件在课件内容页添加图章',
      21 => 'admingroup_edit_stamp_list',
      22 => '允许添加课件图标',
      23 => '设置是否允许给课件在课件列表页添加图标',
      ...
      46 => '允许强制退款',
      47 => '允许将作者发布的收费课件终止，并将作者所获得收益退还给购买者。退款后，该课件将不能再被设置为收费课件，同时作者将自行承担积分交易而产生的损失',
      48 => 'admingroup_edit_edit_poll',
      49 => '允许编辑投票',
      50 => '设置是否允许编辑管理范围内投票课件的选项',
      51 => 'admingroup_edit_remove_reward',
      52 => '允许移除悬赏',
      53 => '设置是否允许移除管理范围内悬赏课件的悬赏金额',
      54 => 'admingroup_edit_edit_activity',
      55 => '允许管理活动报名者',
      56 => '设置是否允许管理范围内活动课件的报名者',
      57 => 'admingroup_edit_edit_trade',
      58 => '允许编辑商品',
      59 => '设置是否允许编辑管理范围内商品课件的商品',
      60 => 'admingroup_edit_usertag',
      61 => '允许添加用户标签',
      62 => '设置是否允许编辑管理范围内课件的用户标签',
    ),
  ),
  139 =>
  array (
    ...
    array (
      '管理组' => 'action=admingroup',
      '课件管理权限' => 'action=admingroup&operation=edit&anchor=postperm',
    ),
    'text' =>
    array (
      0 => '管理组 &raquo; 课件管理权限',
  ...
  array (
    ...
    array (
      ...
      4 => '允许审核课件',
      5 => '设置是否允许审核用户发表的课件，只在站点设置需要审核时有效',
  ...
  array (
    ...
    array (
      ...
      13 => '允许 DIY',
      14 => '设置是否允许 DIY 课件交流系统，文章，空间，课件交流系统等页面',
    ),
  ),
  144 =>
  array (
    ...
    array (
      0 => '站点广告 &raquo; 广告位',
      1 => 'adv_list_tip',
      2 => '您可以使用“自定义广告位”在页面的任意位置添加广告位。安装新的广告位，需将广告位脚本程序上传到 source/class/adv/ 目录，然后即可在以下列表中使用了。插件开发人员在设计新的广告位前请务必仔细阅读《Kejian.TV 技术文库》中的内容。Kejian.TV联盟免费提供更丰富的广告形式，让您赚取更丰厚的广告收益，快来看看吧。',
    ),
  ),
  145 =>
  array (
  ...
  array (
    ...
    array (
      ...
      9 => 'announce_message',
      10 => '内容',
      11 => '文字公告: 直接输入公告内容，支持 Kejian.TV 代码网址链接: 请输入公告的链接地址如某个课件地址: http://xxx.xxx.xxx',
    ),
  ),
  149 =>
  array (
    ...
    array (
      0 => '第三方模块 &raquo; 搜索',
      1 => 'blockxml_tips',
      2 => '插件开发人员在设计新的第三方模块前请务必仔细阅读《Kejian.TV 技术文库》中的内容。',
      3 => 'blockxml_add',
      4 => '添加 第三方模块',
      5 => 'blockxml_xmlurl',
      6 => '第三方地址',
  ...
  array (
    ...
    array (
      0 => '日志管理 &raquo; 最新列表',
      1 => 'blog_tips',
      2 => '批量日志信息管理用于删除日志使用，并且连同对应的评论一同删除。关键字可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。提醒：点击搜索结果页的删除按钮，将会直接删除相关信息！',
    ),
  ),
  151 =>
  array (
  ...
  array (
    ...
    array (
      ...
      18 => '备份文件名',
      19 => 'db_import_tips',
      20 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将课件交流系统关闭，恢复全部完成后可以将课件交流系统重新开放。恢复数据前请在 Kejian.TV2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
      21 => 'db_import',
      22 => '数据恢复',
    ),
  ),
  ...
  array (
    ...
    array (
      0 => '数据库 &raquo; 升级',
      1 => 'db_runquery_tips',
      2 => '您可以通过修改 /source/admincp/admincp_quickquery.php 来添加常用 SQL 操作进行功能扩充。出于安全考虑，Kejian.TV 后台默认情况下禁止 SQL 语句直接执行，只能使用常用 SQL 当中的内容，如果您想自己随意书写 SQL 升级语句，需要将 config/config_global.php 当中的 $_config[admincp][runquery] 设置修改为 1。',
      3 => 'db_runquery_simply',
      4 => '常用 SQL 升级语句',
      5 => 'db_runquery_sql',
      6 => 'Kejian.TV 数据库升级 - 请将数据库升级语句粘贴在下面',
    ),
  ),
  164 =>
  array (
  ...
  array (
    ...
    array (
      0 => '记录管理',
      1 => 'doing_tips',
      2 => '批量记录信息管理用于删除记录使用，并且连同对应的评论一同删除。关键字可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。提醒：点击搜索结果页的删除按钮，将会直接删除相关信息！',
    ),
  ),
  167 =>
  array (
  ...
  array (
    ...
    array (
      ...
      2 => '各自绑定的域名不能相同，域名不需要添加“http://”，也不要以“/”结尾，例如：portal.kejian.tv任意开启一项域名，需要配置默认域名，否则会造成多入口问题当开启多域名时，请在 config/config_global.php 中修改 cookiedomain 值来设置 cookie 作用域',
    ),
  ),
  169 =>
  array (
    ...
    array (
      ...
      2 => '可以为个人空间、群组、课程、专题、频道设置一个二级域名的根域名。例：用户申请XXX.kejian.tv,根域名填：kejian.tv个人空间、群组设置完二级域名的根后，还需要在基本设置中开启相应的二级域名开关，用户才能在相应的地方申请绑定二级域名，同时受限于用户组的二级域名长度频道启用二级域名如果是绑定目录的，需要自已在环境中配置相关的绑定操作不建议中途将不同的根域变更为相同的根域',
    ),
  ),
  170 =>
  array (
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 支付宝',
      1 => 'ec_alipay_tips',
      2 => '“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Kejian.TV 用户提供积分购买及课件交流系统 B2C、C2C 交易平台。您只需进行简单的设置，即可使课件交流系统内容和人气，真成为除广告收入外的重要利润来源，从而实现课件交流系统的规模化经营。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方课件交流系统另行通知以外，Kejian.TV 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方课件交流系统提供的信息为准。您使用支付宝服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京课件交流系统科技有限责任公司不对因使用此功能造成的任何损失承担责任。支付宝业务咨询 Email 为 6688@taobao.com；支付宝客户服务电话为 +86-0571-88156688。',
      3 => 'ec_alipay',
      4 => '支付宝设置',
      5 => 'ec_alipay_account',
      6 => '收款支付宝账号',
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 财付通',
      1 => 'ec_tenpay_tips',
      2 => '“财付通”(http://www.tenpay.com)是Kejian.TV公司创办的中国领先的在线支付平台，为 Kejian.TV 用户提供积分购买交易平台。如需启用积分充值即时到账，请使用财付通企业版并开通即时到账交易；否则，只需要开通“中介担保交易”即可。
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方课件交流系统另行通知以外，Kejian.TV 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方课件交流系统提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京课件交流系统科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      '课程管理' => 'action=forums',
      '编辑课程' => 'action=forums&operation=edit',
    ),
    'text' =>
    array (
      0 => '课程管理 &raquo; 编辑课程',
      ...
      6 => '分区风格方案(会影响该分区下的子课程)',
      7 => '访问者进入分区课程及子课程(子课程不同于分区风格，可单独设置)所使用的风格方案',
      8 => 'forums_edit_extend_forum_horizontal',
      9 => '课件交流系统首页下级子课程横排',
      10 => '设置进入课件交流系统首页时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
      11 => 'forums_edit_extend_cat_sub_horizontal',
      12 => '分区下级子课程横排',
      13 => '设置进入分区时，下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
      ...
      21 => '显示分区',
      22 => '选择“否”将暂时将分区隐藏不显示，但分区内容仍将保留，且用户仍可通过 URL 访问到此分区及其课程',
      23 => 'setting_seo_forum_tips',
      24 => '站点名称&nbsp;{bbname}（应用范围：所有位置）当前课程名称&nbsp;{forum}（应用范围：除首页以外）一级课程名称&nbsp;{fup}（应用范围：子课程课件列表页和课件内容页）分区名称&nbsp;{fgroup}（应用范围：除首页以外）课件标题&nbsp;{subject}（应用范围：课件内容页）课件摘要&nbsp;{summary}（应用范围：课件内容页）课件标签&nbsp;{tags}（应用范围：课件内容页）分页数&nbsp;{page}（应用范围：课件列表页、课件内容页）',
  ...
  array (
    ...
    array (
      0 => '课程管理 &raquo; 基本设置',
      1 => 'forums_edit_tips',
      2 => '以下设置没有继承性，即仅对当前课程有效，不会对下级子课程产生影响。',
      3 => 'forums_edit_basic',
      4 => '基本设置',
      ...
      16 => '显示课程',
      17 => '选择“不显示”将暂时将课程隐藏不显示，但课程内容仍将保留，且用户仍可通过直接提供带有 fid 的 URL 访问到此课程',
      18 => 'forums_edit_basic_up',
      19 => '上级课程',
      20 => '本课程的上级课程或分类',
      21 => 'forums_edit_basic_redirect',
      22 => '课程转向 URL',
      23 => '如果设置转向 URL(例如 http://www.kejian.tv)，用户点击本分课程将进入转向中设置的 URL。一旦设定将无法进入课程页面，请确认是否需要使用此功能，留空为不设置转向 URL',
      24 => 'forums_edit_basic_description',
      25 => '课程简介',
      26 => '将显示于课程名称的下面，提供对本课程的简短描述支持内置的 Kejian.TV 代码',
      27 => 'forums_edit_basic_rules',
      28 => '本课程规则',
      29 => '显示于课件列表页的当前课程规则，留空为不显示支持内置的 Kejian.TV 代码',
      30 => 'forums_edit_basic_keys',
      31 => '绑定别名',
      32 => '绑定后当站点开启 URL 静态化后可通过别名访问此课程，如设置别名为“developer”那么课程的 URL 将变为“http://127.0.0.1/Kejian.TVX/tools/language_template/forum-developer-1.html”。注意：别名中只能包含字母或数字，且不能是纯数字',
      ...
      40 => '站点名称&nbsp;{bbname}（应用范围：所有位置）当前课程名称&nbsp;{forum}（应用范围：除首页以外）一级课程名称&nbsp;{fup}（应用范围：子课程课件列表页和课件内容页）分区名称&nbsp;{fgroup}（应用范围：除首页以外）课件标题&nbsp;{subject}（应用范围：课件内容页）课件摘要&nbsp;{summary}（应用范围：课件内容页）课件标签&nbsp;{tags}（应用范围：课件内容页）分页数&nbsp;{page}（应用范围：课件列表页、课件内容页）',
  ...
  array (
    ...
    array (
      ...
      9 => '课件交流系统课程下级子课程横排',
      10 => '设置进入课件交流系统课程时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
      11 => 'forums_edit_extend_subforumsindex',
      12 => '本课程在首页显示下级子课程',
      13 => '首页课程列表中在课程简介下方显示下级子课程名字和链接(如果存在的话)。注意: 本功能不考虑子课程特殊浏览权限的情况，只要存在即会被显示出来。选择“默认”，将使用全局设置',
      14 => 'forums_edit_extend_simple',
      15 => '只显示下级子课程',
      16 => '选择“是”将不显示本课程的课件列表、上传课件按钮等等，类似于一个分类',
      17 => 'forums_edit_extend_sub_horizontal',
      18 => '课件交流系统课程下级子课程横排',
      19 => '设置进入课件交流系统课程时下级子课程横排时每行课程数量，如果设置为 0，则按正常方式排列',
      20 => 'forums_edit_extend_subforumsindex',
      21 => '本课程在首页显示下级子课程',
      22 => '首页课程列表中在课程简介下方显示下级子课程名字和链接(如果存在的话)。注意: 本功能不考虑子课程特殊浏览权限的情况，只要存在即会被显示出来。选择“默认”，将使用全局设置',
      23 => 'forums_edit_extend_simple',
      24 => '只显示下级子课程',
      25 => '选择“是”将不显示本课程的课件列表、上传课件按钮等等，类似于一个分类',
      26 => 'forums_edit_extend_widthauto',
      27 => '本课程宽窄风格',
      28 => '设置本课程的显示风格是宽版还是窄版，设置后用户将无法自由切换宽窄风格。默认表示继承全局设置',
      29 => 'forums_edit_extend_picstyle',
      30 => '开启图片列表模式',
      31 => '课件列表将以图片方式显示，课件封面可统一设置宽高',
      32 => 'forums_edit_extend_allowside',
      33 => '显示边栏',
      34 => '选择“是”课程首页侧边将显示聚合本课程内容的信息',
      35 => 'forums_edit_extend_recommend_top',
      36 => '显示全局置顶和分类置顶的课件',
      37 => '是否在本课程显示全局置顶和分版置顶',
      38 => 'forums_edit_extend_defaultorderfield',
      39 => '课件默认排序字段',
      40 => '设置课程的课件列表默认按照哪个字段进行排序显示。默认为“评论时间”，除默认设置外其他排序方式会加重服务器负担',
      41 => 'forums_edit_extend_defaultorder',
      42 => '课件默认排序方式',
      43 => '设置课程的课件列表默认排序的方式。默认为“按降序排列”，除默认设置外其他排序方式会加重服务器负担',
      44 => 'forums_edit_extend_threadcache',
      45 => '页面缓存系数',
      46 => '此功能可以将游客经常访问的课件临时缓存起来，缓解大型服务器压力。系数范围 0～100，建议数值 20 ～ 40，0 为关闭缓存。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果注：课程设置完毕后请到 全局 -> 优化设置 -> 站点页面缓存设置，调整其缓存时间',
      47 => 'forums_edit_extend_relatedgroup',
      48 => '关联群组/课程',
      49 => '填写被关联群组/课程的fid，以半角逗号 "," 隔开。课程的课件列表页将显示被关联群组/课程的课件',
      50 => 'forums_edit_extend_edit_rules',
      51 => '允许版主修改本课程规则',
      52 => '设置是否允许超级版主和版主修改本课程规则',
      53 => 'forums_edit_extend_disablecollect',
      54 => '禁止淘帖',
      55 => '选择“是”将禁止用户淘帖本课程课件',
      56 => 'forums_edit_extend_recommend',
      57 => '是否开启推荐课件功能',
      58 => '设置是否开启推荐课件功能',
      59 => 'forums_edit_extend_recommend_sort',
      60 => '版主推荐课件方式',
      61 => '自动生成则按照推荐课件规则设定生成推荐列表。手动生成则由版主自行推荐生成推荐列表。半自动生成则和手动方式类似，当手动生成的列表条数不足设置的显示条数时，将按照推荐课件规则自动补足相差条数',
      62 => 'forums_edit_extend_recommend_orderby',
      63 => '推荐课件规则',
      64 => '推荐课件规则，只对自动和半自动生成推荐课件列表有效，此规则均为降序排列',
      65 => 'forums_edit_extend_recommend_num',
      66 => '推荐课件显示数量',
      67 => '推荐课件显示的数量，默认为 10 条，建议不要超过 20 条',
      68 => 'forums_edit_extend_recommend_imagenum',
      69 => '推荐课件图片附件显示数量',
      70 => '推荐课件中图片附件显示的数量，默认为 5 条。设置为 0 则不显示，建议不要超过 10 条',
      71 => 'forums_edit_extend_recommend_imagesize',
      72 => '推荐课件图片附件显示大小',
      73 => '推荐课件中图片附件显示的大小，默认为 300 x 250',
      ...
      81 => '推荐课件时间段',
      82 => '按照设置的排序方式，取从访问推荐课件列表这一刻往前推送时间段内的课件，自动生成推荐课件列表，单位为小时，设置成0为所有时段',
    ),
  ),
  179 =>
  array (
    ...
    array (
      '课程管理' => 'action=forums',
      '课件选项' => 'action=forums&operation=edit&anchor=posts',
    ),
    'text' =>
    array (
      0 => '课程管理 &raquo; 课件选项',
      ...
      6 => '上传课件审核',
      7 => '选择“是”将使用户在本课程发表的课件待版主或管理员审查通过后才显示出来，打开此功能后，您可以在用户组中设定哪些组上传课件可不经审核，也可以在管理组中设定哪些组可以审核别人的课件',
      8 => 'forums_edit_posts_alloweditpost',
      9 => '允许编辑课件',
      10 => '选择“是”将允许用户编辑本课程发表的课件',
      11 => 'forums_edit_posts_recyclebin',
      12 => '回收站',
      13 => '是否在本课程启用回收站功能，打开此功能后，所有被删除课件和课件评论将被放在回收站中，而不会被直接删除',
      14 => 'forums_edit_posts_html',
      15 => '允许使用 HTML 代码',
      16 => '注意: 选择“是”将不屏蔽课件中的任何代码，将带来严重的安全隐患，请慎用',
      17 => 'forums_edit_posts_bbcode',
      18 => '允许使用Kejian.TV代码',
      19 => 'Kejian.TV 代码是一种简化和安全的页面格式代码',
      20 => 'forums_edit_posts_imgcode',
      21 => '允许使用 [img] 代码',
      22 => '允许 [img] 代码作者将可以在课件插入其他网站的图片并显示',
      23 => 'forums_edit_posts_mediacode',
      24 => '允许使用多媒体代码',
      25 => '允许 [audio] [media] [flash] 等多媒体代码后，作者将可以在课件插入多媒体文件并显示',
      26 => 'forums_edit_posts_smilies',
      27 => '允许使用表情',
      28 => '表情提供对表情符号，如“:)”的解析，使之作为图片显示',
      29 => 'forums_edit_posts_jammer',
      30 => '启用内容干扰码',
      31 => '选择“是”将在课件内容中增加随机的干扰字串，使得访问者无法复制原始内容。注意: 本功能会轻微加重服务器负担',
      32 => 'forums_edit_posts_anonymous',
      33 => '允许匿名上传课件',
      34 => '是否允许用户在本课程匿名上传课件和评论，只要用户组或本课程允许，用户均可使用匿名上传课件功能。匿名上传课件不同于游客上传课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
      35 => 'forums_edit_posts_disablethumb',
      36 => '禁用图片附件添加缩略图',
      37 => '选择“是”将不对本课程上传的图片附件自动缩略图，即便全局设置中开启了此项功能。选择“否”为按照系统默认设置决定是否添加缩略图',
      38 => 'forums_edit_posts_disablewatermark',
      39 => '禁用图片附件添加水印',
      40 => '选择“是”将不对本课程上传的图片附件自动添加水印，即便全局设置中开启了此项功能。选择“否”为按照系统默认设置决定是否添加水印',
      41 => 'forums_edit_posts_allowpostspecial',
      42 => '允许发布的特殊课件',
      43 => 'forums_edit_posts_threadplugin',
      44 => '允许发布的扩展特殊课件',
      45 => '设置本课程允许发布哪些其他扩展的特殊课件',
      46 => 'forums_edit_posts_allowspecialonly',
      47 => '只允许发布特殊类型课件',
      48 => '设置本课程是否只允许发布特殊类型课件',
      49 => 'forums_edit_posts_autoclose',
      50 => '课件自动关闭',
      51 => '设置课件是否在某时间后自动关闭，禁止普通用户评论',
      52 => 'forums_edit_posts_autoclose_time',
      53 => '自动关闭时间(天)',
      54 => '本设定必须在“课件自动关闭”功能打开时才生效，课件依据自动关闭的设定: 在发表后若干天、或被最后评论后若干天被自动转入关闭状态，从而使普通用户无法评论',
      ...
      59 => '允许发送广播和动态',
      60 => '开启后默认允许用户发送广播和动态，广播是否发送用户可以在上传课件时去掉，隐私课程建议设为否。',
      61 => 'forums_edit_posts_commentitem',
      62 => '普通课件点评预置观点',
      63 => '每个观点一行。如存在空行，空行下方的内容将显示在下拉菜单中作为备选观点。只有开启课件点评功能后本设置才生效，如留空表示使用全局的“普通课件点评预置观点”设置',
    ),
  ),
  180 =>
  array (
    ...
    array (
      ...
      2 => '本功能可限定本课程某特定类型附件的最大尺寸，当这里设定的尺寸小于用户组允许的最大尺寸时，指定类型的附件尺寸限制将按本设定为准。您可以设置某类附件最大尺寸为 0 以整体禁止这类附件被上传。此处设置留空则使用全局的“附件类型尺寸”设置。',
    ),
  ),
  181 =>
  array (
  ...
  array (
    ...
    array (
      '课程管理' => 'action=forums',
      '课件老师' => 'action=forums&operation=edit&anchor=threadtypes',
    ),
    'text' =>
    array (
      0 => '课程管理 &raquo; 课件老师',
      ...
      6 => '启用课件老师',
      7 => '设置是否在本课程启用课件老师功能，您需要同时设定相应的分类选项，才能启用本功能',
      8 => 'forums_edit_threadtypes_required',
      9 => '上传课件必须填写老师',
      10 => '是否强制用户发表新课件时必须选择分类',
      11 => 'forums_edit_threadtypes_listable',
      12 => '允许按类别浏览',
      13 => '用户是否可以按照课件老师筛选浏览内容',
      14 => 'forums_edit_threadtypes_prefix',
      15 => '类别前缀',
      16 => '是否在课件前面显示分类的名称',
      17 => 'forums_edit_threadtypes',
      18 => '课件老师',
      19 => '您可以启用已有的课件老师或添加新课件老师应用于本课程，在分类很多的情况下，建议只有重要的分类使用“平板显示”方式，更多的分类使用“下拉显示”方式',
    ),
  ),
  183 =>
  array (
  ...
  array (
    ...
    array (
      '课程管理' => 'action=forums',
      '课程权限' => 'action=forums&operation=edit&anchor=perm',
    ),
    'text' =>
    array (
      0 => '课程管理 &raquo; 课程权限',
      ...
      4 => '课程权限',
      5 => '某权限如果全部未选则表示如下含义:　　浏览课程，全部用户组具有浏览课程课件权限；发新话题，除游客以外的用户组具有上传课件权限；发表评论，除游客以外的用户组具有评论权限；查看附件，全部用户组具有下载/查看附件权限；上传附件，除游客以外的用户组具有上传附件权限；上传图片，除游客以外的用户组具有上传图片权限',
      6 => 'forums_edit_perm_passwd',
      7 => '访问密码',
      8 => '当您设置密码后，用户必须输入密码才可以访问到此课程',
      9 => 'forums_edit_perm_users',
      10 => '访问用户',
      11 => '限定只有列表中的用户可以访问本课程，每行填写一个用户名',
      12 => 'forums_edit_perm_medal',
      13 => '拥有勋章',
      14 => '用户必须拥有指定的勋章才可访问此课程',
      15 => 'forums_edit_perm_forum',
      16 => '课程权限',
      17 => '某权限如果全部未选则表示如下含义:　　浏览课程，全部用户组具有浏览课程课件权限；发新话题，除游客以外的用户组具有上传课件权限；发表评论，除游客以外的用户组具有评论权限；查看附件，全部用户组具有下载/查看附件权限；上传附件，除游客以外的用户组具有上传附件权限；上传图片，除游客以外的用户组具有上传图片权限',
      18 => 'forums_edit_perm_formula',
      19 => '权限表达式设置',
      20 => '当您设定了权限表达式后，只有符合此表达式的会员才可以浏览本课程。如 "posts > 100 and extcredits1 > 10" 表示 "上传课件数 > 100 并且 威望 > 10"日期格式 "{Y-M-D}"，如 "{2009-10-1}"。IP 格式 "{x.x.x.x}"，既可输入完整地址，也可只输入 IP 开头，如 "{10.0.0.1}"、"{192.168.0}"',
  ...
  array (
    ...
    array (
      ...
      15 => '选择管理用户组(在群组中具有与课件交流系统中相对应的管理权限)',
      16 => 'forums_edit_posts_allowfeed',
      17 => '允许发送广播和动态',
      18 => '开启后默认允许用户发送广播和动态，广播是否发送用户可以在上传课件时去掉，隐私课程建议设为否。',
    ),
  ),
  187 =>
  array (
  ...
  array (
    ...
    array (
      0 => '群组等级',
      1 => 'group_level_tips',
      2 => '群组等级不宜设置过多。当允许群组内上传课件等操作影响用户积分时应谨慎，用户有可能通过群组刷积分。默认等级图标大小是25 X 25像素。',
    ),
  ),
  189 =>
  array (
  ...
  array (
    ...
    array (
      0 => '道具中心',
      1 => 'magics_tips',
      2 => '安装新的道具，需将道具脚本程序上传到 source/class/magic/ 目录，然后即可在以下列表中使用了。插件开发人员在设计新的道具前请务必仔细阅读《Kejian.TV 技术文库》中的内容。',
  ...
  array (
    ...
    array (
      ...
      2 => 'Kejian.TV 支持对用户 8 种扩展积分的设置，只有被启用的积分才允许您进行编辑。修改用户的某项积分会造成该用户总积分的变化，从引起普通会员等级的变化，因此请仔细设置各项积分。',
  ...
  array (
    ...
    array (
      ...
      2 => '用户在课程中的权限是基于用户和站点间的权限设定，如果设置为非默认状态，将不受用户组的设定限制。删除某个用户在某课程的特殊权限设置，您只需要将他在这个课程中的权限全部设置为默认即可修改某个用户在这个课程的权限，您只需要重新添加他的权限设置即可',
      3 => 'members_access_add_forum',
      4 => '选择课程',
      5 => '请选择要设置的课程。以下权限设置仅仅影响该用户在此课程的权限',
  ...
  array (
    ...
    array (
      ...
      2 => '本功能用于自定义首页及课件列表页显示的在线会员分组及图例，只在在线列表功能打开时有效。用户组图例处空白为不区分该组用户，所有未区分的用户组将统一归入第一行的“普通用户”项。用户组图例中请填写图片文件名，并将相应图片文件上传到 static/image/common/ 目录中。',
    ),
  ),
  202 =>
  array (
    ...
    array (
      0 => '友情链接',
      1 => 'misc_link_tips',
      2 => '如果您不想在课件交流系统首页显示友情链接，可以在“界面设置”中关闭。未填写文字说明的项目将以紧凑型显示。
  ...
  array (
    ...
    array (
      '编辑器设置' => 'action=setting&operation=editor',
      'Kejian.TV 代码' => 'action=setting&operation=bbcode',
    ),
    'text' =>
    array (
      0 => '编辑器设置 &raquo; Kejian.TV 代码',
      1 => 'misc_bbcode_edit_tips',
      2 => '只有在自定义 Kejian.TV 代码可用并设置了图标文件时，具有“允许使用自定义 Kejian.TV 代码”权限的用户组在上传课件时才会看到相应自定义 Kejian.TV 代码按钮。',
    ),
  ),
  205 =>
  array (
    ...
    array (
      0 => '词语过滤',
      1 => 'misc_censor_tips',
      2 => '替换前的内容可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略的字节数。如 "a{1}s{2}s"(不含引号) 可以过滤 "ass" 也可过滤 "axsxs" 和 "axsxxs" 等等。对于中文字符，若使用 GBK、Big-5 版本，每个中文字符相当于 2 个字节；若使用 UTF-8 版本，每个中文字符相当于 3 个字节。为不影响程序效率，请不要设置过多不需要的过滤内容。审核只对课件交流系统中的内容有效如果您不是课件交流系统管理员，您将只能对自己添加的项目进行编辑或删除。不良词语如果以"/"(不含引号)开头和结尾则表示格式为正则表达式，这时替换内容可用"(n)"引用正则中的子模式，如"/1\\d{10}([^\\d]+|$)/"替换为"手机(1)"。',
      3 => 'misc_censor_batch_add_tips',
      4 => '每行一组过滤词语，不良词语和替换词语之间使用“=”进行分割；如需禁止发布包含某个词语的文字，而不是替换过滤，请将其对应的替换内容设置为{BANNED}即可；如需当用户发布包含某个词语的文字时，自动标记为需要人工审核，而不直接显示或替换过滤，请将其对应的替换内容设置为{MOD}即可(审核只对课件交流系统中的内容有效)。如果只是想将某个词语直接替换成 **，则只输入词语即可；例如：toobadnobadbadword=goodsexword={BANNED}导出/导入时支持词语分类导入，导入时不带有分类则可以通过选择指定导入分类。没有分类时自动归入默认分类',
  ...
  array (
    ...
    array (
      ...
      2 => '鉴定图章显示在课件内容页，鉴定图标显示在课件列表页。系统预留了 100 个课件鉴定图片位置，分别为图片 ID 0 至 99。不要随意修改图片 ID，否则将会导致课件中已使用的图章、图标错乱。当图章设置了关联操作后，图章会在执行相应操作时被自动添加到课件中；当图章设置了关联图标后，图标会在添加图章时自动添加到课件列表中。关联操作不可与关联图标同时设置。',
    ),
  ),
  207 =>
  array (
  ...
  array (
    ...
    array (
      0 => '计划任务',
      1 => 'misc_cron_tips',
      2 => '计划任务是 Kejian.TV 提供的一项使系统在规定时间自动执行某些特定任务的功能，在需要的情况下，您也可以方便的将其用于站点功能的扩展。计划任务是与系统核心紧密关联的功能特性，不当的设置可能造成站点功能的隐患，严重时可能导致站点无法正常运行，因此请务必仅在您对计划任务特性十分了解，并明确知道正在做什么、有什么样后果的时候才自行添加或修改任务项目。此处和其他功能不同，本功能中完全按照站点系统默认时差对时间进行设定和显示，而不会依据某一用户或管理员的时差设定而改变显示或设置的时间值。',
    ),
  ),
  211 =>
  array (
    ...
    array (
      0 => '站长推荐 &raquo; 管理',
      1 => 'misc_focus_tips',
      2 => '站长推荐将以浮窗的形式显示在课件内容页面右下角。您可以手动添加一些指定的课件，或者选择一些版主推荐的课件。最多 10 条，每次随机显示其中 1 条。',
      3 => 'admin',
      4 => '管理',
    ),
  ),
...
',
  ...
  array (
    ...
    array (
      0 => '课件点评管理',
      1 => 'postcomment_tips',
      2 => '批量点评管理用于删除课件点评。提醒：点击搜索结果页的删除按钮，将会直接删除相关信息！',
    ),
  ),
  217 =>
  array (
    ...
    array (
      ...
      8 => '被点评课件 ID',
      9 => '指定课件的所有点评(包括课件帖和课件评论)，多 ID 中间请用半角逗号 "," 隔开',
      10 => 'postcomment_search_pid',
      11 => '被点评课件 ID',
      12 => '指定课件的点评，多 ID 中间请用半角逗号 "," 隔开',
  ...
  array (
    ...
    array (
      ...
      2 => '进行课件分表前一定要先关闭站点，为防止分表操作过程中出现问题，必须做好数据库备份后再进行此操作课件数据转移完毕会对源课件表进行表优化操作，优化表所耗时间比较长，在这期间绝对不能重起服务器或者停止MySQL服务forum_post(主表)必须保留300M的数据课件分表功能可以将课件分在不同的数据表中，适合课件数很多并且运行效率受到影响的站点使用',
    ),
  ),
  219 =>
  array (
  ...
  array (
    ...
    array (
      0 => '课件交流系统批量删帖',
      1 => 'prune_tips',
      2 => '批量删帖仅用于删除违规课件使用，如您需要批量删除历史旧帖，请使用批量课件管理功能。使用此功能，需同时提供起始时间和终止时间其中之一，及上传课件用户名、上传课件 IP、内容关键字其中之一，至少共二项必要的条件，否则将无法进行操作。如果符合删除条件的课件为课件第一帖，或该课件无评论，将删除整个课件。如果您不是课件交流系统管理员，您只能删除从某一时间到现在的范围内的课件。超级版主的删帖的时间范围为二星期(14 天)；版主的时间范围为一星期(7 天)且只能删除所管辖课件交流系统内的课件。关键字可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。',
  ...
  array (
    ...
    array (
      ...
      17 => '显示授权信息链接',
      18 => '选择“是”将在页脚显示商业授权用户链接，链接将指向 Kejian.TV 官方网站，用户可通过此链接验证其所使用的 Kejian.TV 是否经过商业授权',
  ...
  array (
    ...
    array (
      ...
      24 => '不受邀请码限制的地区列表',
      25 => '当用户处于本列表中的地址时，注册时不受邀请码限制。每个地区一行，例如 "北京"(不含引号)，留空为不设置。注意：如要正确无误的判断您 IP 地址所在的地区，请到网上下载 qqwry.dat IP 地址库文件上传到 "data_'.PSVR_KTV_SUB.'/ipdata/" 目录下更名为 wry.dat，同时删除 tinyipdata.dat 文件',
      ...
      33 => '注册地址:',
      34 => '设置站点注册地址 mod 值，默认为“register”，修改名称有利于防止灌水软件，有别于 Kejian.TV 之前的版本更改了此设置，不需要修改任何文件名称，只在此修改即可',
  ...
  array (
    ...
    array (
      ...
      2 => '新手见习期限(分钟)',
      3 => '新注册用户在本期限内将无法上传课件和短消息，不影响版主和管理员，0 为不限制',
  ...
  array (
    ...
    array (
      ...
      18 => '站点宽窄风格',
      19 => '设置站点的显示风格是宽版还是窄版。其中课件交流系统的课程中还可以进行独立的设置',
      20 => 'setting_styles_index_switchwidthauto',
      21 => '允许用户自由切换',
      22 => '设置是否允许用户自由切换宽窄风格',
      23 => 'setting_styles_global_jsmenu',
      24 => '课件交流系统显示课程跳转菜单',
      25 => '注意: 当课件交流系统分课程很多时，本功能会严重加重服务器负担',
      ...
      36 => '匿名用户的昵称',
      37 => '设置课件或评论留言中的匿名用户显示的文字。如:本站网友',
    ),
  ),
  232 =>
  array (
  ...
  array (
    ...
    array (
      '界面设置' => 'action=setting&operation=styles',
      '课件列表页' => 'action=setting&operation=styles&anchor=forumdisplay',
    ),
    'text' =>
    array (
      0 => '界面设置 &raquo; 课件列表页',
  ...
  array (
    ...
    array (
      '界面设置' => 'action=setting&operation=styles',
      '课件内容页' => 'action=setting&operation=styles&anchor=viewthread',
    ),
    'text' =>
    array (
      0 => '界面设置 &raquo; 课件内容页',
      ...
      51 => '显示作者在线状态',
      52 => '是否显示课件作者的在线状态，注意：“精确显示”会轻微加重服务器负担',
      53 => 'setting_styles_viewthread_userstatusby',
      54 => '显示作者的组头衔',
      55 => '设置在课件中是否显示作者的用户组头衔',
      56 => 'setting_styles_viewthread_postno',
      57 => '课件顺序单位',
      58 => '设置课件显示顺序编号的单位，如“#”将显示为 1 #',
      59 => 'setting_styles_viewthread_postnocustom',
      60 => '课件顺序名称',
      61 => '设置每篇课件所有课件的顺序名称，每行填写一个名称，第一行代表课件帖，第二行代表课件的第一个评论，以此类推',
      62 => 'setting_styles_viewthread_maxsmilies',
      63 => '最大单一表情解析次数',
      64 => '在一篇课件中解析的单一表情符号的最大次数，超过此次数限制的表情将不被解析而保留原样，以避免用户在一篇课件中恶意发表大量表情影响正常阅读，0 为不限制',
      65 => 'setting_styles_viewthread_author_onleft',
      66 => '作者用户名显示位置',
      67 => '显示位置并不会影响课件交流系统的性能和美观，请根据您会员的浏览习惯进行选择',
  ...
  array (
    ...
    array (
      ...
      7 => '开启直接/快速跳转',
      8 => '对于站点中的某些成功的操作不显示提示信息，直接跳转到下一个页面，例如上传课件，评论等等，可以节省用户等待跳转的时间',
  ...
  array (
    ...
    array (
      ...
      13 => '上传课件页面',
      14 => '上传课件页面的弹出信息，每行填写一条信息，多条信息将随机显示',
      15 => 'setting_styles_sitemessage_reply',
      16 => '评论页面',
      17 => '评论页面的弹出信息，每行填写一条信息，多条信息将随机显示',
    ),
  ),
  237 =>
  array (
  ...
  array (
    ...
    array (
      '性能优化' => 'action=setting&operation=seo',
      '课件交流系统页面缓存设置' => 'action=setting&operation=cachethread',
    ),
    'text' =>
    array (
      0 => '性能优化 &raquo; 课件交流系统页面缓存设置',
      1 => 'setting_cachethread',
      2 => '课件交流系统页面缓存设置',
      3 => '开启后，缓存页面内容到静态文件，游客访问时速度将大大提升，建议独立服务器使用，虚拟空间请根据实际情况调节缓存的有效期',
      4 => 'setting_cachethread_indexlife',
      5 => '缓存课件交流系统首页有效期',
      6 => '设置课件交流系统首页缓存更新的时间，单位为秒，0 为关闭(此处关闭以后，缓存系数将不再起作用)，建议设置为 900。此功能只针对游客',
      7 => 'setting_cachethread_life',
      8 => '缓存课件有效期',
      9 => '设置课件页面缓存更新的时间，单位为秒，0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑课件交流系统来指定课件页面缓存系数',
      10 => 'setting_cachethread_dir',
      11 => '缓存目录',
      12 => '默认为 data_'.PSVR_KTV_SUB.'/threadcache 目录，如果您需要将其指定为其他目录，请确定您指定的目录有可写权限',
      13 => 'setting_cachethread_coefficient_set',
      14 => '缓存系数批量设置',
      15 => 'setting_cachethread_coefficient',
      16 => '缓存系数',
      17 => '页面缓存功能可以将会员经常访问的课件临时缓存起来，缓解大型课件交流系统服务器压力。缓存阀值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
  ...
  array (
    ...
    array (
      ...
      8 => '查看数开启防刷新',
      9 => '选择“否”，课件、空间、日志每访问一次，浏览量增1，会增大服务器压力，建议选择“是”',
      ...
      35 => '是否关闭session机制',
      36 => '关闭session机制以后，可明显降低站点的服务器负担，建议在线用户数超过2万时开启本功能（注意：游客数和用户的在线时长将不再进行统计，课件交流系统首页和课程列表页面的在线用户列表功能将不可用）',
  ...
  array (
    ...
    array (
      ...
      7 => '开启课件交流系统管理工作统计',
      8 => '课件交流系统管理工作统计可以使版主、管理员了解课件交流系统版主等管理人员的工作状况。注意: 本功能会轻微加重系统负担',
      9 => 'setting_functions_archiver',
      10 => '开启课件交流系统 Archiver 功能',
      11 => '课件交流系统 Archiver 能够将课件交流系统公开的内容模拟成静态页面，以便搜索引擎获取其中的内容',
      ...
      19 => '删帖不减积分时间期限(天)',
      20 => '设置版主或管理员从前台删除发表于多少天以前的课件时，不更新用户的扩展积分，可用于清理老课件而不对作者的扩展积分造成损失。0 为不使用此功能，始终更新用户积分',
      ...
      37 => '悬赏课件有效期',
      38 => '设置悬赏课件的有效天数，当悬赏课件超过有效期后依然未发放悬赏，版主或管理员有权代为课件作者发放悬赏。0 或留空表示不允许版主或管理员进行此操作',
      39 => 'setting_functions_mod_moddetail',
      40 => '版主面板显示审核数目',
      41 => '设置版主面板是否详细显示待审核课件、课件及用户的具体数目',
    ),
  ),
  243 =>
  array (
    ...
    array (
      '站点功能' => 'action=setting&operation=functions',
      '课件热度' => 'action=setting&operation=functions&anchor=heatthread',
    ),
    'text' =>
    array (
      0 => '站点功能 &raquo; 课件热度',
      1 => 'setting_functions_heatthread_tips',
      2 => '课件热度将按参与人次计算，包括课件评论，点评，收藏，分享，评分，推荐',
      3 => 'setting_functions_heatthread_period',
      4 => '用户热度值周期(天)',
      5 => '以天为单位，一个周期内某用户多次参与课件，只加一次热度。0代表不设置周期，只要参与一次，热度就加1。为避免用户刷热度，建议不要设置为0。(评论、点评、评论、收藏、分享等都算作参与课件的动作)',
      6 => 'setting_functions_heatthread_iconlevels',
      7 => '热门课件显示级别',
      8 => '设置课件列表页课件图标每一级别对应的热度指数，默认为 3 个级别，请用逗号分隔，如：“50,100,200”表示当课件的热度大于 50 时为 1 级，大于 100 时为 2 级，大于 200 时为 3 级。留空表示不显示图标',
    ),
  ),
  244 =>
  array (
    ...
    array (
      '站点功能' => 'action=setting&operation=functions',
      '课件评价' => 'action=setting&operation=functions&anchor=recommend',
    ),
    'text' =>
    array (
      0 => '站点功能 &raquo; 课件评价',
      1 => 'setting_functions_recommend_tips',
      2 => '不同用户组会员的课件评价影响值不同，您可以在”用户组”设置的“课件相关”中设置。',
      3 => 'setting_functions_recommend_status',
      4 => '启用课件评价',
      5 => '课件评价是让用户参与课件热度的重要指标，您可以设定用户在每天允许执行的评价次数',
      ...
      13 => '每 24 小时评价课件次数',
      14 => '设置用户每 24 小时可以评价多少篇课件，0 或留空为不限制',
      15 => 'setting_functions_recommend_ownthread',
      16 => '是否允许评价自己的课件',
      17 => '设置是否允许评价自己的课件。评价自己的课件无积分奖励',
      18 => 'setting_functions_recommend_iconlevels',
      19 => '评价图标显示级别',
      20 => '设置课件列表页评价图标每一级别对应的评价指数。建议为 3 个级别，请用逗号分隔，如：“0,100,200”表示当课件的评价指数大于 0 时为 1 级，大于 100 时为 2 级，大于 200 时为 3 级。1 级及以上级别的课件会在课件列表页“查看好评课件”中列出。留空或者 0 表示不显示图标',
    ),
  ),
  245 =>
  array (
    ...
    array (
      '站点功能' => 'action=setting&operation=functions',
      '课件点评' => 'action=setting&operation=functions&anchor=comment',
    ),
    'text' =>
    array (
      0 => '站点功能 &raquo; 课件点评',
      ...
      2 => '点评方式',
      3 => '设置点评的发表方式，如不选择表示不启用点评功能。开启任意一种点评方式都需要在用户组中设置点评权限“直接点评”即通过课件每楼层中的“点评”链接发表点评“楼层评论”即通过课件每楼层中的“评论”链接发表课件评论时，自动对该楼层产生点评注意：点击课件中的“评论”链接，不会对课件产生点评',
      4 => 'setting_functions_comment_number',
      5 => '点评条目数',
      6 => '在课件中显示点评的条目数',
      7 => 'setting_functions_comment_postself',
      8 => '允许点评自己的课件',
      9 => '设置是否上传课件作者能点评自己的课件',
      10 => 'setting_functions_comment_firstpost',
      11 => '允许点评楼主帖',
      12 => '设置是否允许直接点评楼主帖，关闭表示只能点评课件评论',
  ...
  array (
    ...
    array (
      ...
      10 => '启用 RSS',
      11 => '选择“是”，将允许用户使用 RSS 客户端软件接收最新的课件、文章更新。注意: 在分类很多的情况下，本功能可能会加重服务器负担',
      ...
      16 => '用户在线时间更新时长(分钟)',
      17 => 'Kejian.TV 可统计每个用户总共和当月的在线时间，本设置用以设定更新用户在线时间的时间频率。例如设置为 10，则用户每在线 10 分钟更新一次记录。本设置值越小，则统计越精确，但消耗资源越大。建议设置为 5～30 范围内，0 为不记录用户在线时间',
  ...
  array (
    ...
    array (
      '站点功能' => 'action=setting&operation=functions',
      '活动课件' => 'action=setting&operation=functions&anchor=activity',
    ),
    'text' =>
    array (
      0 => '站点功能 &raquo; 活动课件',
  ...
  array (
    ...
    array (
      ...
      2 => '允许查看用户的课件和课件',
      3 => '设置是否允许查看其他用户的课件和课件，选择相应的课程那么在个人空间将出现“课件”模块和链接',
      4 => 'setting_permissions_allowviewuserthread_fids',
      5 => '允许查看哪些课程的课件',
      6 => '设置允许查看其他用户哪些课程的课件和课件',
      7 => 'setting_permissions_allowmoderatingthread',
      8 => '是否提示用户自己有未审核的课件或者课件',
      9 => '选择“是”，用户如果有正在审核的课件，将可以在课件列表页看到提示',
      10 => 'setting_permissions_memliststatus',
      11 => '允许查看会员列表',
      12 => 'setting_permissions_minpostsize',
      13 => '课件最小字数(字节)',
      14 => '管理组成员可通过“上传课件不受限制”设置而不受影响，0 为不限制',
      15 => 'setting_permissions_maxpostsize',
      16 => '课件最大字数(字节)',
      17 => '管理组成员可通过“上传课件不受限制”设置而不受影响',
      18 => 'setting_permissions_alloweditpost',
      19 => '允许用户随时编辑的课件类型',
      20 => '被选中的课件类型将不受用户组中的“编辑课件时间”限制，任何时刻都可以编辑',
      21 => 'setting_permissions_post_append',
      22 => '启用课件补充功能',
      23 => '启用后，当用户无法编辑自己的课件时，可以补充内容',
      24 => 'setting_permissions_maxpolloptions',
      25 => '投票最大选项数:',
      26 => '设定发布投票包含的最大选项数',
      27 => 'setting_permissions_editby',
      28 => '编辑课件附加编辑记录',
      29 => '在 60 秒后编辑课件添加“本课件由 xxx 于 xxxx-xx-xx 编辑”字样。管理员编辑不受此限制',
      30 => 'nav_setting_rate',
      31 => '评分',
      32 => 'setting_permissions_karmaratelimit',
      33 => '评分时间限制(小时)',
      34 => '课件发表后超过此时间限制其他用户将不能对此帖评分，版主和管理员不受此限制，0 为不限制',
      35 => 'setting_permissions_modratelimit',
      36 => '版主评分限制',
      37 => '设置版主只能在自身所管辖的课程范围内对课件进行评分。本限制只对版主有效，允许评分的普通用户及超级版主、管理员不受此限制，因此如果赋予这些用户评分权限，他们仍将可以在全课程范围内进行评分',
      38 => 'setting_permissions_dupkarmarate',
      39 => '允许重复评分',
      40 => '选择“是”将允许用户对一个课件进行多次评分，默认为“否”',
      41 => 'setting_permissions_editperdel',
      42 => '允许用户编辑课件时删除课件',
      43 => '选择“是”将允许用户编辑课件时删除课件，默认为“否”',
      44 => 'setting_permissions_hideexpiration',
      45 => '课件中[hide]标签最大有效天数',
      46 => '距上传课件日期天数超过此设置时标签自动失效，0或不填为不限制',
    ),
  ),
  250 =>
  array (
    ...
    array (
      ...
      7 => '交易积分设置',
      8 => '交易积分是一种可以由用户间自行转让、买卖交易、发布悬赏课件的积分类型，您可以指定一种积分作为交易积分。如果不指定交易积分，则用户间积分交易功能将不能使用。注意: 交易积分必须是已启用的积分，一旦确定请尽量不要更改，否则以往记录及交易可能会产生问题',
      ...
      49 => '单课件(附件)最高收入',
      50 => '设置单一课件(附件)出售作者所得的最高税后积分收入，超过此限制后购买者将仍然被扣除相应积分，但课件(附件)作者收益将不再上涨。本限制只在课件(附件)买卖时起作用，0 为不限制',
      51 => 'setting_credits_maxchargespan',
      52 => '单课件(附件)最高出售时限(小时)',
      53 => '设置当课件(附件)被作者出售时，系统允许自课件(附件)发布时间起，其可出售的最长时间。超过此时间限制后将变为普通课件(附件)，阅读者无需支付积分购买，作者也将不再获得相应收益，以小时为单位，0 为不限制',
    ),
  ),
  251 =>
  array (
  ...
  array (
    ...
    array (
      ...
      7 => '验证码上传课件限制',
      8 => '上传课件数超过此设置的会员将不受验证码功能限制，0 表示所有会员均受限制',
  ...
  array (
    ...
    array (
      ...
      2 => '验证问题应该言简意赅，没有歧义，正常人都能够正确作答。请经常更新验证问答的问题及答案以防止被猜测！安装新的验证问答脚本，需将验证问答脚本程序上传到 source/class/secqaa/ 目录，然后即可在以下列表中选择使用了。插件开发人员在设计新的验证问答脚本前请务必仔细阅读《Kejian.TV 技术文库》中的内容。',
      ...
      10 => '验证问答上传课件限制',
      11 => '上传课件数超过此设置的会员将不受验证问答功能限制，0 表示所有会员均受限制',
  ...
  array (
    ...
    array (
      ...
      4 => '禁止上传课件时间段',
      5 => '每天该时间段内用户不能上传课件，请使用 24 小时时段格式，每个时间段一行，如需要也可跨越零点，留空为不限制。例如:每日晚 11:25 到次日早 5:05 可设置为: 23:25-5:05每日早 9:00 到当日下午 2:30 可设置为: 9:00-14:30注意: 格式不正确将可能导致意想不到的问题，用户组中如开启“不受时间段限制”的选项，则该组可不被任何时间段设置约束。所有时间段设置均以站点系统默认时区为准，不受用户自定义时区的影响',
      6 => 'setting_datetime_postmodperiods',
      7 => '上传课件审核时间段',
      8 => '每天该时间段内用户上传课件不直接显示，需经版主或管理员人工审核才能发表，格式和用法同上',
      9 => 'setting_datetime_postignorearea',
      10 => '上传课件不受时间限制的地区列表',
      11 => '当用户处于本列表中的地址时，上传课件不受时间段限制。每个地区一行，例如 "北京"(不含引号)，留空为不设置。注意：如要正确无误的判断您 IP 地址所在的地区，请到网上下载 qqwry.dat IP 地址库文件上传到 "data_'.PSVR_KTV_SUB.'/ipdata/" 目录下更名为 wry.dat，同时删除 tinyipdata.dat 文件',
      12 => 'setting_datetime_postignoreip',
      13 => '上传课件不受时间限制的IP列表',
      14 => '当用户处于本列表中的 IP 地址时，上传课件不受时间段限制。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头，例如 "192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为不设置',
    ),
  ),
  258 =>
  array (
    ...
    array (
      ...
      32 => '图片处理库类型',
      33 => '请选择 Kejian.TV 用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但需要服务器有执行命令行命令的权限。如果您的服务器有条件安装此程序，请到 http://www.imagemagick.org 下载，安装后在下面指定安装的路径',
  ...
  array (
    ...
    array (
      '上传设置' => 'action=setting&operation=attach',
      '课件交流系统附件' => 'action=setting&operation=attach&anchor=forumattach',
    ),
    'text' =>
    array (
      0 => '上传设置 &raquo; 课件交流系统附件',
      1 => 'setting_attach_basic_imgpost',
      2 => '课件中显示图片附件',
      3 => '在课件中直接将图片或动画附件显示出来，而不需要点击附件链接',
      4 => 'setting_attach_basic_allowattachurl',
      5 => '附件 URL 地址、媒体附件播放',
      6 => '开启附件 URL 地址后，上传附件的地址可通过 "attach://aid" 方式在任何帖内引用，并支持媒体类附件的直接播放，此项设置需要在 用户组 - 课件相关 中允许用户组使用多媒体代码方可生效',
      ...
      23 => '下载附件来路检查',
      24 => '选择“是”将检查下载附件的来路，来自其他网站或站点的下载请求将被禁止。注意: 本功能在开启“课件中显示图片附件”时，会加重服务器负担',
    ),
  ),
  260 =>
  array (
  ...
  array (
    ...
    array (
      '水印设置' => 'action=setting&operation=imgwater',
      '课件交流系统' => 'action=setting&operation=imgwater&anchor=forum',
    ),
    'text' =>
    array (
      0 => '水印设置 &raquo; 课件交流系统',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      6 => 'setting_uc_key',
      7 => 'UCenter 通信密钥',
      8 => '通信密钥用于在 UCenter 和 Kejian.TV 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 Kejian.TV 设置完全相同的通讯密钥，以确保两套系统能够正常通信',
      9 => 'setting_uc_api',
      10 => 'UCenter 访问地址',
  ...
  array (
    ...
    array (
      ...
      9 => '不参与排行的课程/群组',
      10 => '填入课程ID或群组ID，对应课程及下面的课件将不进入排行榜，多个课程ID间请用半角逗号 "," 隔开',
  ...
  array (
    ...
    array (
      ...
      2 => '提供方便手机方式浏览的页面，此功能仅限课件交流系统范围内。本手机功能页仅支持WAP2.0(XHTML方式)以上的手机浏览器进行访问。手机浏览图片宽度为200像素以内缩略图。',
      3 => 'setting_mobile_status',
      4 => '手机版全局设置',
      5 => 'setting_mobile_allowmobile',
      6 => '开启手机版',
      7 => '开启本功能，用户使用手机访问课件交流系统时，将自动跳转到手机版界面手机访问域名配置请进入: 全局 - 域名设置 - 应用域名底部导航设置请进入：界面 - 导航设置 - 底部导航',
      8 => 'setting_mobile_mobileforward',
      9 => '开启手机浏览器自动跳转',
      10 => '开启后用户使用手机浏览器访问社区课件交流系统功能页以外页面时自动跳转到课件交流系统首页进行访问',
      ...
      18 => '手机版式',
      19 => '默认为“标准版”，标准版为全功能手机版式。“无图精简版”则为去掉小图标、课件列表日期等页面元素的精简版式注意：两种模式下表情均解析，且用户可以自由切换',
      20 => 'setting_mobile_topicperpage',
      21 => '每页显示课件数',
      22 => '课件列表页每页显示课件个数，推荐值为10',
      23 => 'setting_mobile_postperpage',
      24 => '课件内每页显示帖数',
      25 => '课件内每页显示的课件数目，推荐值为5',
      26 => 'setting_mobile_cachetime',
      27 => '页面浏览缓存时间',
      28 => '设置访问过的页面在用户手机上保存的时间，留空或0为不缓存单位：秒',
      29 => 'setting_mobile_index_forumview',
      30 => '首页分区展示方式',
      31 => '如“收起”，课件交流系统首页将默认只展示分区标题用户需点击分区展开该分区下的课程列表',
  ...
  array (
    ...
    'text' =>
    array (
      0 => '课件交流系统课件管理 &raquo; 最新列表',
      1 => 'threads_tips',
      2 => '通过批量课件管理，您可以对搜索到的课件进行批量删除、移动、分类/取消分类、删除、置顶/取消置顶、设置/取消精华、打开/关闭以及删除课件中的附件等操作；请先根据条件搜索课件，然后选择相应的操作。',
    ),
  ),
  280 =>
  array (
  ...
  array (
    ...
    array (
      ...
      2 => '课件分表功能可将 forum_thread 表(包含课件标题、创建时间等信息，但不包含课件及评论内容)分在多个数据表中。创建新的课件存档表后，可使用课件移动功能将特定课件移动到存档表中。移动到存档表中的课件，会在课件所在的课程下建立一个存档区(名称可自定义)，通过存档区可浏览存档表中的课件。存档表中的课件，只供浏览，不可评论、评分，不能进行管理操作，但可以删除和移动到非存档区。',
  ...
  array (
    ...
    array (
      '课件分表' => 'action=threadsplit',
      '课件移动' => 'action=threadsplit&operation=move',
    ),
    'text' =>
    array (
      0 => '课件分表 &raquo; 课件移动',
      1 => 'threadsplit_move_tips',
      2 => '课件移动功能可将特定的课件在原始表(forum_thread)和新建的课件存档表之间移动。移动课件之前，请确定存在至少一个课件存档表(表名为 forum_thread_1、forum_thread_2……)。通过课件搜索筛选出要移动的课件，再选择目标表，即可完成课件数据的移动。',
  ...
  array (
    ...
    array (
      ...
      2 => '当站点进行了数据恢复、升级或者工作出现异常的时候，您可以使用本功能重新生成缓存。更新缓存的时候，可能让服务器负载升高，请尽量避开会员访问的高峰时间
				数据缓存：更新站点的全部数据缓存
				模板缓存：更新课件交流系统模板、风格等缓存文件，当您修改了模板或者风格，但是没有立即生效的时候使用
  ...
  array (
    ...
    array (
      0 => '用户组',
      1 => 'usergroups_tips',
      2 => '用户组分为系统组、会员组和自定义组，会员组以积分确定组别和权限，而系统组和自定义组是人为设定，不会由系统自行改变。系统组和自定义组的设定不需要指定积分，Kejian.TV 预留了从站点管理员到游客等的 8 个系统头衔，自定义组的用户需要在编辑会员时将其加入。会员用户组至少分为两组，其积分下限分别为负值(任一负数)和 0，否则将导致部分用户无法与用户组匹配的问题。',
    ),
  ),
  285 =>
  array (
  ...
  array (
    ...
    array (
      ...
      11 => '阅读权限',
      12 => '设置用户浏览课件或附件的权限级别，范围 0～255，0 为禁止用户浏览任何课件或附件。当用户的阅读权限小于课件或附件的阅读权限许可(默认时为 1)时，用户将不能阅读该课件或下载该附件',
      ...
      38 => '允许发站外URL',
      39 => '是否允许上传课件包含URL，合理的设置可以有效的减少广告帖的量',
      40 => 'usergroups_edit_basic_allow_statdata',
      41 => '允许查看站点统计',
      42 => 'usergroups_edit_basic_search_post',
      43 => '允许全文搜索',
      44 => '此设置只对搜索课件交流系统有效。注意: 当数据量大时，全文搜索将非常耗费服务器资源，请慎用',
      ...
      52 => '允许自定义头衔',
      53 => '设置是否允许用户设置自己的头衔名字并在课件中显示',
      54 => 'usergroups_edit_basic_disable_periodctrl',
      55 => '不受时间段限制',
      56 => '设置用户是否可以不受全局设置中设置的特殊时间段禁令限制',
      57 => 'usergroups_edit_basic_hour_threads',
      58 => '会员每小时上传课件数限制',
      59 => '设置允许会员每小时最多的上传课件数量，可以配合灌水预防功能进一步限制会员的上传课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
      60 => 'usergroups_edit_basic_hour_posts',
      61 => '会员每小时发表课件评论数限制',
      62 => '设置允许会员每小时最多的发表课件评论数量，可以配合灌水预防功能进一步限制会员的上传课件，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
  ...
  array (
    ...
    array (
      '用户组' => 'action=usergroups',
      '特殊课件' => 'action=usergroups&operation=edit&anchor=special',
    ),
    'text' =>
    array (
      0 => '用户组 &raquo; 特殊课件',
      ...
      4 => '允许发起活动',
      5 => '选择“是”允许在课件交流系统发布活动课件',
      6 => 'usergroups_edit_special_poll',
      7 => '允许发起投票',
      8 => '选择“是”允许在课件交流系统发布投票课件',
      9 => 'usergroups_edit_special_vote',
      10 => '允许参与投票',
      11 => '选择“是”允许在课件交流系统参与投票',
      12 => 'usergroups_edit_special_reward',
      13 => '允许发起悬赏',
      14 => '选择“是”允许在课件交流系统发布悬赏课件，悬赏使用交易积分',
      ...
      31 => '商品课件最多推荐商品数',
      32 => '设置用户在每篇商品课件中最多推荐商品的数目',
      33 => 'usergroups_edit_special_debate',
      34 => '允许发起辩论',
      35 => '选择“是”允许在课件交流系统发布辩论课件',
  ...
  array (
    ...
    array (
      '用户组' => 'action=usergroups',
      '课件相关' => 'action=usergroups&operation=edit&anchor=post',
    ),
    'text' =>
    array (
      0 => '用户组 &raquo; 课件相关',
      ...
      7 => '允许发表评论',
      8 => '设置是否允许发表评论。注意: 只有当用户组阅读权限高于 0 时，才能发表评论',
      9 => 'usergroups_edit_post_direct',
      10 => '允许直接上传课件',
      11 => '是否允许直接上传课件或者对评论及课件进行审核，此设置受课程审核影响，如果课程设置为不需要审核，则此设置无效',
      12 => 'usergroups_edit_post_allow_down_remote_img',
      13 => '允许下载远程图片',
      14 => '远程图片本地化保存',
      15 => 'usergroups_edit_post_anonymous',
      16 => '允许发匿名帖',
      17 => '是否允许用户匿名上传课件和评论，只要用户组或本课件交流系统允许，用户均可使用匿名上传课件功能。匿名上传课件不同于游客上传课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
      18 => 'usergroups_edit_post_set_read_perm',
      19 => '允许设置课件权限',
      20 => '设置是否允许设置课件需要指定阅读权限才可浏览',
      21 => 'usergroups_edit_post_maxprice',
      22 => '课件(附件)最高售价',
      23 => '课件(附件)出售使得作者可以将自己发表的课件(附件)隐藏起来，只有当浏览者向作者支付相应的交易积分后才能查看课件(附件)内容。此处设置用户出售课件(附件)时允许设置的最高价格，0 为不允许用户出售。注意: 本功能需在 全局设置中启用交易积分后才可使用。如开启版主及管理员的出售课件(附件)功能，请将其最高价格设置为高于普通用户组允许的最高价格，这样在课件被编辑时不至于导致课件(附件)售价的硬性下调',
      24 => 'usergroups_edit_post_hide_code',
      25 => '允许使用 [hide] 代码',
      26 => '设置是否允许课件中使用 [hide] 隐藏标签',
      ...
      31 => '允许签名中使用 Kejian.TV 代码',
      32 => '设置是否解析用户签名中的 Kejian.TV 代码',
      ...
      40 => '课件评价影响值',
      41 => '设置用户评价一次课件，对课件评价指数的影响，0 为不允许用户评价课件',
      42 => 'usergroups_edit_post_edit_time_limit',
      43 => '编辑课件时间限制(分钟)',
      44 => '课件作者上传课件后超过此时间限制将不能再编辑帖，版主和管理员在 全局 - 用户权限 选择“允许用户随时编辑的课件类型”后不受此限制，0 为不限制',
      45 => 'usergroups_edit_post_allowreplycredit',
      46 => '允许设置课件评论奖励',
      47 => '允许用户在发布课件时给予课件评论者一定的扩展积分奖励。课件评论奖励默认积分可在全局 - 积分设置指定',
      48 => 'usergroups_edit_post_tag',
      49 => '允许使用标签',
      50 => '设置是否允许发表新话题时使用标签',
      51 => 'usergroups_edit_post_allowcommentpost',
      52 => '课件直接点评',
      53 => '设置允许点评的范围，如不选择表示不启用点评功能注意：只有在 全局 - 站点功能 - 课件点评 中开启直接点评功能，本设置才会生效',
      54 => 'usergroups_edit_post_allowcommentreply',
      55 => '楼层评论点评',
      56 => '允许用户通过点击课件中的“评论”链接评论他人课件评论时，自动对该楼层产生点评注意：只有在 全局 - 站点功能 - 课件点评 中开启楼层评论功能，本设置才会生效；点击课件中的“评论”链接，不会对课件产生点评',
      57 => 'usergroups_edit_post_allowcommentitem',
      58 => '允许用户在点评时发表观点',
      59 => '允许用户在点评时发表观点注意：只有在 全局 - 站点功能 - 课件点评 中开启直接点评功能，本设置才会生效',
      60 => 'usergroups_edit_post_allowat',
      61 => '上传课件时可 @ 其他人的数量',
      62 => '0为不允许 @ 其他人（包括他关注的人和他的好友）',
      63 => 'usergroups_edit_post_allowsetpublishdate',
      64 => '允许设置定时发布',
      65 => '允许用户在发布课件时设置指定的上传课件时间。只能设置在每半小时（如 13:00 或 13:30）自动发布。',
      66 => 'usergroups_edit_post_allowcommentcollection',
      67 => '允许评论淘专辑',
      68 => '允许用户在课件和淘专辑页面进行评论。',
    ),
  ),
  289 =>
  array (
    ...
    array (
      ...
      4 => '允许下载附件',
      5 => '设置是否允许在没有设置特殊权限的课件交流系统中下载附件',
      6 => 'usergroups_edit_attach_getimage',
      7 => '允许查看图片',
      8 => '设置是否允许在没有设置特殊权限的课件交流系统中查看图片',
      9 => 'usergroups_edit_attach_post',
      10 => '允许上传附件',
      11 => '设置是否允许上传附件到没有设置特殊权限的课件交流系统中。需要 PHP 设置允许才有效，请参考管理中心首页',
      12 => 'usergroups_edit_attach_set_perm',
      13 => '允许设置附件权限',
      14 => '设置是否允许设置附件需要指定积分以上才可下载',
      15 => 'usergroups_edit_image_post',
      16 => '允许上传图片',
      17 => '设置是否允许上传图片到没有设置特殊权限的课件交流系统中。需要 PHP 设置允许才有效，请参考管理中心首页',
      18 => 'usergroups_edit_attach_max_size',
      19 => '课件交流系统最大附件尺寸(单位K 1M=1024K)',
