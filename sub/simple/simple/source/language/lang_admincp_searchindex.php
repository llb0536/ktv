...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买课件内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Kejian.TV 官方网站或官方课件交流系统另行通知以外，Kejian.TV 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Kejian.TV 官方网站或官方课件交流系统提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Kejian.TV 因主观恶意的因素造成的资金损失以外，北京课件交流系统科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      33 => '允许匿名上传课件',
      34 => '是否允许用户在本课程匿名发表课件和评论，只要用户组或本课程允许，用户均可使用匿名上传课件功能。匿名上传课件不同于游客上传课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      16 => '允许发匿名帖',
      17 => '是否允许用户匿名发表课件和评论，只要用户组或本课件交流系统允许，用户均可使用匿名上传课件功能。匿名上传课件不同于游客上传课件，用户需要登录后才可使用，版主和管理员可以查看真实作者',
