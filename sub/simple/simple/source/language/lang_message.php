...
$lang = array (
  ...
  'forum_not_group' => '该课程不是{_G/setting/navs/3/navname}',
  ...
  'forum_nonexistence' => '抱歉，指定的课程不存在',
  ...
  'debate_end' => '抱歉，辩论已结束',
  'replyperm_login_nopermission' => '抱歉，您尚未登录，没有权限在该课程课件评论',
  ...
  'post_reply_mod_succeed' => '评论需要审核，请等待通过',
  'postperm_login_nopermission' => '抱歉，您尚未登录，没有权限在该课程上传课件',
  ...
  'debate_position_nofound' => '抱歉，发表辩论课件需要输入正方和反方观点',
  ...
  'postperm_none_nopermission' => '抱歉，您没有权限在该课程上传课件</p></div><div>',
  'replyperm_none_nopermission' => '抱歉，您没有权限在该课程课件评论</p></div><div>',
  ...
  'forum_passwd_incorrect' => '抱歉，您输入的密码不正确，不能访问这个课程',
  ...
  'group_threadtype_only_founder' => '抱歉，只有{_G/setting/navs/3/navname}创始人可以管理课件老师',
  'group_threadtype_edit_succeed' => '修改课件老师成功 ',
  ...
  'postcomment_error' => '抱歉，您不能点评此帖或课件尚未找到',
  ...
  'thread_poll_none' => '抱歉，本课件非投票帖',
  'thread_poll_nopermission' => '抱歉，您无权查看本课件投票人',
  'thread_rate_moderator_invalid' => '抱歉，作为版主您只能在自己的管辖范围内评分',
  'thread_rate_timelimit' => '抱歉，您不能对发表于 {karmaratelimit} 小时前的课件进行评分',
  'thread_rate_member_invalid' => '抱歉，您不能给自己发表的课件评分',
  ...
  'reward_cant_self' => '抱歉，您不能把自己的评论设置成最佳答案',
  ...
  'forum_group_not_groupmember' => '抱歉，您还不是本{_G/setting/navs/3/navname}成员不能上传课件<br /><a href="forum.php?mod=group&action=join&fid={fid}" target="_blank">马上加入该{_G/setting/navs/3/navname}</a>',
  'forum_group_not_groupmember_guest' => '抱歉，您还不是本{_G/setting/navs/3/navname}成员不能上传课件',
  'forum_disablepost' => '本课程禁止上传课件',
  'post_newbie_span' => '抱歉，您在注册时间起 {newbiespan} 分钟后才能拥有上传课件权限',
  'post_hide_nopermission' => '抱歉，您没有权限使用 [hide] 代码',
  'reward_credits_closed' => '交易积分被关闭，请联系管理员。',
  'forum_access_disallow' => '抱歉，您在本课程没有权限进行此操作',
  ...
  'collection_forum_deny' => '抱歉，管理员设置了本课程课件不能被加入淘专辑',
  ...
  'collection_collect_succ' => '淘帖成功，课件已经被加入到相应淘专辑中',
  ...
  'post_edit_nopermission' => '抱歉，您没有权限编辑他人发表的课件',
  'post_edit_timelimit' => '抱歉，您的课件从发表到现在已超过 {edittimelimit} 分钟，不能再进行编辑',
  'debate_umpire_comment_invalid' => '抱歉，裁判已进行过评判，您不能再进行编辑',
  'post_edit_nopermission_threadplign' => '抱歉，您没有权限编辑本课件或特殊帖功能已关闭',
  'reward_credits_invalid' => '抱歉，悬赏积分设置不合理',
  'reward_credits_fall' => '抱歉，悬赏积分不能减少',
  'post_edit_thread_replaycredit_nocredit' => '您的积分不足，不能为课件评论奖励增加积分',
  'post_edit_thread_ban_del' => '抱歉，编辑课件时不允许删除课件',
  'post_edit_reward_already_reply' => '抱歉，您不能删除已经有评论的悬赏',
  'post_edit_thread_already_reply' => '对不起，您不能删除已经有评论的课件，请返回。',
  'post_edit_reward_nopermission' => '抱歉，悬赏已结束，无法退还积分',
  'post_edit_delete_rushreply_nopermission' => '抱歉，抢楼件不能删除',
  ...
  'edit_reply_mod_succeed' => '编辑后的评论需要审核，请等待审核通过',
  'post_edit_succeed' => '课件编辑成功，现在将转入课件页，请稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入课件列表 ]</a>',

  'post_forum_newreply_nopermission' => '抱歉，本课程只有特定用户组可以评论',
  'comment_add_succeed' => '课件点评成功 ',
  'post_rushreply_creditlimit' => '抱歉，您的 {creditlimit_title} 不足，本抢楼件限制最小 {creditlimit_title} 为 {creditlimit}',
  'trade_newreply_nopermission' => '抱歉，只有已开放的商品课件可以评论',
  'post_reply_succeed' => '非常感谢，评论发布成功，现在将转入课件页，请稍候……<br /><a href="forum.php?mod=forumdisplay&fid={fid}">[ 点击这里转入课件列表 ]</a>',
  ...
  'postperm_login_nopermission_mobile' => '您尚未<a href="member.php?mod=logging&action=login&referer={referer}&mobile=yes">登录</a>，没有权限在该课程上传课件',
  ...
  'replycredit_morethan_self' => '抱歉，课件评论送积分额度大于您的积分',
  ...
  'follow_only_allow_the_relay_time' => '抱歉，第二次转播必须同时进行课件评论操作',
  ...
  'do_success_thread_share_mod' => '您的分享成功了，评论请等待管理员审核通过',
  ...
  'recommend_group_invalid' => '抱歉，您选择的课件已被推荐课程',
  ...
  'admin_move_have_mod' => '抱歉，目标课程需要内容审核',
  'admin_move_nopermission' => '抱歉，目标课程无上传课件权',
  'no_privilege_edittypethread' => '抱歉，您没有权限设置课件老师',
  ...
  'admin_split_invalid' => '抱歉，课件没有评论，无法分割',
  ...
  'note_wall_reply_success' => '已经评论到{username}的留言板',
  ...
  'credits_policy_lowerlimit_fid' => '抱歉，本课程{ruletext} {rulecredit}，本操作后您的{title}将不足 {lowerlimit} {unit}',
  ...
  'forum_permforum_nomedal' => '您需要拥有以下勋章才能访问这个课程<br /><br />{forum_permforum_nomedal}&nbsp;<a href="home.php?mod=medal" class="xi1">点击进入勋章页面</a>',
  'forum_permforum_disallow' => '本课程只有特定用户可以访问',
  'forum_permforum_nopermission' => '您需要满足以下条件才能访问这个课程</p></div><div><p><b>访问条件： </b><br />&nbsp;&nbsp;&nbsp;{formulamessage}<br /><b>您的信息： </b>{usermsg} ',
  'forum_permforum_nopermission_custommsg' => '</p></div><div><p>{formulamessage} ',
  'viewperm_none_nopermission' => '抱歉，您没有权限访问该课程</p></div><div>',
  'viewperm_upgrade_nopermission' => '抱歉，您需要升级您所在的用户组后才能访问该课程，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。</p></div><div><p><b>有权访问的用户组或认证用户为：</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
  'viewperm_login_nopermission' => '抱歉，您尚未登录，没有权限访问该课程',
  'postperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能上传课件，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。</p></div><div><p><b>有权上传课件的用户组或认证用户为：</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
  'replyperm_upgrade_nopermission' => '抱歉，您需要升级所在的用户组后才能课件评论，详细请 <a href="home.php?mod=spacecp&ac=usergroup&do=forum" target="_blank">点击这里查看</a>。</p></div><div><p><b>有权课件评论的用户组或认证用户为：</b><br />&nbsp;&nbsp;&nbsp; {permgroups}',
