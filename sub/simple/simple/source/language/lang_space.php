...
$lang = array(
	...
	'blockdata' => array('personalinfo' => '个人资料', 'profile' => '头像', 'doing' => '记录', 'feed' => '动态',
				...
				'thread' => '课件', 'group'=>$_G[setting][navs][3][navname],'music'=>'音乐盒',
	...
	'doing_li' => '<li>{message}</li><br />{date} {from} 评论({replynum})',
	...
	'wall_form' => '<div class="space_wall_post">
						<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
							...
							<input type="hidden" name="commentsubmit" value="true" />' : ($_G['connectguest'] ? '<div class="pt hm">您需要 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">绑定已有帐号</a> 后才可以课件评论</div>' : '<div class="pt hm">你需要登录后才可以留言 <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">登录</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>')).'
	...
	'wall_reply' => '<a href="home.php?mod=spacecp&ac=comment&op=reply&cid={cid}&handlekey=replycommenthk_{cid}" id="c_{cid}_reply" onclick="showWindow(this.id, this.href, \'get\', 0);">评论</a>',
	...
	'block_thread_no_content' => '现在还没有课件',
	'block_thread_no_content_publish' => '，<a href ="forum.php?mod=misc&action=nav&special=0&from=home" onclick="showWindow(\'nav\', this.href);return false;">发布课件</a>',
	...
	'viewthread_userinfo_posts' => '课件',
	'viewthread_userinfo_threads' => '课件',
	...
	'follow_view_thread' => '{who}的课件',
	'follow_view_reply' => '{who}的评论',
	'follow_view_profile' => '{who}的个人资料',
	'follow_view_type_feed' => '广播',
	'follow_view_type_thread' => '课件',
	'follow_view_type_reply' => '课件评论',
