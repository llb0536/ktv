...
(
	...
	'anonymouspost_forum' => '允许使用本道具的课程',
	'anonymouspost_info' => '将自己的课件设置为匿名身份，请输入课件的 ID',
	'anonymouspost_info_nonexistence' => '请指定要匿名的课件',
	'anonymouspost_succeed' => '成功设置为匿名',
	'anonymouspost_use_error' => '参数错误，不能在此处使用本道具。',
	'anonymouspost_info_noperm' => '对不起，课件所在课程不允许使用本道具',
