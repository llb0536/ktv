...
$lang = array (
  ...
  'mobile_favorite_comment' => '您可以通过手机快速访问课件交流系统课程及管理收藏夹，随时随地访问自己最爱的内容',
  'mobile_other_1' => '节省流量与获得优质手机体验并存',
  'mobile_pm' => '站内短信实时收发，与短信另一端的朋友进行单人或多人聊天',
  'mobile_viewthread' => '看帖及课件评论更快速',
  'mobile_viewthread_comment' => '通过手机版，可以快速的访问您需要阅读的课件，并可以快速的发布新课件及评论',
  'continue' => '继续访问',
  'goback' => '返回上一页',
  ...
  'join_thread' => '评论',
  'required' => '必填',
  'send_special_activity_error' => '手机版不支持<strong>活动</strong>发布，请点击上方上传课件选择其他方式',
  'send_special_trade_error' => '手机版不支持<strong>商品</strong>发布，请点击上方上传课件选择其他方式',
  ...
  'topicadmin_mobile_mod' => '手机版课件操作',
  'admin_banpost_confirm' => '您要进行屏蔽操作',
  'admin_delpost_confirm' => '您确定要删除此评论？',
  ...
  'my_favorites_thread' => '我收藏的课件',
  'return_forum' => '返回课件交流系统',
  ...
  'favorite_forum_confirm' => '收藏此课程: ',
  'favorite_thread_confirm' => '收藏此课件: ',
