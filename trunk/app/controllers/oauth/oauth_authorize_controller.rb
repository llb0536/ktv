class Oauth::OauthAuthorizeController < ApiController
  ...
  def show
    render "/oauth/authorize",:layout=>'application' and return
  end
  ...
  private
    ...
    def client_not_found
      render text:I18n.t("notifications.oauth.client.not_found")
      return
