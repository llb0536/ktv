...
class RegistrationsController < ApplicationController
  ...
  def update
    begin
      params[resource_name]["mail_be_followed"] = ('on'==params[resource_name]["mail_be_followed"] ? '1' : '0')
      params[resource_name]["mail_new_answer"] = ('on'==params[resource_name]["mail_new_answer"] ? '1' : '0')
      params[resource_name]["mail_invite_to_ask"] = ('on'==params[resource_name]["mail_invite_to_ask"] ? '1' : '0')
      params[resource_name]["mail_ask_me"] = ('on'==params[resource_name]["mail_ask_me"] ? '1' : '0')
  ...
  def authenticate_scope!
    xookie
    redirect_to Setting.zhaopin_login+CGI::escape('http://'+Setting.wendao_domain_name+request.path) and return if !current_user
