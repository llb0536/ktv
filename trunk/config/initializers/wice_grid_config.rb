...
if defined?(Wice::Defaults)
  ...
  # Icon to reset the filter.
  Wice::Defaults::TOGGLE_MULTI_SELECT_ICON = "/assets/wice_grid/expand.png"
 
  # CSV Export icon.
  Wice::Defaults::CSV_EXPORT_ICON = "/assets/wice_grid/page_white_excel.png"
 
  # Tick-All icon for the action column.
  Wice::Defaults::TICK_ALL_ICON = "/assets/wice_grid/tick_all.png"
 
  # Untick-All icon for the action column.
  Wice::Defaults::UNTICK_ALL_ICON = "/assets/wice_grid/untick_all.png"
  ...
  Wice::Defaults::CALENDAR_ICON = "/assets/wice_grid/calendar_view_month.png"
