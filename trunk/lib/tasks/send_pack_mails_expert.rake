...
<div style="background:#FFF; font-size:12px; width:500px;">
        ...
        <div><a href="http://kejian.tv" title="Kejian.TV" target="_blank"><img src="http://kejian.tv/assets/mail_logo.png" /></a></div>
...
bodycombo+=<<DOC
                ...
                <div style="border-top:3px solid #bbb;text-align:right;margin-top:20px;">
                        这是一封系统邮件，请勿回复<br/>
                        <a style="color:#999;" href="http://kejian.tv">http://kejian.tv</a> &nbsp;|&nbsp; <a style="color:#999;" href="http://kejian.tv/users/edit#mail_notify_settings">邮件通知设置</a>
                </div>
        </div>
