$(document).ready(function(){
  ...
  $("form[name='loginform']").submit(function(e){
    ...
    loginform.action = "http://my.zhaopin.com//loginmgr/loginproc.asp";
  ...
  $("form[name='regform']").submit(function(e){
    ...
    regform.method = "post";
    regform.action = "http://my.zhaopin.com/loginmgr/registerProc.asp";
    regform.redirect_url.value = "http://"+location.host+"/";
    $.mobile.showPageLoadingMsg();
    $.getScript("http://my.zhaopin.com/myzhaopin/CEF_markhome.asp?timestamp=" + new Date().getTime()+"&opt=1&email=" + regform.email.value, function(){
