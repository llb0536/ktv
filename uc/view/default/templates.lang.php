...
$languages = array(
	...
	'login_tips' => 'KTV用户管理中心 是一个能沟通多个应用的桥梁，使各应用共享一个用户数据库，实现统一登录，注册，用户管理。',
	...
	'app_url' => '应用的主 URL',
	'app_url_comment' => '该应用与 KTV用户管理中心 通信的接口 URL，结尾请不要加“/” ，应用的通知只发送给主 URL',
	'app_extra_url' => '应用的其他 URL',
	'app_extra_url_comment' => '该应用可以访问的其他 URL，结尾请不要加“/” ，每行一个，只有在同步登录是请求该 URL',
	'app_ip' => '应用 IP',
	'app_ip_comment' => '正常情况下留空即可。如果由于域名解析问题导致 KTV用户管理中心 与该应用通信失败，请尝试设置为该应用所在服务器的 IP 地址。',
	'app_key' => '通信密钥',
	'app_key_comment' => '只允许使用英文字母及数字，限 64 字节。应用端的通信密钥必须与此设置保持一致，否则该应用将无法与 KTV用户管理中心 正常通信。',
	'app_login' => '是否开启同步登录',
	...
	'app_code' => '应用的 KTV用户管理中心 配置信息',
	'app_code_comment' => '当应用的 KTV用户管理中心 配置信息丢失时可复制左侧的代码到应用的配置文件中',
	...
	'db_delete_dumpfile_confirm' => '删除数据库备份会同时删除KTV用户管理中心 下所有应用的同目录下的备份，您确定要删除吗？',
	...
	'home_dev_community' => '产品官方博客',
	'home_stats' => 'KTV用户管理中心 统计信息',
	'home_member_count' => '用户总数',
	'home_app_count' => '应用总数',
	'home_env' => '系统信息',
	'home_team' => 'Kejian.TV 开发团队',
	...
	'app_allowips' => '允许的IP',
	'app_allowips_comment' => '限定终端访问的IP, 设置哪些IP可以访问KTV用户管理中心  的数据接口',
