...
namespace Microsoft.word2pdf
{
    class Program
    {
            ...
            //{
                ...
                //{
                    ...
                    wordDocument = wordApplication.Documents.Open(
                        ref paramSourceDocPath, false, true,
                        ref paramMissing, ref paramMissing, ref paramMissing,
                        true, ref paramMissing, ref paramMissing,
                        ref paramMissing, ref paramMissing, false,
                        true, ref paramMissing, true,
                        ref paramMissing);
        ...
        {
            ConvertWord2PDF(args[0],args[1],args[2]);
        }
    }
}
